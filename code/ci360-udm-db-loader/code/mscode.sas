...
%if %sysfunc(exist(&udmmart..ab_test_path_assignment) ) %then %do;
 ...
 data &tmplib..ab_test_path_assignment_tmp     ;
  ...
  if abtestpath_assignment_dttm ne . then abtestpath_assignment_dttm = tzoneu2s(abtestpath_assignment_dttm,'AMERICA/NEW_YORK') ; if abtestpath_assignment_dttm_tz ne . then abtestpath_assignment_dttm_tz = tzoneu2s(abtestpath_assignment_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..abt_attribution) ) %then %do;
 ...
 data &tmplib..abt_attribution_tmp             ;
  ...
  if interaction_dttm ne . then interaction_dttm = tzoneu2s(interaction_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..activity_conversion) ) %then %do;
 ...
 data &tmplib..activity_conversion_tmp         ;
  ...
  if activity_conversion_dttm ne . then activity_conversion_dttm = tzoneu2s(activity_conversion_dttm,'AMERICA/NEW_YORK') ; if activity_conversion_dttm_tz ne . then activity_conversion_dttm_tz = tzoneu2s(activity_conversion_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..activity_flow_in) ) %then %do;
 ...
 data &tmplib..activity_flow_in_tmp            ;
  ...
  if activity_flow_in_dttm ne . then activity_flow_in_dttm = tzoneu2s(activity_flow_in_dttm,'AMERICA/NEW_YORK') ; if activity_flow_in_dttm_tz ne . then activity_flow_in_dttm_tz = tzoneu2s(activity_flow_in_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..activity_start) ) %then %do;
 ...
 data &tmplib..activity_start_tmp              ;
  ...
  if activity_start_dttm ne . then activity_start_dttm = tzoneu2s(activity_start_dttm,'AMERICA/NEW_YORK') ; if activity_start_dttm_tz ne . then activity_start_dttm_tz = tzoneu2s(activity_start_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..advertising_contact) ) %then %do;
 ...
 data &tmplib..advertising_contact_tmp         ;
  ...
  if advertising_contact_dttm ne . then advertising_contact_dttm = tzoneu2s(advertising_contact_dttm,'AMERICA/NEW_YORK') ; if advertising_contact_dttm_tz ne . then advertising_contact_dttm_tz = tzoneu2s(advertising_contact_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..asset_details) ) %then %do;
 ...
 data &tmplib..asset_details_tmp               ;
  ...
  if asset_locked_dttm ne . then asset_locked_dttm = tzoneu2s(asset_locked_dttm,'AMERICA/NEW_YORK') ; if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if download_disabled_dttm ne . then download_disabled_dttm = tzoneu2s(download_disabled_dttm,'AMERICA/NEW_YORK') ; if expired_dttm ne . then expired_dttm = tzoneu2s(expired_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if recycled_dttm ne . then recycled_dttm = tzoneu2s(recycled_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..asset_details_custom_prop) ) %then %do;
 ...
 data &tmplib..asset_details_custom_prop_tmp   ;
  ...
  if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..audience_membership_change) ) %then %do;
 ...
 data &tmplib..audience_membership_change_tmp  ;
  ...
  if audience_change_dttm ne . then audience_change_dttm = tzoneu2s(audience_change_dttm,'AMERICA/NEW_YORK') ; if audience_change_dttm_tz ne . then audience_change_dttm_tz = tzoneu2s(audience_change_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..business_process_details) ) %then %do;
 ...
 data &tmplib..business_process_details_tmp    ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if process_dttm ne . then process_dttm = tzoneu2s(process_dttm,'AMERICA/NEW_YORK') ; if process_dttm_tz ne . then process_dttm_tz = tzoneu2s(process_dttm_tz,'AMERICA/NEW_YORK') ; if process_exception_dttm ne . then process_exception_dttm = tzoneu2s(process_exception_dttm,'AMERICA/NEW_YORK') ; if process_exception_dttm_tz ne . then process_exception_dttm_tz = tzoneu2s(process_exception_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cart_activity_details) ) %then %do;
 ...
 data &tmplib..cart_activity_details_tmp       ;
  ...
  if activity_dttm ne . then activity_dttm = tzoneu2s(activity_dttm,'AMERICA/NEW_YORK') ; if activity_dttm_tz ne . then activity_dttm_tz = tzoneu2s(activity_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_activity_custom_attr) ) %then %do;
 ...
 data &tmplib..cdm_activity_custom_attr_tmp    ;
  ...
  if attribute_dttm_val ne . then attribute_dttm_val = tzoneu2s(attribute_dttm_val,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_activity_detail) ) %then %do;
 ...
 data &tmplib..cdm_activity_detail_tmp         ;
  ...
  if last_published_dttm ne . then last_published_dttm = tzoneu2s(last_published_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_activity_x_task) ) %then %do;
 ...
 data &tmplib..cdm_activity_x_task_tmp         ;
  ...
  if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_audience_detail) ) %then %do;
 ...
 data &tmplib..cdm_audience_detail_tmp         ;
  ...
  if create_dttm ne . then create_dttm = tzoneu2s(create_dttm,'AMERICA/NEW_YORK') ; if delete_dttm ne . then delete_dttm = tzoneu2s(delete_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_audience_occur_detail) ) %then %do;
 ...
 data &tmplib..cdm_audience_occur_detail_tmp   ;
  ...
  if end_dttm ne . then end_dttm = tzoneu2s(end_dttm,'AMERICA/NEW_YORK') ; if start_dttm ne . then start_dttm = tzoneu2s(start_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_campaign_detail) ) %then %do;
 ...
 data &tmplib..cdm_campaign_detail_tmp         ;
  ...
  if approval_dttm ne . then approval_dttm = tzoneu2s(approval_dttm,'AMERICA/NEW_YORK') ; if end_dttm ne . then end_dttm = tzoneu2s(end_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if run_dttm ne . then run_dttm = tzoneu2s(run_dttm,'AMERICA/NEW_YORK') ; if start_dttm ne . then start_dttm = tzoneu2s(start_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_contact_history) ) %then %do;
 ...
 data &tmplib..cdm_contact_history_tmp         ;
  ...
  if contact_dttm ne . then contact_dttm = tzoneu2s(contact_dttm,'AMERICA/NEW_YORK') ; if contact_dttm_tz ne . then contact_dttm_tz = tzoneu2s(contact_dttm_tz,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_content_detail) ) %then %do;
 ...
 data &tmplib..cdm_content_detail_tmp          ;
  ...
  if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_identity_attr) ) %then %do;
 ...
 data &tmplib..cdm_identity_attr_tmp           ;
  ...
  if entry_dttm ne . then entry_dttm = tzoneu2s(entry_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_response_history) ) %then %do;
 ...
 data &tmplib..cdm_response_history_tmp        ;
  ...
  if response_dttm ne . then response_dttm = tzoneu2s(response_dttm,'AMERICA/NEW_YORK') ; if response_dttm_tz ne . then response_dttm_tz = tzoneu2s(response_dttm_tz,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_rtc_detail) ) %then %do;
 ...
 data &tmplib..cdm_rtc_detail_tmp              ;
  ...
  if processed_dttm ne . then processed_dttm = tzoneu2s(processed_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..cdm_task_detail) ) %then %do;
 ...
 data &tmplib..cdm_task_detail_tmp             ;
  ...
  if export_dttm ne . then export_dttm = tzoneu2s(export_dttm,'AMERICA/NEW_YORK') ; if scheduled_end_dttm ne . then scheduled_end_dttm = tzoneu2s(scheduled_end_dttm,'AMERICA/NEW_YORK') ; if scheduled_start_dttm ne . then scheduled_start_dttm = tzoneu2s(scheduled_start_dttm,'AMERICA/NEW_YORK') ; if updated_dttm ne . then updated_dttm = tzoneu2s(updated_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..commitment_details) ) %then %do;
 ...
 data &tmplib..commitment_details_tmp          ;
  ...
  if cmtmnt_created_dttm ne . then cmtmnt_created_dttm = tzoneu2s(cmtmnt_created_dttm,'AMERICA/NEW_YORK') ; if cmtmnt_payment_dttm ne . then cmtmnt_payment_dttm = tzoneu2s(cmtmnt_payment_dttm,'AMERICA/NEW_YORK') ; if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..contact_history) ) %then %do;
 ...
 data &tmplib..contact_history_tmp             ;
  ...
  if contact_dttm ne . then contact_dttm = tzoneu2s(contact_dttm,'AMERICA/NEW_YORK') ; if contact_dttm_tz ne . then contact_dttm_tz = tzoneu2s(contact_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if contact_id='' then contact_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..conversion_milestone) ) %then %do;
 ...
 data &tmplib..conversion_milestone_tmp        ;
  ...
  if conversion_milestone_dttm ne . then conversion_milestone_dttm = tzoneu2s(conversion_milestone_dttm,'AMERICA/NEW_YORK') ; if conversion_milestone_dttm_tz ne . then conversion_milestone_dttm_tz = tzoneu2s(conversion_milestone_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..custom_events) ) %then %do;
 ...
 data &tmplib..custom_events_tmp               ;
  ...
  if custom_event_dttm ne . then custom_event_dttm = tzoneu2s(custom_event_dttm,'AMERICA/NEW_YORK') ; if custom_event_dttm_tz ne . then custom_event_dttm_tz = tzoneu2s(custom_event_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..custom_events_ext) ) %then %do;
 ...
 data &tmplib..custom_events_ext_tmp           ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..data_view_details) ) %then %do;
 ...
 data &tmplib..data_view_details_tmp           ;
  ...
  if data_view_dttm ne . then data_view_dttm = tzoneu2s(data_view_dttm,'AMERICA/NEW_YORK') ; if data_view_dttm_tz ne . then data_view_dttm_tz = tzoneu2s(data_view_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_adv_campaign_visitors) ) %then %do;
 ...
 data &tmplib..dbt_adv_campaign_visitors_tmp   ;
  ...
  if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK') ; if visit_dttm ne . then visit_dttm = tzoneu2s(visit_dttm,'AMERICA/NEW_YORK') ; if visit_dttm_tz ne . then visit_dttm_tz = tzoneu2s(visit_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_business_process) ) %then %do;
 ...
 data &tmplib..dbt_business_process_tmp        ;
  ...
  if bus_process_started_dttm ne . then bus_process_started_dttm = tzoneu2s(bus_process_started_dttm,'AMERICA/NEW_YORK') ; if bus_process_started_dttm_tz ne . then bus_process_started_dttm_tz = tzoneu2s(bus_process_started_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_content) ) %then %do;
 ...
 data &tmplib..dbt_content_tmp                 ;
  ...
  if detail_dttm ne . then detail_dttm = tzoneu2s(detail_dttm,'AMERICA/NEW_YORK') ; if detail_dttm_tz ne . then detail_dttm_tz = tzoneu2s(detail_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_documents) ) %then %do;
 ...
 data &tmplib..dbt_documents_tmp               ;
  ...
  if document_download_dttm ne . then document_download_dttm = tzoneu2s(document_download_dttm,'AMERICA/NEW_YORK') ; if document_download_dttm_tz ne . then document_download_dttm_tz = tzoneu2s(document_download_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_ecommerce) ) %then %do;
 ...
 data &tmplib..dbt_ecommerce_tmp               ;
  ...
  if product_activity_dttm ne . then product_activity_dttm = tzoneu2s(product_activity_dttm,'AMERICA/NEW_YORK') ; if product_activity_dttm_tz ne . then product_activity_dttm_tz = tzoneu2s(product_activity_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_forms) ) %then %do;
 ...
 data &tmplib..dbt_forms_tmp                   ;
     set work.dbt_forms;
  if form_attempt_dttm ne . then form_attempt_dttm = tzoneu2s(form_attempt_dttm,'AMERICA/NEW_YORK') ; if form_attempt_dttm_tz ne . then form_attempt_dttm_tz = tzoneu2s(form_attempt_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_goals) ) %then %do;
 ...
 data &tmplib..dbt_goals_tmp                   ;
     set work.dbt_goals;
  if goal_reached_dttm ne . then goal_reached_dttm = tzoneu2s(goal_reached_dttm,'AMERICA/NEW_YORK') ; if goal_reached_dttm_tz ne . then goal_reached_dttm_tz = tzoneu2s(goal_reached_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
  if session_id='' then session_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..dbt_media_consumption) ) %then %do;
 ...
 data &tmplib..dbt_media_consumption_tmp       ;
  ...
  if media_start_dttm ne . then media_start_dttm = tzoneu2s(media_start_dttm,'AMERICA/NEW_YORK') ; if media_start_dttm_tz ne . then media_start_dttm_tz = tzoneu2s(media_start_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_promotions) ) %then %do;
 ...
 data &tmplib..dbt_promotions_tmp              ;
  ...
  if promotion_shown_dttm ne . then promotion_shown_dttm = tzoneu2s(promotion_shown_dttm,'AMERICA/NEW_YORK') ; if promotion_shown_dttm_tz ne . then promotion_shown_dttm_tz = tzoneu2s(promotion_shown_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..dbt_search) ) %then %do;
 ...
 data &tmplib..dbt_search_tmp                  ;
     set work.dbt_search;
  if search_results_dttm ne . then search_results_dttm = tzoneu2s(search_results_dttm,'AMERICA/NEW_YORK') ; if search_results_dttm_tz ne . then search_results_dttm_tz = tzoneu2s(search_results_dttm_tz,'AMERICA/NEW_YORK') ; if session_complete_load_dttm ne . then session_complete_load_dttm = tzoneu2s(session_complete_load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..direct_contact) ) %then %do;
 ...
 data &tmplib..direct_contact_tmp              ;
  ...
  if direct_contact_dttm ne . then direct_contact_dttm = tzoneu2s(direct_contact_dttm,'AMERICA/NEW_YORK') ; if direct_contact_dttm_tz ne . then direct_contact_dttm_tz = tzoneu2s(direct_contact_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..document_details) ) %then %do;
 ...
 data &tmplib..document_details_tmp            ;
  ...
  if link_event_dttm ne . then link_event_dttm = tzoneu2s(link_event_dttm,'AMERICA/NEW_YORK') ; if link_event_dttm_tz ne . then link_event_dttm_tz = tzoneu2s(link_event_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..email_bounce) ) %then %do;
 ...
 data &tmplib..email_bounce_tmp                ;
  ...
  if email_bounce_dttm ne . then email_bounce_dttm = tzoneu2s(email_bounce_dttm,'AMERICA/NEW_YORK') ; if email_bounce_dttm_tz ne . then email_bounce_dttm_tz = tzoneu2s(email_bounce_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_click) ) %then %do;
 ...
 data &tmplib..email_click_tmp                 ;
  ...
  if email_click_dttm ne . then email_click_dttm = tzoneu2s(email_click_dttm,'AMERICA/NEW_YORK') ; if email_click_dttm_tz ne . then email_click_dttm_tz = tzoneu2s(email_click_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_complaint) ) %then %do;
 ...
 data &tmplib..email_complaint_tmp             ;
  ...
  if email_complaint_dttm ne . then email_complaint_dttm = tzoneu2s(email_complaint_dttm,'AMERICA/NEW_YORK') ; if email_complaint_dttm_tz ne . then email_complaint_dttm_tz = tzoneu2s(email_complaint_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_open) ) %then %do;
 ...
 data &tmplib..email_open_tmp                  ;
     set work.email_open;
  if email_open_dttm ne . then email_open_dttm = tzoneu2s(email_open_dttm,'AMERICA/NEW_YORK') ; if email_open_dttm_tz ne . then email_open_dttm_tz = tzoneu2s(email_open_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_optout) ) %then %do;
 ...
 data &tmplib..email_optout_tmp                ;
  ...
  if email_optout_dttm ne . then email_optout_dttm = tzoneu2s(email_optout_dttm,'AMERICA/NEW_YORK') ; if email_optout_dttm_tz ne . then email_optout_dttm_tz = tzoneu2s(email_optout_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_optout_details) ) %then %do;
 ...
 data &tmplib..email_optout_details_tmp        ;
  ...
  if email_action_dttm ne . then email_action_dttm = tzoneu2s(email_action_dttm,'AMERICA/NEW_YORK') ; if email_action_dttm_tz ne . then email_action_dttm_tz = tzoneu2s(email_action_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_reply) ) %then %do;
 ...
 data &tmplib..email_reply_tmp                 ;
  ...
  if email_reply_dttm ne . then email_reply_dttm = tzoneu2s(email_reply_dttm,'AMERICA/NEW_YORK') ; if email_reply_dttm_tz ne . then email_reply_dttm_tz = tzoneu2s(email_reply_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_send) ) %then %do;
 ...
 data &tmplib..email_send_tmp                  ;
     set work.email_send;
  if email_send_dttm ne . then email_send_dttm = tzoneu2s(email_send_dttm,'AMERICA/NEW_YORK') ; if email_send_dttm_tz ne . then email_send_dttm_tz = tzoneu2s(email_send_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..email_view) ) %then %do;
 ...
 data &tmplib..email_view_tmp                  ;
     set work.email_view;
  if email_view_dttm ne . then email_view_dttm = tzoneu2s(email_view_dttm,'AMERICA/NEW_YORK') ; if email_view_dttm_tz ne . then email_view_dttm_tz = tzoneu2s(email_view_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..external_event) ) %then %do;
 ...
 data &tmplib..external_event_tmp              ;
  ...
  if external_event_dttm ne . then external_event_dttm = tzoneu2s(external_event_dttm,'AMERICA/NEW_YORK') ; if external_event_dttm_tz ne . then external_event_dttm_tz = tzoneu2s(external_event_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..form_details) ) %then %do;
 ...
 data &tmplib..form_details_tmp                ;
  ...
  if form_field_detail_dttm ne . then form_field_detail_dttm = tzoneu2s(form_field_detail_dttm,'AMERICA/NEW_YORK') ; if form_field_detail_dttm_tz ne . then form_field_detail_dttm_tz = tzoneu2s(form_field_detail_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..identity_attributes) ) %then %do;
 ...
 data &tmplib..identity_attributes_tmp         ;
  ...
  if entrytime ne . then entrytime = tzoneu2s(entrytime,'AMERICA/NEW_YORK') ; if processed_dttm ne . then processed_dttm = tzoneu2s(processed_dttm,'AMERICA/NEW_YORK');
  if identifier_type_id='' then identifier_type_id='-'; if identity_id='' then identity_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..impression_delivered) ) %then %do;
 ...
 data &tmplib..impression_delivered_tmp        ;
  ...
  if impression_delivered_dttm ne . then impression_delivered_dttm = tzoneu2s(impression_delivered_dttm,'AMERICA/NEW_YORK') ; if impression_delivered_dttm_tz ne . then impression_delivered_dttm_tz = tzoneu2s(impression_delivered_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..impression_spot_viewable) ) %then %do;
 ...
 data &tmplib..impression_spot_viewable_tmp    ;
  ...
  if impression_viewable_dttm ne . then impression_viewable_dttm = tzoneu2s(impression_viewable_dttm,'AMERICA/NEW_YORK') ; if impression_viewable_dttm_tz ne . then impression_viewable_dttm_tz = tzoneu2s(impression_viewable_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..in_app_failed) ) %then %do;
 ...
 data &tmplib..in_app_failed_tmp               ;
  ...
  if in_app_failed_dttm ne . then in_app_failed_dttm = tzoneu2s(in_app_failed_dttm,'AMERICA/NEW_YORK') ; if in_app_failed_dttm_tz ne . then in_app_failed_dttm_tz = tzoneu2s(in_app_failed_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..in_app_message) ) %then %do;
 ...
 data &tmplib..in_app_message_tmp              ;
  ...
  if in_app_action_dttm ne . then in_app_action_dttm = tzoneu2s(in_app_action_dttm,'AMERICA/NEW_YORK') ; if in_app_action_dttm_tz ne . then in_app_action_dttm_tz = tzoneu2s(in_app_action_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..in_app_send) ) %then %do;
 ...
 data &tmplib..in_app_send_tmp                 ;
  ...
  if in_app_send_dttm ne . then in_app_send_dttm = tzoneu2s(in_app_send_dttm,'AMERICA/NEW_YORK') ; if in_app_send_dttm_tz ne . then in_app_send_dttm_tz = tzoneu2s(in_app_send_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..in_app_targeting_request) ) %then %do;
 ...
 data &tmplib..in_app_targeting_request_tmp    ;
  ...
  if in_app_tgt_request_dttm ne . then in_app_tgt_request_dttm = tzoneu2s(in_app_tgt_request_dttm,'AMERICA/NEW_YORK') ; if in_app_tgt_request_dttm_tz ne . then in_app_tgt_request_dttm_tz = tzoneu2s(in_app_tgt_request_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..invoice_details) ) %then %do;
 ...
 data &tmplib..invoice_details_tmp             ;
  ...
  if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if invoice_created_dttm ne . then invoice_created_dttm = tzoneu2s(invoice_created_dttm,'AMERICA/NEW_YORK') ; if invoice_reconciled_dttm ne . then invoice_reconciled_dttm = tzoneu2s(invoice_reconciled_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if payment_dttm ne . then payment_dttm = tzoneu2s(payment_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..md_activity) ) %then %do;
 ...
 data &tmplib..md_activity_tmp                 ;
  ...
  if last_published_dttm ne . then last_published_dttm = tzoneu2s(last_published_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
  if activity_version_id='' then activity_version_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..md_activity_abtestpath) ) %then %do;
 ...
 data &tmplib..md_activity_abtestpath_tmp      ;
  ...
  if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..md_audience) ) %then %do;
 ...
 data &tmplib..md_audience_tmp                 ;
  ...
  if create_dttm ne . then create_dttm = tzoneu2s(create_dttm,'AMERICA/NEW_YORK') ; if delete_dttm ne . then delete_dttm = tzoneu2s(delete_dttm,'AMERICA/NEW_YORK');
  if audience_id='' then audience_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..md_audience_occurrence) ) %then %do;
 ...
 data &tmplib..md_audience_occurrence_tmp      ;
  ...
  if end_tm ne . then end_tm = tzoneu2s(end_tm,'AMERICA/NEW_YORK') ; if start_tm ne . then start_tm = tzoneu2s(start_tm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..md_custattrib_table_values) ) %then %do;
 ...
 %if %sysfunc(exist(&tmplib..md_custattrib_table_values_tmp  ) ) %then %do;
      ...
      quit;
 %end;
 %check_duplicate_from_source(table_nm=md_custattrib_table_values, table_keys=%str(attr_group_id,attr_id), out_table=work.md_custattrib_table_values);
 ...
 %if &errFlag = 0 %then %do;
    ...
    connect to SQLSVR (DATASRC=&dbsrc user=&dbuser password=&dbpass);
        execute (merge into &dbschema..md_custattrib_table_values using &tmpdbschema..md_custattrib_table_values_tmp  
         on (md_custattrib_table_values.attr_group_id=md_custattrib_table_values_tmp.attr_group_id and md_custattrib_table_values.attr_id=md_custattrib_table_values_tmp.attr_id)
        when matched then  
        update set md_custattrib_table_values.attr_cd = md_custattrib_table_values_tmp.attr_cd , md_custattrib_table_values.attr_group_cd = md_custattrib_table_values_tmp.attr_group_cd , md_custattrib_table_values.attr_group_nm = md_custattrib_table_values_tmp.attr_group_nm , md_custattrib_table_values.attr_nm = md_custattrib_table_values_tmp.attr_nm , md_custattrib_table_values.created_by_usernm = md_custattrib_table_values_tmp.created_by_usernm , md_custattrib_table_values.created_dttm = md_custattrib_table_values_tmp.created_dttm , md_custattrib_table_values.data_formatter = md_custattrib_table_values_tmp.data_formatter , md_custattrib_table_values.data_type = md_custattrib_table_values_tmp.data_type , md_custattrib_table_values.is_obsolete_flg = md_custattrib_table_values_tmp.is_obsolete_flg , md_custattrib_table_values.last_modified_dttm = md_custattrib_table_values_tmp.last_modified_dttm , md_custattrib_table_values.last_modified_usernm = md_custattrib_table_values_tmp.last_modified_usernm , md_custattrib_table_values.load_dttm = md_custattrib_table_values_tmp.load_dttm , md_custattrib_table_values.table_val = md_custattrib_table_values_tmp.table_val
        when not matched then insert ( 
...
%if %sysfunc(exist(&udmmart..md_rtc) ) %then %do;
 ...
 data &tmplib..md_rtc_tmp                      ;
     set work.md_rtc;
  if rtc_dttm ne . then rtc_dttm = tzoneu2s(rtc_dttm,'AMERICA/NEW_YORK');
  if rtc_id='' then rtc_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..md_segment_map) ) %then %do;
 ...
 data &tmplib..md_segment_map_tmp              ;
  ...
  if last_published_dttm ne . then last_published_dttm = tzoneu2s(last_published_dttm,'AMERICA/NEW_YORK') ; if rec_scheduled_end_dttm ne . then rec_scheduled_end_dttm = tzoneu2s(rec_scheduled_end_dttm,'AMERICA/NEW_YORK') ; if rec_scheduled_start_dttm ne . then rec_scheduled_start_dttm = tzoneu2s(rec_scheduled_start_dttm,'AMERICA/NEW_YORK') ; if scheduled_end_dttm ne . then scheduled_end_dttm = tzoneu2s(scheduled_end_dttm,'AMERICA/NEW_YORK') ; if scheduled_start_dttm ne . then scheduled_start_dttm = tzoneu2s(scheduled_start_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
  if segment_map_version_id='' then segment_map_version_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..md_segment_map_x_segment) ) %then %do;
 ...
 %if %sysfunc(exist(&tmplib..md_segment_map_x_segment_tmp    ) ) %then %do;
      ...
      quit;
 %end;
 %check_duplicate_from_source(table_nm=md_segment_map_x_segment, table_keys=%str(segment_map_version_id,segment_version_id), out_table=work.md_segment_map_x_segment);
 data &tmplib..md_segment_map_x_segment_tmp    ;
     set work.md_segment_map_x_segment;
  if segment_map_version_id='' then segment_map_version_id='-'; if segment_version_id='' then segment_version_id='-';
 run;
 ...
 %if &errFlag = 0 %then %do;
    ...
    connect to SQLSVR (DATASRC=&dbsrc user=&dbuser password=&dbpass);
        execute (merge into &dbschema..md_segment_map_x_segment using &tmpdbschema..md_segment_map_x_segment_tmp    
         on (md_segment_map_x_segment.segment_map_version_id=md_segment_map_x_segment_tmp.segment_map_version_id and md_segment_map_x_segment.segment_version_id=md_segment_map_x_segment_tmp.segment_version_id)
        when matched then  
        update set md_segment_map_x_segment.segment_id = md_segment_map_x_segment_tmp.segment_id , md_segment_map_x_segment.segment_map_id = md_segment_map_x_segment_tmp.segment_map_id , md_segment_map_x_segment.segment_map_status_cd = md_segment_map_x_segment_tmp.segment_map_status_cd
        when not matched then insert ( 
...
%if %sysfunc(exist(&udmmart..md_target_assist) ) %then %do;
 ...
 data &tmplib..md_target_assist_tmp            ;
  ...
  if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if model_available_dttm ne . then model_available_dttm = tzoneu2s(model_available_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..md_task) ) %then %do;
 ...
 data &tmplib..md_task_tmp                     ;
     set work.md_task;
  if last_published_dttm ne . then last_published_dttm = tzoneu2s(last_published_dttm,'AMERICA/NEW_YORK') ; if model_start_dttm ne . then model_start_dttm = tzoneu2s(model_start_dttm,'AMERICA/NEW_YORK') ; if rec_scheduled_end_dttm ne . then rec_scheduled_end_dttm = tzoneu2s(rec_scheduled_end_dttm,'AMERICA/NEW_YORK') ; if rec_scheduled_start_dttm ne . then rec_scheduled_start_dttm = tzoneu2s(rec_scheduled_start_dttm,'AMERICA/NEW_YORK') ; if scheduled_end_dttm ne . then scheduled_end_dttm = tzoneu2s(scheduled_end_dttm,'AMERICA/NEW_YORK') ; if scheduled_start_dttm ne . then scheduled_start_dttm = tzoneu2s(scheduled_start_dttm,'AMERICA/NEW_YORK') ; if valid_from_dttm ne . then valid_from_dttm = tzoneu2s(valid_from_dttm,'AMERICA/NEW_YORK') ; if valid_to_dttm ne . then valid_to_dttm = tzoneu2s(valid_to_dttm,'AMERICA/NEW_YORK');
  if task_version_id='' then task_version_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..media_activity_details) ) %then %do;
 ...
 data &tmplib..media_activity_details_tmp      ;
  ...
  if action_dttm ne . then action_dttm = tzoneu2s(action_dttm,'AMERICA/NEW_YORK') ; if action_dttm_tz ne . then action_dttm_tz = tzoneu2s(action_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..media_details) ) %then %do;
 ...
 data &tmplib..media_details_tmp               ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if play_start_dttm ne . then play_start_dttm = tzoneu2s(play_start_dttm,'AMERICA/NEW_YORK') ; if play_start_dttm_tz ne . then play_start_dttm_tz = tzoneu2s(play_start_dttm_tz,'AMERICA/NEW_YORK');
  if detail_id='' then detail_id='-'; if media_nm='' then media_nm='-';
 run;
...
%if %sysfunc(exist(&udmmart..media_details_ext) ) %then %do;
 ...
 data &tmplib..media_details_ext_tmp           ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if play_end_dttm ne . then play_end_dttm = tzoneu2s(play_end_dttm,'AMERICA/NEW_YORK') ; if play_end_dttm_tz ne . then play_end_dttm_tz = tzoneu2s(play_end_dttm_tz,'AMERICA/NEW_YORK');
  if detail_id='' then detail_id='-'; if media_nm='' then media_nm='-';
 run;
...
%if %sysfunc(exist(&udmmart..notification_failed) ) %then %do;
 ...
 data &tmplib..notification_failed_tmp         ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if notification_failed_dttm ne . then notification_failed_dttm = tzoneu2s(notification_failed_dttm,'AMERICA/NEW_YORK') ; if notification_failed_dttm_tz ne . then notification_failed_dttm_tz = tzoneu2s(notification_failed_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..notification_opened) ) %then %do;
 ...
 data &tmplib..notification_opened_tmp         ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if notification_opened_dttm ne . then notification_opened_dttm = tzoneu2s(notification_opened_dttm,'AMERICA/NEW_YORK') ; if notification_opened_dttm_tz ne . then notification_opened_dttm_tz = tzoneu2s(notification_opened_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..notification_send) ) %then %do;
 ...
 data &tmplib..notification_send_tmp           ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if notification_send_dttm ne . then notification_send_dttm = tzoneu2s(notification_send_dttm,'AMERICA/NEW_YORK') ; if notification_send_dttm_tz ne . then notification_send_dttm_tz = tzoneu2s(notification_send_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..notification_targeting_request) ) %then %do;
 ...
 data &tmplib..notification_targeting_reque_tmp;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if notification_tgt_req_dttm ne . then notification_tgt_req_dttm = tzoneu2s(notification_tgt_req_dttm,'AMERICA/NEW_YORK') ; if notification_tgt_req_dttm_tz ne . then notification_tgt_req_dttm_tz = tzoneu2s(notification_tgt_req_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..outbound_system) ) %then %do;
 ...
 data &tmplib..outbound_system_tmp             ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if outbound_system_dttm ne . then outbound_system_dttm = tzoneu2s(outbound_system_dttm,'AMERICA/NEW_YORK') ; if outbound_system_dttm_tz ne . then outbound_system_dttm_tz = tzoneu2s(outbound_system_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..page_details) ) %then %do;
 ...
 data &tmplib..page_details_tmp                ;
  ...
  if detail_dttm ne . then detail_dttm = tzoneu2s(detail_dttm,'AMERICA/NEW_YORK') ; if detail_dttm_tz ne . then detail_dttm_tz = tzoneu2s(detail_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..page_errors) ) %then %do;
 ...
 data &tmplib..page_errors_tmp                 ;
  ...
  if in_page_error_dttm ne . then in_page_error_dttm = tzoneu2s(in_page_error_dttm,'AMERICA/NEW_YORK') ; if in_page_error_dttm_tz ne . then in_page_error_dttm_tz = tzoneu2s(in_page_error_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..planning_info) ) %then %do;
 ...
 data &tmplib..planning_info_tmp               ;
  ...
  if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if planned_end_dttm ne . then planned_end_dttm = tzoneu2s(planned_end_dttm,'AMERICA/NEW_YORK') ; if planned_start_dttm ne . then planned_start_dttm = tzoneu2s(planned_start_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..promotion_displayed) ) %then %do;
 ...
 data &tmplib..promotion_displayed_tmp         ;
  ...
  if display_dttm ne . then display_dttm = tzoneu2s(display_dttm,'AMERICA/NEW_YORK') ; if display_dttm_tz ne . then display_dttm_tz = tzoneu2s(display_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..promotion_used) ) %then %do;
 ...
 data &tmplib..promotion_used_tmp              ;
  ...
  if click_dttm ne . then click_dttm = tzoneu2s(click_dttm,'AMERICA/NEW_YORK') ; if click_dttm_tz ne . then click_dttm_tz = tzoneu2s(click_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK');
  if detail_id='' then detail_id='-'; if promotion_nm='' then promotion_nm='-';
 run;
...
%if %sysfunc(exist(&udmmart..response_history) ) %then %do;
 ...
 data &tmplib..response_history_tmp            ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if response_dttm ne . then response_dttm = tzoneu2s(response_dttm,'AMERICA/NEW_YORK') ; if response_dttm_tz ne . then response_dttm_tz = tzoneu2s(response_dttm_tz,'AMERICA/NEW_YORK');
  if response_id='' then response_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..search_results) ) %then %do;
 ...
 data &tmplib..search_results_tmp              ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if search_results_dttm ne . then search_results_dttm = tzoneu2s(search_results_dttm,'AMERICA/NEW_YORK') ; if search_results_dttm_tz ne . then search_results_dttm_tz = tzoneu2s(search_results_dttm_tz,'AMERICA/NEW_YORK');
  if detail_id='' then detail_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..session_details) ) %then %do;
 ...
 data &tmplib..session_details_tmp             ;
  ...
  if client_session_start_dttm ne . then client_session_start_dttm = tzoneu2s(client_session_start_dttm,'AMERICA/NEW_YORK') ; if client_session_start_dttm_tz ne . then client_session_start_dttm_tz = tzoneu2s(client_session_start_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm ne . then session_start_dttm = tzoneu2s(session_start_dttm,'AMERICA/NEW_YORK') ; if session_start_dttm_tz ne . then session_start_dttm_tz = tzoneu2s(session_start_dttm_tz,'AMERICA/NEW_YORK');
  if session_id='' then session_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..session_details_ext) ) %then %do;
 ...
 data &tmplib..session_details_ext_tmp         ;
  ...
  if last_session_activity_dttm ne . then last_session_activity_dttm = tzoneu2s(last_session_activity_dttm,'AMERICA/NEW_YORK') ; if last_session_activity_dttm_tz ne . then last_session_activity_dttm_tz = tzoneu2s(last_session_activity_dttm_tz,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if session_expiration_dttm ne . then session_expiration_dttm = tzoneu2s(session_expiration_dttm,'AMERICA/NEW_YORK') ; if session_expiration_dttm_tz ne . then session_expiration_dttm_tz = tzoneu2s(session_expiration_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..spot_clicked) ) %then %do;
 ...
 data &tmplib..spot_clicked_tmp                ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if spot_clicked_dttm ne . then spot_clicked_dttm = tzoneu2s(spot_clicked_dttm,'AMERICA/NEW_YORK') ; if spot_clicked_dttm_tz ne . then spot_clicked_dttm_tz = tzoneu2s(spot_clicked_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..spot_requested) ) %then %do;
 ...
 data &tmplib..spot_requested_tmp              ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if spot_requested_dttm ne . then spot_requested_dttm = tzoneu2s(spot_requested_dttm,'AMERICA/NEW_YORK') ; if spot_requested_dttm_tz ne . then spot_requested_dttm_tz = tzoneu2s(spot_requested_dttm_tz,'AMERICA/NEW_YORK');
  if event_id='' then event_id='-';
 run;
...
%if %sysfunc(exist(&udmmart..visit_details) ) %then %do;
 ...
 data &tmplib..visit_details_tmp               ;
  ...
  if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if visit_dttm ne . then visit_dttm = tzoneu2s(visit_dttm,'AMERICA/NEW_YORK') ; if visit_dttm_tz ne . then visit_dttm_tz = tzoneu2s(visit_dttm_tz,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..wf_process_details) ) %then %do;
 ...
 data &tmplib..wf_process_details_tmp          ;
  ...
  if completed_dttm ne . then completed_dttm = tzoneu2s(completed_dttm,'AMERICA/NEW_YORK') ; if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if deleted_dttm ne . then deleted_dttm = tzoneu2s(deleted_dttm,'AMERICA/NEW_YORK') ; if indexed_dttm ne . then indexed_dttm = tzoneu2s(indexed_dttm,'AMERICA/NEW_YORK') ; if last_modified_dttm ne . then last_modified_dttm = tzoneu2s(last_modified_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if planned_end_dttm ne . then planned_end_dttm = tzoneu2s(planned_end_dttm,'AMERICA/NEW_YORK') ; if projected_end_dttm ne . then projected_end_dttm = tzoneu2s(projected_end_dttm,'AMERICA/NEW_YORK') ; if published_dttm ne . then published_dttm = tzoneu2s(published_dttm,'AMERICA/NEW_YORK') ; if start_dttm ne . then start_dttm = tzoneu2s(start_dttm,'AMERICA/NEW_YORK') ; if submitted_dttm ne . then submitted_dttm = tzoneu2s(submitted_dttm,'AMERICA/NEW_YORK') ; if timeline_calculated_dttm ne . then timeline_calculated_dttm = tzoneu2s(timeline_calculated_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..wf_process_tasks) ) %then %do;
 ...
 data &tmplib..wf_process_tasks_tmp            ;
  ...
  if completed_dttm ne . then completed_dttm = tzoneu2s(completed_dttm,'AMERICA/NEW_YORK') ; if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if deleted_dttm ne . then deleted_dttm = tzoneu2s(deleted_dttm,'AMERICA/NEW_YORK') ; if due_dttm ne . then due_dttm = tzoneu2s(due_dttm,'AMERICA/NEW_YORK') ; if engine_task_cancelled_dttm ne . then engine_task_cancelled_dttm = tzoneu2s(engine_task_cancelled_dttm,'AMERICA/NEW_YORK') ; if indexed_dttm ne . then indexed_dttm = tzoneu2s(indexed_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if modified_dttm ne . then modified_dttm = tzoneu2s(modified_dttm,'AMERICA/NEW_YORK') ; if projected_end_dttm ne . then projected_end_dttm = tzoneu2s(projected_end_dttm,'AMERICA/NEW_YORK') ; if projected_start_dttm ne . then projected_start_dttm = tzoneu2s(projected_start_dttm,'AMERICA/NEW_YORK') ; if published_dttm ne . then published_dttm = tzoneu2s(published_dttm,'AMERICA/NEW_YORK') ; if started_dttm ne . then started_dttm = tzoneu2s(started_dttm,'AMERICA/NEW_YORK');
...
%if %sysfunc(exist(&udmmart..wf_tasks_user_assignment) ) %then %do;
 ...
 data &tmplib..wf_tasks_user_assignment_tmp    ;
  ...
  if completed_dttm ne . then completed_dttm = tzoneu2s(completed_dttm,'AMERICA/NEW_YORK') ; if created_dttm ne . then created_dttm = tzoneu2s(created_dttm,'AMERICA/NEW_YORK') ; if deleted_dttm ne . then deleted_dttm = tzoneu2s(deleted_dttm,'AMERICA/NEW_YORK') ; if due_dttm ne . then due_dttm = tzoneu2s(due_dttm,'AMERICA/NEW_YORK') ; if load_dttm ne . then load_dttm = tzoneu2s(load_dttm,'AMERICA/NEW_YORK') ; if modified_dttm ne . then modified_dttm = tzoneu2s(modified_dttm,'AMERICA/NEW_YORK') ; if projected_end_dttm ne . then projected_end_dttm = tzoneu2s(projected_end_dttm,'AMERICA/NEW_YORK') ; if projected_start_dttm ne . then projected_start_dttm = tzoneu2s(projected_start_dttm,'AMERICA/NEW_YORK') ; if start_dttm ne . then start_dttm = tzoneu2s(start_dttm,'AMERICA/NEW_YORK');
