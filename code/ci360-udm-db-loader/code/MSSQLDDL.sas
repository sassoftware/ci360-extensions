...
/* ****************************************************************************/
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..advertising_contact(
        ...
        ,
        advertising_contact_dttm datetime2 NULL ,advertising_contact_dttm_tz datetime2 NULL ,advertising_platform_nm varchar(100) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_action_nm varchar(40) NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cart_activity_details(
        ...
        ,
        activity_cd varchar(20) NULL ,activity_dttm_tz datetime2 NULL ,availability_message_txt varchar(650) NULL ,cart_id varchar(42) NULL ,cart_nm varchar(100) NULL ,channel_nm varchar(40) NULL ,currency_cd varchar(6) NULL ,displayed_cart_amt decimal(17,2) NULL ,displayed_cart_items_no int NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm datetime2 NULL ,mobile_app_id varchar(40) NULL ,product_group_nm varchar(130) NULL ,properties_map_doc varchar(4000) NULL ,quantity_val int NULL ,saving_message_txt varchar(650) NULL ,shipping_message_txt varchar(650) NULL ,unit_price_amt decimal(17,2) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..contact_history(
        ...
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,contact_channel_nm varchar(19) NULL ,contact_dttm datetime2 NULL ,contact_dttm_tz datetime2 NULL ,contact_nm varchar(256) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,control_group_flg char(1) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,properties_map_doc varchar(4000) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..custom_events(
        ...
        ,
        channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,custom_event_dttm datetime2 NULL ,custom_event_dttm_tz datetime2 NULL ,custom_event_group_nm varchar(256) NULL ,custom_event_nm varchar(256) NULL ,custom_revenue_amt decimal(17,2) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,event_type_nm varchar(20) NULL ,load_dttm datetime2 NULL ,mobile_app_id varchar(64) NULL ,page_id varchar(256) NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..document_details(
        ...
        ,
        alt_txt varchar(1332) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_source_cd varchar(100) NULL ,link_event_dttm_tz datetime2 NULL ,link_id varchar(1332) NULL ,link_name varchar(1332) NULL ,link_selector_path varchar(1332) NULL ,load_dttm datetime2 NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_bounce(
        ...
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,bounce_class_cd varchar(5) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,email_bounce_dttm datetime2 NULL ,email_bounce_dttm_tz datetime2 NULL ,event_nm varchar(256) NULL ,imprint_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,program_id varchar(50) NULL ,properties_map_doc varchar(4000) NULL ,raw_reason_txt varchar(1000) NULL ,reason_txt varchar(1000) NULL ,recipient_domain_nm varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,subject_line_txt varchar(256) NULL ,task_version_id varchar(36) NULL ,test_flg char(1) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_complaint(
        event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,email_complaint_dttm datetime2 NULL ,email_complaint_dttm_tz datetime2 NULL ,event_nm varchar(256) NULL ,imprint_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,program_id varchar(50) NULL ,properties_map_doc varchar(4000) NULL ,recipient_domain_nm varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,subject_line_txt varchar(256) NULL ,task_version_id varchar(36) NULL ,test_flg char(1) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_optout(
        event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,email_optout_dttm datetime2 NULL ,email_optout_dttm_tz datetime2 NULL ,event_nm varchar(256) NULL ,imprint_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,link_tracking_group_txt varchar(256) NULL ,link_tracking_id varchar(4) NULL ,link_tracking_label_txt varchar(256) NULL ,load_dttm datetime2 NULL ,optout_type_nm varchar(50) NULL ,program_id varchar(50) NULL ,properties_map_doc varchar(4000) NULL ,recipient_domain_nm varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,subject_line_txt varchar(256) NULL ,task_version_id varchar(36) NULL ,test_flg char(1) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_optout_details(
        event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,email_action_dttm datetime2 NULL ,email_action_dttm_tz datetime2 NULL ,email_address varchar(300) NULL ,event_nm varchar(256) NULL ,imprint_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,optout_type_nm varchar(50) NULL ,program_id varchar(50) NULL ,properties_map_doc varchar(4000) NULL ,recipient_domain_nm varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,subject_line_txt varchar(256) NULL ,task_version_id varchar(36) NULL ,test_flg char(1) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_reply(
        event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,email_reply_dttm datetime2 NULL ,email_reply_dttm_tz datetime2 NULL ,event_nm varchar(256) NULL ,imprint_id varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,program_id varchar(50) NULL ,properties_map_doc varchar(4000) NULL ,recipient_domain_nm varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,subject_line_txt varchar(256) NULL ,task_version_id varchar(36) NULL ,test_flg char(1) NULL ,uri_txt varchar(1332) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..impression_spot_viewable(
        ...
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,control_group_flg char(1) NULL ,creative_version_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,impression_viewable_dttm datetime2 NULL ,impression_viewable_dttm_tz datetime2 NULL ,load_dttm datetime2 NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,product_id varchar(128) NULL ,product_nm varchar(128) NULL ,product_qty_no int NULL ,product_sku_no varchar(100) NULL ,properties_map_doc varchar(4000) NULL ,rec_group_id varchar(3) NULL ,request_id varchar(36) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_creative(
        ...
        ,
        business_context_id varchar(36) NULL ,created_user_nm varchar(256) NULL ,creative_category_nm varchar(100) NULL ,creative_cd varchar(60) NULL ,creative_desc varchar(256) NULL ,creative_id varchar(36) NULL ,creative_nm varchar(60) NULL ,creative_status_cd varchar(20) NULL ,creative_txt varchar(1500) NULL ,creative_type_nm varchar(40) NULL ,folder_path_nm varchar(256) NULL ,last_published_dttm datetime2 NULL ,owner_nm varchar(256) NULL ,recommender_template_id varchar(36) NULL ,recommender_template_nm varchar(60) NULL ,valid_from_dttm datetime2 NULL ,valid_to_dttm datetime2 NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_custattrib_table_values(
        ...
        ,
        attr_cd varchar(128) NULL ,attr_group_cd varchar(128) NULL ,attr_group_id varchar(128) NULL ,attr_group_nm varchar(128) NULL ,attr_nm varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm datetime2 NULL ,data_formatter varchar(64) NULL ,data_type varchar(32) NULL ,is_obsolete_flg char(1) NULL ,last_modified_dttm datetime2 NULL ,last_modified_usernm varchar(128) NULL ,load_dttm datetime2 NULL
        )) by SQLSVR;
      execute (alter table &dbschema..md_custattrib_table_values add constraint md_custattrib_table_value_pk primary key (attr_id,table_val)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey(
      ...
      execute (alter table &dbschema..md_journey add constraint md_journey_pk primary key (journey_version_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_node(
      ...
      execute (alter table &dbschema..md_journey_node add constraint md_journey_node_pk primary key (journey_node_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_node_occurrence(
      ...
      execute (alter table &dbschema..md_journey_node_occurrence add constraint md_journey_node_occurrenc_pk primary key (journey_node_occurrence_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_occurrence(
      ...
      execute (alter table &dbschema..md_journey_occurrence add constraint md_journey_occurrence_pk primary key (journey_occurrence_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_audience(
      ...
      execute (alter table &dbschema..md_journey_x_audience add constraint md_journey_x_audience_pk primary key (audience_id,journey_version_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_event(
      ...
      execute (alter table &dbschema..md_journey_x_event add constraint md_journey_x_event_pk primary key (event_id,journey_node_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_task(
      ...
      execute (alter table &dbschema..md_journey_x_task add constraint md_journey_x_task_pk primary key (journey_node_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_purpose(
      ...
      execute (alter table &dbschema..md_purpose add constraint md_purpose_pk primary key (purpose_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_map_x_segment(
      ...
      execute (alter table &dbschema..md_segment_map_x_segment add constraint md_segment_map_x_segment_pk primary key (segment_id,segment_map_version_id)) by SQLSVR;
 DISCONNECT FROM SQLSVR;
 QUIT;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_opened(
        creative_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,spot_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,creative_version_id varchar(36) NULL ,event_nm varchar(256) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,notification_opened_dttm datetime2 NULL ,notification_opened_dttm_tz datetime2 NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,reserved_3_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_send(
        creative_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,spot_id varchar(36) NULL ,task_id varchar(36) NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,creative_version_id varchar(36) NULL ,event_nm varchar(256) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,notification_send_dttm datetime2 NULL ,notification_send_dttm_tz datetime2 NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..order_details(
        ...
        ,
        activity_dttm datetime2 NULL ,activity_dttm_tz datetime2 NULL ,availability_message_txt varchar(650) NULL ,cart_id varchar(42) NULL ,cart_nm varchar(100) NULL ,channel_nm varchar(40) NULL ,currency_cd varchar(6) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm datetime2 NULL ,mobile_app_id varchar(40) NULL ,order_id varchar(42) NULL ,product_group_nm varchar(130) NULL ,properties_map_doc varchar(4000) NULL ,quantity_amt int NULL ,reserved_1_txt varchar(100) NULL ,saving_message_txt varchar(650) NULL ,shipping_message_txt varchar(650) NULL ,unit_price_amt decimal(17,2) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..outbound_system(
        ...
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,creative_version_id varchar(36) NULL ,event_nm varchar(256) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,outbound_system_dttm datetime2 NULL ,outbound_system_dttm_tz datetime2 NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..product_views(
        ...
        ,
        action_dttm datetime2 NULL ,action_dttm_tz datetime2 NULL ,availability_message_txt varchar(650) NULL ,channel_nm varchar(40) NULL ,currency_cd varchar(6) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm datetime2 NULL ,mobile_app_id varchar(40) NULL ,price_val decimal(17,2) NULL ,product_group_nm varchar(130) NULL ,properties_map_doc varchar(4000) NULL ,saving_message_txt varchar(650) NULL ,shipping_message_txt varchar(650) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..response_history(
        ...
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm datetime2 NULL ,properties_map_doc varchar(4000) NULL ,response_channel_nm varchar(40) NULL ,response_dttm datetime2 NULL ,response_dttm_tz datetime2 NULL ,response_nm varchar(256) NULL ,task_version_id varchar(36) NULL
        )) by SQLSVR;
 ...
 connect to SQLSVR (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..spot_requested(
        ...
        ,
        channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm datetime2 NULL ,mobile_app_id varchar(40) NULL ,properties_map_doc varchar(4000) NULL ,request_id varchar(36) NULL ,spot_requested_dttm datetime2 NULL ,spot_requested_dttm_tz datetime2 NULL
        )) by SQLSVR;
