...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..ABT_ATTRIBUTION (
      interaction_cost int NULL, conversion_value int NULL, interaction_dttm timestamp NOT NULL, task_id varchar(36) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..ASSET_DETAILS (
      folder_sk numeric NULL, asset_sk numeric NULL, public_media_id numeric NULL, user_rating_cnt numeric NULL, 
      total_user_rating_val numeric NULL, entity_revision_enabled_flg char(1) NULL, folder_deleted_flg char(1) NULL, entity_attribute_enabled_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..ASSET_RENDITION_DETAILS (
      download_cnt numeric NULL, revision_no numeric NULL, rend_deleted_flg char(1) NULL, rev_deleted_flg char(1) NULL, 
      current_revision_flg char(1) NULL, media_dpi decimal(10,2) NULL, file_size int NULL, media_depth int NULL, 
      media_height int NULL, rend_duration int NULL, media_width int NULL, created_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..COMMITMENT_LINE_ITEMS (
      item_qty numeric NULL, item_alloc_unit numeric NULL, item_vend_alloc_unit numeric NULL, vendor_obsolete_flg char(1) NULL, 
      ...
      cc_available_amt decimal(17,2) NULL, item_vend_alloc_amt decimal(17,2) NULL, item_number int NULL, created_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DAILY_USAGE (
      bc_subjcnt_str varchar(4000) NULL, customer_profiles_processed_str varchar(4000) NULL, api_usage_str varchar(4000) NULL, mob_impr_cnt numeric NULL, 
      dm_destinations_total_row_cnt numeric NULL, google_ads_cnt numeric NULL, mob_sesn_cnt numeric NULL, audience_usage_cnt numeric NULL, 
      mobile_in_app_msg_cnt numeric NULL, mobile_push_cnt numeric NULL, email_preview_cnt numeric NULL, facebook_ads_cnt numeric NULL, 
      web_sesn_cnt numeric NULL, plan_users_cnt numeric NULL, outbound_api_cnt numeric NULL, web_impr_cnt numeric NULL, 
      email_send_cnt numeric NULL, linkedin_ads_cnt numeric NULL, dm_destinations_total_id_cnt numeric NULL, asset_size decimal(17,2) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_BUSINESS_PROCESS (
      processes numeric NULL, steps_completed numeric NULL, step_count numeric NULL, processes_completed numeric NULL, 
      steps_abandoned numeric NULL, last_step numeric NULL, processes_abandoned numeric NULL, steps numeric NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_CONTENT (
      total_page_view_time numeric NULL, entry_pages int NULL, active_page_view_time int NULL, views int NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_ECOMMERCE (
      ...
      basket_removes_units int NULL, basket_removes int NULL, baskets_abandoned numeric NULL, baskets_completed numeric NULL, 
      baskets_started numeric NULL, session_complete_load_dttm timestamp NOT NULL, session_start_dttm_tz timestamp NULL, product_activity_dttm_tz timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_FORMS (
      attempts int NULL, forms_completed numeric NULL, forms_not_submitted numeric NULL, forms_started numeric NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_GOALS (
      ...
      goal_reached_dttm timestamp NULL, session_complete_load_dttm timestamp NOT NULL, session_start_dttm_tz timestamp NULL, goals numeric NULL, 
      visitor_type varchar(10) NULL, visitor_id varchar(32) NULL, visit_origination_type varchar(65) NULL, visit_origination_tracking_code varchar(65) NULL, 
      visit_origination_placement varchar(390) NULL, visit_origination_name varchar(260) NULL, visit_origination_creative varchar(260) NULL, visit_id varchar(32) NULL, 
      session_id varchar(29) NULL, goal_name varchar(260) NOT NULL, goal_group_name varchar(130) NOT NULL, device_type varchar(52) NULL, 
   ...
   EXECUTE (ALTER TABLE &dbschema..DBT_GOALS
      ADD CONSTRAINT DBT_GOALS_pk  PRIMARY KEY (DETAIL_ID,GOAL_GROUP_NAME,GOAL_NAME)) BY &database.;
   DISCONNECT FROM &database.;
QUIT;
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_MEDIA_CONSUMPTION (
      ...
      session_complete_load_dttm timestamp NOT NULL, media_start_dttm timestamp NULL, media_start_dttm_tz timestamp NULL, views_started numeric NULL, 
      views_completed numeric NULL, views numeric NULL, media_section_view numeric NULL, visitor_type varchar(10) NULL, 
      visitor_id varchar(32) NULL, visit_origination_type varchar(65) NULL, visit_origination_tracking_code varchar(65) NULL, visit_origination_placement varchar(390) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..FISCAL_CC_BUDGET (
      ...
      cc_bdgt_direct_invoice_amt decimal(17,2) NULL, cc_bdgt_cmtmnt_invoice_cnt int NULL, last_modified_dttm timestamp NULL, created_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..INVOICE_LINE_ITEMS (
      ...
      cc_allocated_amt decimal(17,2) NULL, item_number int NULL, payment_dttm timestamp NULL, load_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..INVOICE_LINE_ITEMS_CCBDGT (
      ...
      item_vend_alloc_unit int NULL, item_alloc_unit int NULL, cc_bdgt_cmtmnt_invoice_cnt int NULL, created_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_ACTIVITY_NODE (
      next_node_val varchar(4000) NULL, previous_node_val varchar(4000) NULL, wait_tm numeric NULL, end_node_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_ACTIVITY_NODE_ALL (
      previous_node_val varchar(4000) NULL, next_node_val varchar(4000) NULL, wait_tm numeric NULL, time_boxed_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_DATAVIEW (
      ...
      analytics_period_val int NULL, max_path_length_val int NULL, half_life_time_val int NULL, last_published_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_JOURNEY_OCCURRENCE (
      num_of_contacts_entered int NULL, num_of_contacts_suppressed int NULL, journey_occurrence_num int NULL, start_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_TASK (
      ...
      recurrence_day_of_month_no int NULL, impressions_qty_period_cnt int NULL, maximum_period_expression_cnt int NULL, valid_from_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_TASK_ALL (
      ...
      maximum_period_expression_cnt int NULL, impressions_qty_period_cnt int NULL, impressions_life_time_cnt int NULL, last_published_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_WF_PROCESS_DEF (
      version_num numeric NULL, file_tobecatlgd_flg char(1) NULL, default_approval_flg char(1) NULL, buildin_template_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_WF_PROCESS_DEF_TASKS (
      default_duration_perassignee numeric NULL, file_enabled_flg char(1) NULL, is_sequential_flg char(1) NULL, outgoing_flow_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MONTHLY_USAGE (
      api_usage_str varchar(4000) NULL, bc_subjcnt_str varchar(4000) NULL, customer_profiles_processed_str varchar(4000) NULL, web_impr_cnt numeric NULL, 
      web_sesn_cnt numeric NULL, mob_sesn_cnt numeric NULL, email_preview_cnt numeric NULL, outbound_api_cnt numeric NULL, 
      facebook_ads_cnt numeric NULL, mobile_push_cnt numeric NULL, google_ads_cnt numeric NULL, audience_usage_cnt numeric NULL, 
      plan_users_cnt numeric NULL, email_send_cnt numeric NULL, linkedin_ads_cnt numeric NULL, dm_destinations_total_row_cnt numeric NULL, 
      mob_impr_cnt numeric NULL, dm_destinations_total_id_cnt numeric NULL, mobile_in_app_msg_cnt numeric NULL, asset_size decimal(17,2) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_PROCESS_DETAILS (
      delayed_by_day numeric NULL, percent_complete numeric NULL, user_tasks_cnt numeric NULL, completed_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_PROCESS_TASKS (
      version_num numeric NULL, duration_per_assignee numeric NULL, delayed_by_day numeric NULL, percent_complete numeric NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_TASKS_USER_ASSIGNMENT (
      usan_duration_day numeric NULL, delayed_by_day numeric NULL, is_assigned_flg char(1) NULL, is_replaced_flg char(1) NULL, 
