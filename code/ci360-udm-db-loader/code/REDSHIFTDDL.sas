...
/* ****************************************************************************/
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..ab_test_path_assignment(
      ...
      execute (alter table &dbschema..ab_test_path_assignment add constraint ab_test_path_assignment_pk primary key (event_id)) BY REDSHIFT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..abt_attribution(
        ...
        ,
        conversion_value integer NULL ,creative_id varchar(36) NULL ,identity_id varchar(36) NULL ,interaction varchar(260) NULL ,interaction_cost integer NULL ,interaction_subtype varchar(100) NULL ,interaction_type varchar(15) NULL ,load_id varchar(36) NULL ,task_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..abt_attribution add constraint abt_attribution_pk primary key (interaction_dttm,interaction_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..activity_conversion(
      ...
      execute (alter table &dbschema..activity_conversion add constraint activity_conversion_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..activity_flow_in(
      ...
      execute (alter table &dbschema..activity_flow_in add constraint activity_flow_in_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..activity_start(
      ...
      execute (alter table &dbschema..activity_start add constraint activity_start_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..advertising_contact(
      ...
      execute (alter table &dbschema..advertising_contact add constraint advertising_contact_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..asset_details(
        ...
        ,
        asset_deleted_flg char(1) NULL ,asset_desc varchar(1332) NULL ,asset_locked_by_usernm varchar(128) NULL ,asset_locked_dttm timestamp NULL ,asset_locked_flg char(1) NULL ,asset_nm varchar(128) NULL ,asset_owner_usernm varchar(128) NULL ,asset_process_status varchar(36) NULL ,asset_sk bigint NULL ,asset_source_nm varchar(128) NULL ,asset_source_type varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,download_disabled_by_usernm varchar(128) NULL ,download_disabled_dttm timestamp NULL ,download_disabled_flg char(1) NULL ,entity_attribute_enabled_flg char(1) NULL ,entity_revision_enabled_flg char(1) NULL ,entity_status_cd varchar(3) NULL ,entity_subtype_enabled_flg char(1) NULL ,entity_subtype_nm varchar(128) NULL ,entity_table_nm varchar(128) NULL ,entity_type_nm varchar(128) NULL ,entity_type_usage_cd varchar(3) NULL ,expired_dttm timestamp NULL ,expired_flg char(1) NULL ,external_sharing_error_msg varchar(1024) NULL ,folder_deleted_flg char(1) NULL ,folder_desc varchar(1332) NULL ,folder_entity_status_cd varchar(3) NULL ,folder_level integer NULL ,folder_nm varchar(128) NULL ,folder_owner_usernm varchar(128) NULL ,folder_path varchar(1024) NULL ,folder_sk bigint NULL ,last_modified_by_usernm varchar(128) NULL ,last_modified_dttm timestamp NULL ,load_dttm timestamp NULL ,process_id varchar(128) NULL ,process_task_id varchar(128) NULL ,public_link varchar(1) NULL ,public_media_id bigint NULL ,public_url varchar(1024) NULL ,recycled_by_usernm varchar(128) NULL ,recycled_dttm timestamp NULL ,total_user_rating_val bigint NULL ,user_rating_cnt bigint NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..asset_details add constraint asset_details_pk primary key (asset_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..asset_details_custom_prop(
      ...
      execute (alter table &dbschema..asset_details_custom_prop add constraint asset_details_custom_prop_pk primary key (asset_id,attr_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..asset_rendition_details(
        ...
        ,
        created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,current_revision_flg char(1) NULL ,download_cnt bigint NULL ,entity_status_cd varchar(3) NULL ,file_format varchar(128) NULL ,file_nm varchar(128) NULL ,file_size integer NULL ,last_modified_by_usernm varchar(128) NULL ,last_modified_dttm timestamp NULL ,last_modified_status_cd varchar(3) NULL ,load_dttm timestamp NULL ,media_depth integer NULL ,media_height integer NULL ,media_width integer NULL ,rend_deleted_flg char(1) NULL ,rend_duration integer NULL ,rendition_generated_type_cd varchar(3) NULL ,rendition_nm varchar(128) NULL ,rendition_type_cd varchar(3) NULL ,rev_deleted_flg char(1) NULL ,revision_comment_txt varchar(512) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..asset_rendition_details add constraint asset_rendition_details_pk primary key (asset_id,rendition_id,revision_id,revision_no)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..asset_revision(
      ...
      execute (alter table &dbschema..asset_revision add constraint asset_revision_pk primary key (asset_id,revision_id,revision_no)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..audience_membership_change(
      ...
      execute (alter table &dbschema..audience_membership_change add constraint audience_membership_chang_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..business_process_details(
        detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,event_designed_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,process_dttm timestamp NOT NULL ,process_instance_no integer NOT NULL ,process_nm varchar(130) NOT NULL ,process_step_nm varchar(130) NOT NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,step_order_no integer NOT NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        attribute1_txt varchar(130) NULL ,attribute2_txt varchar(130) NULL ,event_id varchar(36) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,is_completion_flg char(1) NULL ,is_start_flg char(1) NULL ,load_dttm timestamp NULL ,next_detail_id varchar(32) NULL ,process_attempt_cnt integer NULL ,process_details_sk varchar(32) NULL ,process_dttm_tz timestamp NULL ,process_exception_dttm timestamp NULL ,process_exception_dttm_tz timestamp NULL ,process_exception_txt varchar(1300) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..business_process_details add constraint business_process_details_pk primary key (detail_id,event_designed_id,process_dttm,process_instance_no,process_nm,process_step_nm,step_order_no)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cart_activity_details(
        ...
        ,
        activity_cd varchar(20) NULL ,activity_dttm_tz timestamp NULL ,availability_message_txt varchar(650) NULL ,cart_id varchar(42) NULL ,cart_nm varchar(100) NULL ,channel_nm varchar(40) NULL ,currency_cd varchar(6) NULL ,displayed_cart_items_no integer NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,product_group_nm varchar(130) NULL ,properties_map_doc varchar(4000) NULL ,quantity_val integer NULL ,saving_message_txt varchar(650) NULL ,shipping_message_txt varchar(650) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cart_activity_details add constraint cart_activity_details_pk primary key (activity_dttm,detail_id,product_id,product_nm,product_sku)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cc_budget_breakup(
      ...
      execute (alter table &dbschema..cc_budget_breakup add constraint cc_budget_breakup_pk primary key (cost_center_id,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cc_budget_breakup_ccbdgt(
        ...
        ,
        cc_bdgt_budget_desc varchar(1332) NULL ,cc_bdgt_cmtmnt_invoice_cnt integer NULL ,cc_desc varchar(1332) NULL ,cc_nm varchar(128) NULL ,cc_number varchar(128) NULL ,cc_obsolete_flg char(1) NULL ,cc_owner_usernm varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fin_accnt_desc varchar(1332) NULL ,fin_accnt_nm varchar(128) NULL ,fin_accnt_obsolete_flg char(1) NULL ,fp_cls_ver varchar(128) NULL ,fp_desc varchar(1332) NULL ,fp_nm varchar(128) NULL ,fp_obsolete_flg char(1) NULL ,gen_ledger_cd varchar(128) NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,planning_nm varchar(128) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cc_budget_breakup_ccbdgt add constraint cc_budget_breakup_ccbdgt_pk primary key (cost_center_id,fp_id,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_activity_custom_attr(
        ...
        ,
        activity_id varchar(36) NULL ,attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_activity_custom_attr add constraint cdm_activity_custom_attr_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_activity_detail(
      ...
      execute (alter table &dbschema..cdm_activity_detail add constraint cdm_activity_detail_pk primary key (activity_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_activity_x_task(
      ...
      execute (alter table &dbschema..cdm_activity_x_task add constraint cdm_activity_x_task_pk primary key (activity_version_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_audience_detail(
      ...
      execute (alter table &dbschema..cdm_audience_detail add constraint cdm_audience_detail_pk primary key (audience_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_audience_occur_detail(
        ...
        ,
        audience_id varchar(36) NULL ,audience_size_cnt integer NULL ,end_dttm timestamp NULL ,execution_status_cd varchar(100) NULL ,occurrence_type_nm varchar(100) NULL ,start_dttm timestamp NULL ,started_by_nm varchar(256) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_audience_occur_detail add constraint cdm_audience_occur_detail_pk primary key (audience_occur_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_business_context(
      ...
      execute (alter table &dbschema..cdm_business_context add constraint cdm_business_context_pk primary key (business_context_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_campaign_custom_attr(
        ...
        ,
        attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,extension_attribute_nm varchar(256) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_campaign_custom_attr add constraint cdm_campaign_custom_attr_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_campaign_detail(
        ...
        ,
        approval_dttm timestamp NULL ,approval_given_by_nm varchar(60) NULL ,campaign_cd varchar(60) NULL ,campaign_desc varchar(1500) NULL ,campaign_folder_txt varchar(1024) NULL ,campaign_group_sk integer NULL ,campaign_nm varchar(60) NULL ,campaign_owner_nm varchar(60) NULL ,campaign_status_cd varchar(3) NULL ,campaign_type_cd varchar(3) NULL ,campaign_version_no integer NULL ,current_version_flg char(1) NULL ,deleted_flg char(1) NULL ,deployment_version_no integer NULL ,end_dttm timestamp NULL ,last_modified_by_user_nm varchar(60) NULL ,last_modified_dttm timestamp NULL ,run_dttm timestamp NULL ,source_system_cd varchar(10) NULL ,start_dttm timestamp NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL ,valid_from_dttm timestamp NULL ,valid_to_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_campaign_detail add constraint cdm_campaign_detail_pk primary key (campaign_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_contact_channel(
      ...
      execute (alter table &dbschema..cdm_contact_channel add constraint cdm_contact_channel_pk primary key (contact_channel_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_contact_history(
        ...
        ,
        audience_id varchar(36) NULL ,audience_occur_id varchar(36) NULL ,contact_dttm timestamp NULL ,contact_dttm_tz timestamp NULL ,contact_nm varchar(256) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,control_group_flg char(1) NULL ,external_contact_info_1_id varchar(32) NULL ,external_contact_info_2_id varchar(32) NULL ,optimization_backfill_flg char(1) NULL ,source_system_cd varchar(10) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_contact_history add constraint cdm_contact_history_pk primary key (contact_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_contact_status(
      ...
      execute (alter table &dbschema..cdm_contact_status add constraint cdm_contact_status_pk primary key (contact_status_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_content_custom_attr(
        attribute_character_val varchar(1500) NULL ,attribute_data_type_cd varchar(30) NULL ,attribute_dttm_val timestamp NULL ,attribute_nm varchar(256) NULL ,attribute_val varchar(1500) NULL ,content_version_id varchar(40) NULL
        ,
      ...
      execute (alter table &dbschema..cdm_content_custom_attr add constraint cdm_content_custom_attr_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_dyn_content_custom_attr(
        ...
        ,
        attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,content_id varchar(40) NULL ,extension_attribute_nm varchar(256) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_dyn_content_custom_attr add constraint cdm_dyn_content_custom_at_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_identifier_type(
      ...
      execute (alter table &dbschema..cdm_identifier_type add constraint cdm_identifier_type_pk primary key (identifier_type_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_identity_attr(
      ...
      execute (alter table &dbschema..cdm_identity_attr add constraint cdm_identity_attr_pk primary key (identifier_type_id,identity_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_identity_map(
      ...
      execute (alter table &dbschema..cdm_identity_map add constraint cdm_identity_map_pk primary key (identity_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_identity_type(
      ...
      execute (alter table &dbschema..cdm_identity_type add constraint cdm_identity_type_pk primary key (identity_type_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_occurrence_detail(
        ...
        ,
        end_dttm timestamp NULL ,execution_status_cd varchar(30) NULL ,occurrence_no integer NULL ,occurrence_object_id varchar(36) NULL ,occurrence_object_type_cd varchar(60) NULL ,occurrence_type_cd varchar(30) NULL ,source_system_cd varchar(10) NULL ,start_dttm timestamp NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_occurrence_detail add constraint cdm_occurrence_detail_pk primary key (occurrence_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_response_channel(
      ...
      execute (alter table &dbschema..cdm_response_channel add constraint cdm_response_channel_pk primary key (response_channel_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_response_extended_attr(
      ...
      execute (alter table &dbschema..cdm_response_extended_attr add constraint cdm_response_extended_att_pk primary key (attribute_nm,response_attribute_type_cd,response_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_response_history(
        ...
        ,
        audience_id varchar(36) NULL ,audience_occur_id varchar(36) NULL ,content_hash_val varchar(32) NULL ,content_id varchar(40) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,conversion_flg char(1) NULL ,external_contact_info_1_id varchar(32) NULL ,external_contact_info_2_id varchar(32) NULL ,inferred_response_flg char(1) NULL ,properties_map_doc varchar(4000) NULL ,response_dttm timestamp NULL ,response_dttm_tz timestamp NULL ,source_system_cd varchar(10) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_response_history add constraint cdm_response_history_pk primary key (response_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_response_lookup(
      ...
      execute (alter table &dbschema..cdm_response_lookup add constraint cdm_response_lookup_pk primary key (response_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_response_type(
      ...
      execute (alter table &dbschema..cdm_response_type add constraint cdm_response_type_pk primary key (response_type_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_rtc_detail(
        ...
        ,
        deleted_flg char(1) NULL ,execution_status_cd varchar(30) NULL ,processed_dttm timestamp NULL ,response_tracking_flg char(1) NULL ,segment_id varchar(36) NULL ,source_system_cd varchar(10) NULL ,task_id varchar(36) NULL ,task_occurrence_no integer NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_rtc_detail add constraint cdm_rtc_detail_pk primary key (rtc_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_rtc_x_content(
        ...
        ,
        content_hash_val varchar(32) NULL ,content_id varchar(40) NULL ,rtc_x_content_sk varchar(36) NULL ,sequence_no integer NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_rtc_x_content add constraint cdm_rtc_x_content_pk primary key (content_version_id,rtc_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_custom_attr(
        ...
        ,
        attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,segment_id varchar(36) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_segment_custom_attr add constraint cdm_segment_custom_attr_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_detail(
      ...
      execute (alter table &dbschema..cdm_segment_detail add constraint cdm_segment_detail_pk primary key (segment_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_map(
      ...
      execute (alter table &dbschema..cdm_segment_map add constraint cdm_segment_map_pk primary key (segment_map_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_map_custom_attr(
        ...
        ,
        attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,segment_map_id varchar(36) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_segment_map_custom_attr add constraint cdm_segment_map_custom_at_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_test(
        ...
        ,
        stratified_samp_criteria_txt varchar(1024) NULL ,stratified_sampling_flg char(1) NULL ,task_id varchar(36) NULL ,test_cnt integer NULL ,test_enabled_flg char(1) NULL ,test_nm varchar(65) NULL ,test_sizing_type_nm varchar(65) NULL ,test_type_nm varchar(10) NULL ,updated_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_segment_test add constraint cdm_segment_test_pk primary key (task_version_id,test_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_segment_test_x_segment(
      ...
      execute (alter table &dbschema..cdm_segment_test_x_segment add constraint cdm_segment_test_x_segmen_pk primary key (segment_id,task_version_id,test_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..cdm_task_custom_attr(
        ...
        ,
        attribute_character_val varchar(1500) NULL ,attribute_dttm_val timestamp NULL ,extension_attribute_nm varchar(256) NULL ,task_id varchar(36) NULL ,updated_by_nm varchar(60) NULL ,updated_dttm timestamp NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..cdm_task_custom_attr add constraint cdm_task_custom_attr_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..commitment_details(
        ...
        ,
        cmtmnt_closure_note varchar(1332) NULL ,cmtmnt_created_dttm timestamp NULL ,cmtmnt_desc varchar(1332) NULL ,cmtmnt_nm varchar(128) NULL ,cmtmnt_no varchar(128) NULL ,cmtmnt_payment_dttm timestamp NULL ,cmtmnt_status varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,planning_currency_cd varchar(10) NULL ,planning_nm varchar(128) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..commitment_details add constraint commitment_details_pk primary key (cmtmnt_id,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..commitment_line_items(
        cmtmnt_id varchar(128) NOT NULL ,cost_center_id varchar(128) NULL ,item_nm varchar(128) NOT NULL ,item_number integer NOT NULL ,planning_id varchar(128) NOT NULL ,vendor_id varchar(128) NULL
        ,
        cc_desc varchar(1332) NULL ,cc_nm varchar(128) NULL ,cc_owner_usernm varchar(128) NULL ,ccat_nm varchar(128) NULL ,cmtmnt_closure_note varchar(1332) NULL ,cmtmnt_created_dttm timestamp NULL ,cmtmnt_desc varchar(1332) NULL ,cmtmnt_nm varchar(128) NULL ,cmtmnt_no varchar(128) NULL ,cmtmnt_payment_dttm timestamp NULL ,cmtmnt_status varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fin_acc_nm varchar(128) NULL ,gen_ledger_cd varchar(128) NULL ,item_alloc_unit bigint NULL ,item_qty bigint NULL ,item_vend_alloc_unit bigint NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,planning_currency_cd varchar(10) NULL ,planning_nm varchar(128) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..commitment_line_items add constraint commitment_line_items_pk primary key (cmtmnt_id,item_nm,item_number,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..commitment_line_items_ccbdgt(
        cmtmnt_id varchar(128) NOT NULL ,item_number integer NOT NULL
        ,
        cc_bdgt_budget_desc varchar(1332) NULL ,cc_bdgt_cmtmnt_invoice_cnt integer NULL ,cc_desc varchar(1332) NULL ,cc_nm varchar(128) NULL ,cc_number varchar(128) NULL ,cc_obsolete_flg char(1) NULL ,cc_owner_usernm varchar(128) NULL ,ccat_nm varchar(128) NULL ,cmtmnt_closure_note varchar(1332) NULL ,cmtmnt_created_dttm timestamp NULL ,cmtmnt_desc varchar(1332) NULL ,cmtmnt_nm varchar(128) NULL ,cmtmnt_no varchar(128) NULL ,cmtmnt_payment_dttm timestamp NULL ,cmtmnt_status varchar(128) NULL ,cost_center_id varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fin_acc_nm varchar(128) NULL ,fp_cls_ver varchar(128) NULL ,fp_desc varchar(1332) NULL ,fp_id varchar(128) NULL ,fp_nm varchar(128) NULL ,fp_obsolete_flg char(1) NULL ,gen_ledger_cd varchar(128) NULL ,item_alloc_unit integer NULL ,item_nm varchar(128) NULL ,item_qty integer NULL ,item_vend_alloc_unit integer NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,planning_currency_cd varchar(10) NULL ,planning_id varchar(128) NULL ,planning_nm varchar(128) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_id varchar(128) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..commitment_line_items_ccbdgt add constraint commitment_line_items_ccb_pk primary key (cmtmnt_id,item_number)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..contact_history(
      ...
      execute (alter table &dbschema..contact_history add constraint contact_history_pk primary key (contact_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..conversion_milestone(
      ...
      execute (alter table &dbschema..conversion_milestone add constraint conversion_milestone_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..custom_events(
        ...
        ,
        channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,custom_event_dttm timestamp NULL ,custom_event_dttm_tz timestamp NULL ,custom_event_group_nm varchar(256) NULL ,custom_event_nm varchar(256) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,event_type_nm varchar(20) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(64) NULL ,page_id varchar(256) NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..custom_events add constraint custom_events_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..custom_events_ext(
      ...
      execute (alter table &dbschema..custom_events_ext add constraint custom_events_ext_pk primary key (custom_events_sk)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..daily_usage(
        ...
        ,
        admin_user_cnt integer NULL ,api_usage_str varchar(4000) NULL ,audience_usage_cnt bigint NULL ,bc_subjcnt_str varchar(4000) NULL ,email_preview_cnt bigint NULL ,email_send_cnt bigint NULL ,facebook_ads_cnt bigint NULL ,google_ads_cnt bigint NULL ,linkedin_ads_cnt bigint NULL ,mob_impr_cnt bigint NULL ,mob_sesn_cnt bigint NULL ,mobile_in_app_msg_cnt bigint NULL ,mobile_push_cnt bigint NULL ,outbound_api_cnt bigint NULL ,plan_users_cnt bigint NULL ,web_impr_cnt bigint NULL ,web_sesn_cnt bigint NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..daily_usage add constraint daily_usage_pk primary key (event_day)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..data_view_details(
        ...
        ,
        channel_user_id varchar(300) NULL ,data_view_dttm timestamp NULL ,data_view_dttm_tz timestamp NULL ,event_nm varchar(256) NULL ,load_dttm timestamp NULL ,properties_map_doc varchar(4000) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..data_view_details add constraint data_view_details_pk primary key (detail_id_hex,event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_adv_campaign_visitors(
        ...
        ,
        average_visit_duration integer NULL ,bouncer varchar(12) NULL ,bouncers integer NULL ,br_browser_name varchar(52) NULL ,br_browser_version varchar(16) NULL ,co_conversions integer NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,ge_city varchar(390) NULL ,ge_country varchar(85) NULL ,ge_state_region varchar(2) NULL ,landing_page varchar(1332) NULL ,landing_page_url varchar(1332) NULL ,landing_page_url_domain varchar(215) NULL ,new_visitors integer NULL ,page_views integer NULL ,pl_device_operating_system varchar(78) NULL ,return_visitors integer NULL ,se_external_search_engine varchar(130) NULL ,se_external_search_engine_domain varchar(215) NULL ,se_external_search_engine_phrase varchar(1332) NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_dttm timestamp NULL ,visit_dttm_tz timestamp NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL ,visits integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_adv_campaign_visitors add constraint dbt_adv_campaign_visitors_pk primary key (session_id,visit_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_business_process(
        ...
        ,
        bouncer varchar(12) NULL ,bus_process_started_dttm_tz timestamp NULL ,business_process_attribute_1 varchar(130) NULL ,business_process_attribute_2 varchar(130) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,last_step smallint NULL ,processes smallint NULL ,processes_abandoned smallint NULL ,processes_completed smallint NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,step_count smallint NULL ,steps smallint NULL ,steps_abandoned smallint NULL ,steps_completed smallint NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_business_process add constraint dbt_business_process_pk primary key (bus_process_started_dttm,business_process_name,business_process_step_name,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_content(
        active_page_view_time integer NULL ,detail_dttm timestamp NULL ,entry_pages integer NULL ,exit_pages integer NULL ,pg_page_url varchar(1332) NULL ,session_id varchar(29) NULL
        ,
        bouncer varchar(12) NULL ,bouncers integer NULL ,class1_id varchar(650) NULL ,class2_id varchar(650) NULL ,cu_customer_id varchar(36) NULL ,detail_dttm_tz timestamp NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,pg_domain_name varchar(215) NULL ,pg_page varchar(1332) NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,total_page_view_time bigint NULL ,views integer NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL ,visits integer NULL
        ,Hashed_pk_col varchar(64) NOT NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_content add constraint dbt_content_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_documents(
        ...
        ,
        bouncer varchar(12) NULL ,class1_id varchar(650) NULL ,class2_id varchar(650) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,do_page_description varchar(1332) NULL ,do_page_url varchar(1332) NULL ,document_download_dttm_tz timestamp NULL ,document_downloads integer NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_documents add constraint dbt_documents_pk primary key (document_download_dttm,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_ecommerce(
        ...
        ,
        basket_adds integer NULL ,basket_adds_units integer NULL ,basket_id varchar(42) NULL ,basket_removes integer NULL ,basket_removes_units integer NULL ,baskets_abandoned smallint NULL ,baskets_completed smallint NULL ,baskets_started smallint NULL ,bouncer varchar(12) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,product_activity_dttm_tz timestamp NULL ,product_group_name varchar(130) NULL ,product_name varchar(130) NULL ,product_purchase_units integer NULL ,product_purchases integer NULL ,product_sku varchar(100) NULL ,product_views integer NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_ecommerce add constraint dbt_ecommerce_pk primary key (product_activity_dttm,product_id,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_forms(
        ...
        ,
        attempts integer NULL ,bouncer varchar(12) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,form_attempt_dttm_tz timestamp NULL ,forms_completed smallint NULL ,forms_not_submitted smallint NULL ,forms_started smallint NULL ,last_field varchar(325) NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_forms add constraint dbt_forms_pk primary key (form_attempt_dttm,form_nm,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_goals(
        ...
        ,
        bouncer varchar(12) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,goal_group_name varchar(130) NULL ,goal_name varchar(260) NULL ,goal_reached_dttm_tz timestamp NULL ,goals smallint NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL ,visits integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_goals add constraint dbt_goals_pk primary key (goal_reached_dttm,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_media_consumption(
        detail_id varchar(32) NOT NULL ,interactions_count integer NOT NULL ,media_completion_rate varchar(35) NOT NULL ,media_section varchar(35) NOT NULL ,visit_id varchar(32) NOT NULL
        ,
        bouncer varchar(12) NULL ,counter integer NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,media_name varchar(260) NULL ,media_section_view smallint NULL ,media_start_dttm timestamp NULL ,media_start_dttm_tz timestamp NULL ,media_uri_txt varchar(2024) NULL ,session_complete_load_dttm timestamp NULL ,session_id varchar(29) NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,views smallint NULL ,views_completed smallint NULL ,views_started smallint NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_media_consumption add constraint dbt_media_consumption_pk primary key (detail_id,interactions_count,media_completion_rate,media_section,visit_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..dbt_search(
        ...
        ,
        bouncer varchar(12) NULL ,cu_customer_id varchar(36) NULL ,device_name varchar(85) NULL ,device_type varchar(52) NULL ,exit_pages integer NULL ,internal_search_term varchar(128) NULL ,num_additional_searches integer NULL ,num_pages_viewed_afterwards integer NULL ,search_no_results_returned integer NULL ,search_results_dttm_tz timestamp NULL ,search_returned_results integer NULL ,search_unknown_results integer NULL ,searches integer NULL ,session_complete_load_dttm timestamp NULL ,session_start_dttm timestamp NULL ,session_start_dttm_tz timestamp NULL ,visit_id varchar(32) NULL ,visit_origination_creative varchar(260) NULL ,visit_origination_name varchar(260) NULL ,visit_origination_placement varchar(390) NULL ,visit_origination_tracking_code varchar(65) NULL ,visit_origination_type varchar(65) NULL ,visitor_id varchar(32) NULL ,visitor_type varchar(10) NULL ,visits integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..dbt_search add constraint dbt_search_pk primary key (search_name,search_results_dttm,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..direct_contact(
      ...
      execute (alter table &dbschema..direct_contact add constraint direct_contact_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..document_details(
      ...
      execute (alter table &dbschema..document_details add constraint document_details_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_bounce(
      ...
      execute (alter table &dbschema..email_bounce add constraint email_bounce_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_click(
      ...
      execute (alter table &dbschema..email_click add constraint email_click_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_complaint(
      ...
      execute (alter table &dbschema..email_complaint add constraint email_complaint_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_open(
      ...
      execute (alter table &dbschema..email_open add constraint email_open_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_optout(
      ...
      execute (alter table &dbschema..email_optout add constraint email_optout_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_optout_details(
      ...
      execute (alter table &dbschema..email_optout_details add constraint email_optout_details_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_reply(
      ...
      execute (alter table &dbschema..email_reply add constraint email_reply_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_send(
      ...
      execute (alter table &dbschema..email_send add constraint email_send_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..email_view(
      ...
      execute (alter table &dbschema..email_view add constraint email_view_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..external_event(
      ...
      execute (alter table &dbschema..external_event add constraint external_event_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..fiscal_cc_budget(
      ...
      execute (alter table &dbschema..fiscal_cc_budget add constraint fiscal_cc_budget_pk primary key (cost_center_id,fp_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..form_details(
        attempt_index_cnt integer NOT NULL ,attempt_status_cd varchar(42) NOT NULL ,detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,form_field_detail_dttm timestamp NOT NULL ,identity_id varchar(36) NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,submit_flg char(1) NOT NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        change_index_no integer NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_source_cd varchar(100) NULL ,form_field_detail_dttm_tz timestamp NULL ,form_field_id varchar(325) NULL ,form_field_nm varchar(325) NULL ,form_field_value varchar(2600) NULL ,form_nm varchar(65) NULL ,load_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..form_details add constraint form_details_pk primary key (attempt_index_cnt,attempt_status_cd,detail_id,form_field_detail_dttm,submit_flg)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..identity_attributes(
      ...
      execute (alter table &dbschema..identity_attributes add constraint identity_attributes_pk primary key (entrytime,identifier_type_id,identity_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..identity_map(
      ...
      execute (alter table &dbschema..identity_map add constraint identity_map_pk primary key (source_identity_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..impression_spot_viewable(
        ...
        ,
        analysis_group_id varchar(36) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,control_group_flg char(1) NULL ,creative_version_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,impression_viewable_dttm timestamp NULL ,impression_viewable_dttm_tz timestamp NULL ,load_dttm timestamp NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,product_id varchar(128) NULL ,product_nm varchar(128) NULL ,product_qty_no integer NULL ,product_sku_no varchar(100) NULL ,properties_map_doc varchar(4000) NULL ,rec_group_id varchar(3) NULL ,request_id varchar(36) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..impression_spot_viewable add constraint impression_spot_viewable_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..in_app_failed(
      ...
      execute (alter table &dbschema..in_app_failed add constraint in_app_failed_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..in_app_message(
      ...
      execute (alter table &dbschema..in_app_message add constraint in_app_message_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..in_app_send(
      ...
      execute (alter table &dbschema..in_app_send add constraint in_app_send_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..in_app_targeting_request(
      ...
      execute (alter table &dbschema..in_app_targeting_request add constraint in_app_targeting_request_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..invoice_details(
        ...
        ,
        cmtmnt_nm varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,invoice_created_dttm timestamp NULL ,invoice_desc varchar(1332) NULL ,invoice_nm varchar(128) NULL ,invoice_number varchar(128) NULL ,invoice_reconciled_dttm timestamp NULL ,invoice_status varchar(64) NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,payment_dttm timestamp NULL ,plan_currency_cd varchar(10) NULL ,planning_nm varchar(128) NULL ,reconcile_note varchar(1332) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_desc varchar(1332) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..invoice_details add constraint invoice_details_pk primary key (cmtmnt_id,invoice_id,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..invoice_line_items(
        ...
        ,
        cc_desc varchar(1332) NULL ,cc_nm varchar(128) NULL ,cc_owner_usernm varchar(128) NULL ,ccat_nm varchar(128) NULL ,cmtmnt_nm varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fin_acc_ccat_nm varchar(128) NULL ,fin_acc_nm varchar(128) NULL ,gen_ledger_cd varchar(128) NULL ,invoice_created_dttm timestamp NULL ,invoice_desc varchar(1332) NULL ,invoice_reconciled_dttm timestamp NULL ,invoice_status varchar(64) NULL ,item_alloc_unit bigint NULL ,item_nm varchar(128) NULL ,item_number integer NULL ,item_qty bigint NULL ,item_vend_alloc_unit bigint NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,payment_dttm timestamp NULL ,plan_currency_cd varchar(10) NULL ,planning_nm varchar(128) NULL ,reconcile_note varchar(1332) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_desc varchar(1332) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..invoice_line_items add constraint invoice_line_items_pk primary key (cmtmnt_id,invoice_id,invoice_nm,invoice_number,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..invoice_line_items_ccbdgt(
        invoice_id varchar(128) NOT NULL ,item_number integer NOT NULL
        ,
        cc_bdgt_budget_desc varchar(1332) NULL ,cc_bdgt_cmtmnt_invoice_cnt integer NULL ,cc_desc varchar(1332) NULL ,cc_nm varchar(128) NULL ,cc_number varchar(128) NULL ,cc_obsolete_flg char(1) NULL ,cc_owner_usernm varchar(128) NULL ,ccat_nm varchar(128) NULL ,cmtmnt_id varchar(128) NULL ,cmtmnt_nm varchar(128) NULL ,cost_center_id varchar(128) NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fin_acc_ccat_nm varchar(128) NULL ,fin_acc_nm varchar(128) NULL ,fp_cls_ver varchar(128) NULL ,fp_desc varchar(1332) NULL ,fp_id varchar(128) NULL ,fp_nm varchar(128) NULL ,fp_obsolete_flg char(1) NULL ,gen_ledger_cd varchar(128) NULL ,invoice_created_dttm timestamp NULL ,invoice_desc varchar(1332) NULL ,invoice_nm varchar(128) NULL ,invoice_number varchar(128) NULL ,invoice_reconciled_dttm timestamp NULL ,invoice_status varchar(64) NULL ,item_alloc_unit integer NULL ,item_nm varchar(128) NULL ,item_qty integer NULL ,item_vend_alloc_unit integer NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,payment_dttm timestamp NULL ,plan_currency_cd varchar(10) NULL ,planning_id varchar(128) NULL ,planning_nm varchar(128) NULL ,reconcile_note varchar(1332) NULL ,vendor_currency_cd varchar(10) NULL ,vendor_desc varchar(1332) NULL ,vendor_id varchar(128) NULL ,vendor_nm varchar(128) NULL ,vendor_number varchar(128) NULL ,vendor_obsolete_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..invoice_line_items_ccbdgt add constraint invoice_line_items_ccbdgt_pk primary key (invoice_id,item_number)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..journey_entry(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,entry_dttm timestamp NULL ,entry_dttm_tz timestamp NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,identity_type_nm varchar(100) NULL ,identity_type_val varchar(300) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..journey_entry add constraint journey_entry_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..journey_holdout(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,event_nm varchar(256) NULL ,holdout_dttm timestamp NULL ,holdout_dttm_tz timestamp NULL ,identity_id varchar(36) NULL ,identity_type_nm varchar(100) NULL ,identity_type_val varchar(300) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..journey_holdout add constraint journey_holdout_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..journey_node_entry(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,identity_type_nm varchar(100) NULL ,identity_type_val varchar(300) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm timestamp NULL ,node_entry_dttm timestamp NULL ,node_entry_dttm_tz timestamp NULL ,node_id varchar(36) NULL ,node_type_nm varchar(256) NULL ,previous_node_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..journey_node_entry add constraint journey_node_entry_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..journey_success(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,identity_type_nm varchar(100) NULL ,identity_type_val varchar(300) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm timestamp NULL ,success_dttm timestamp NULL ,success_dttm_tz timestamp NULL ,success_val integer NULL ,unit_qty integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..journey_success add constraint journey_success_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..journey_suppression(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,identity_type_nm varchar(100) NULL ,identity_type_val varchar(300) NULL ,journey_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,load_dttm timestamp NULL ,reason_cd varchar(100) NULL ,reason_txt varchar(1000) NULL ,suppression_dttm timestamp NULL ,suppression_dttm_tz timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..journey_suppression add constraint journey_suppression_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity(
      ...
      execute (alter table &dbschema..md_activity add constraint md_activity_pk primary key (activity_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity_abtestpath(
      ...
      execute (alter table &dbschema..md_activity_abtestpath add constraint md_activity_abtestpath_pk primary key (abtest_path_id,activity_node_id,activity_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity_custom_prop(
      ...
      execute (alter table &dbschema..md_activity_custom_prop add constraint md_activity_custom_prop_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity_node(
        ...
        ,
        abtest_id varchar(36) NULL ,activity_node_nm varchar(256) NULL ,activity_node_type_nm varchar(100) NULL ,activity_status_cd varchar(20) NULL ,end_node_flg char(1) NULL ,next_node_val varchar(4000) NULL ,node_sequence_no integer NULL ,previous_node_val varchar(4000) NULL ,specific_wait_flg char(1) NULL ,start_node_flg char(1) NULL ,time_boxed_flg char(1) NULL ,valid_from_dttm timestamp NULL ,valid_to_dttm timestamp NULL ,wait_tm integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_activity_node add constraint md_activity_node_pk primary key (activity_node_id,activity_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity_x_activity_node(
      ...
      execute (alter table &dbschema..md_activity_x_activity_node add constraint md_activity_x_activity_no_pk primary key (activity_node_id,activity_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_activity_x_task(
      ...
      execute (alter table &dbschema..md_activity_x_task add constraint md_activity_x_task_pk primary key (activity_version_id,task_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_asset(
      ...
      execute (alter table &dbschema..md_asset add constraint md_asset_pk primary key (asset_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_audience(
        audience_id varchar(36) NOT NULL
        ,
        audience_data_source_nm varchar(100) NULL ,audience_desc varchar(1332) NULL ,audience_expiration_val integer NULL ,audience_nm varchar(128) NULL ,audience_schedule_flg char(1) NULL ,audience_source_nm varchar(100) NULL ,create_dttm timestamp NULL ,created_user_nm varchar(256) NULL ,delete_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_audience add constraint md_audience_pk primary key (audience_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_audience_occurrence(
        ...
        ,
        audience_id varchar(36) NULL ,audience_size_val integer NULL ,end_tm timestamp NULL ,execution_status_cd varchar(100) NULL ,occurrence_type_nm varchar(100) NULL ,start_tm timestamp NULL ,started_by_nm varchar(256) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_audience_occurrence add constraint md_audience_occurrence_pk primary key (aud_occurrence_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_bu(
      ...
      execute (alter table &dbschema..md_bu add constraint md_bu_pk primary key (bu_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_business_context(
      ...
      execute (alter table &dbschema..md_business_context add constraint md_business_context_pk primary key (business_context_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_cost_category(
      ...
      execute (alter table &dbschema..md_cost_category add constraint md_cost_category_pk primary key (ccat_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_costcenter(
      ...
      execute (alter table &dbschema..md_costcenter add constraint md_costcenter_pk primary key (cost_center_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_creative(
      ...
      execute (alter table &dbschema..md_creative add constraint md_creative_pk primary key (creative_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_creative_custom_prop(
      ...
      execute (alter table &dbschema..md_creative_custom_prop add constraint md_creative_custom_prop_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_creative_x_asset(
      ...
      execute (alter table &dbschema..md_creative_x_asset add constraint md_creative_x_asset_pk primary key (asset_id,creative_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_cust_attrib(
      ...
      execute (alter table &dbschema..md_cust_attrib add constraint md_cust_attrib_pk primary key (attr_group_id,attr_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_custattrib_table_values(
      ...
      execute (alter table &dbschema..md_custattrib_table_values add constraint md_custattrib_table_value_pk primary key (attr_id,table_val)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_dataview(
        ...
        ,
        analytic_active_flg char(1) NULL ,analytics_period_type_nm varchar(10) NULL ,analytics_period_val integer NULL ,created_user_nm varchar(256) NULL ,custom_recent_cd varchar(36) NULL ,custom_recent_exclude_cd varchar(36) NULL ,dataview_desc varchar(1332) NULL ,dataview_id varchar(36) NULL ,dataview_nm varchar(60) NULL ,dataview_status_cd varchar(20) NULL ,half_life_time_val integer NULL ,include_external_flg char(1) NULL ,include_internal_flg char(1) NULL ,last_published_dttm timestamp NULL ,max_path_length_val integer NULL ,max_path_time_type_nm varchar(10) NULL ,max_path_time_val integer NULL ,owner_nm varchar(256) NULL ,selected_task_list varchar(1000) NULL ,valid_from_dttm timestamp NULL ,valid_to_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_dataview add constraint md_dataview_pk primary key (dataview_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_dataview_x_event(
      ...
      execute (alter table &dbschema..md_dataview_x_event add constraint md_dataview_x_event_pk primary key (dataview_version_id,event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_event(
      ...
      execute (alter table &dbschema..md_event add constraint md_event_pk primary key (event_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_fiscal_period(
        ...
        ,
        created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,fp_cls_ver varchar(128) NULL ,fp_desc varchar(1332) NULL ,fp_nm varchar(128) NULL ,fp_obsolete_flg char(1) NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_fiscal_period add constraint md_fiscal_period_pk primary key (fp_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey(
        ...
        ,
        activated_user_nm varchar(256) NULL ,control_group_flg char(1) NULL ,created_user_nm varchar(256) NULL ,journey_id varchar(36) NULL ,journey_nm varchar(256) NULL ,journey_status_cd varchar(20) NULL ,last_activated_dttm timestamp NULL ,purpose_id varchar(36) NULL ,target_goal_qty integer NULL ,target_goal_type_nm varchar(20) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_journey add constraint md_journey_pk primary key (journey_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_node(
      ...
      execute (alter table &dbschema..md_journey_node add constraint md_journey_node_pk primary key (journey_node_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_node_occurrence(
        ...
        ,
        end_dttm timestamp NULL ,error_messages varchar(256) NULL ,execution_status varchar(36) NULL ,journey_id varchar(36) NULL ,journey_node_id varchar(36) NULL ,journey_occurrence_id varchar(36) NULL ,journey_version_id varchar(36) NULL ,num_of_contacts_entered integer NULL ,start_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_journey_node_occurrence add constraint md_journey_node_occurrenc_pk primary key (journey_node_occurrence_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_occurrence(
        ...
        ,
        aud_occurrence_id varchar(36) NULL ,end_dttm timestamp NULL ,error_messages varchar(256) NULL ,execution_status varchar(36) NULL ,journey_id varchar(36) NULL ,journey_occurrence_num integer NULL ,journey_version_id varchar(36) NULL ,num_of_contacts_entered integer NULL ,num_of_contacts_suppressed integer NULL ,occurrence_type_nm varchar(36) NULL ,start_dttm timestamp NULL ,started_by_nm varchar(128) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_journey_occurrence add constraint md_journey_occurrence_pk primary key (journey_occurrence_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_audience(
      ...
      execute (alter table &dbschema..md_journey_x_audience add constraint md_journey_x_audience_pk primary key (audience_id,journey_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_event(
      ...
      execute (alter table &dbschema..md_journey_x_event add constraint md_journey_x_event_pk primary key (event_id,journey_node_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_journey_x_task(
      ...
      execute (alter table &dbschema..md_journey_x_task add constraint md_journey_x_task_pk primary key (journey_node_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_message(
      ...
      execute (alter table &dbschema..md_message add constraint md_message_pk primary key (message_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_message_custom_prop(
      ...
      execute (alter table &dbschema..md_message_custom_prop add constraint md_message_custom_prop_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_message_x_creative(
      ...
      execute (alter table &dbschema..md_message_x_creative add constraint md_message_x_creative_pk primary key (creative_id,message_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_object_type(
      ...
      execute (alter table &dbschema..md_object_type add constraint md_object_type_pk primary key (attr_group_id,attr_id,object_type)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_occurrence(
        occurrence_id varchar(36) NOT NULL
        ,
        end_tm timestamp NULL ,execution_status_cd varchar(50) NULL ,object_id varchar(36) NULL ,object_type_nm varchar(100) NULL ,object_version_id varchar(36) NULL ,occurrence_no integer NULL ,occurrence_type_nm varchar(100) NULL ,properties_map_doc varchar(4000) NULL ,start_tm timestamp NULL ,started_by_nm varchar(100) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_occurrence add constraint md_occurrence_pk primary key (occurrence_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_picklist(
      ...
      execute (alter table &dbschema..md_picklist add constraint md_picklist_pk primary key (attr_id,plist_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_purpose(
      ...
      execute (alter table &dbschema..md_purpose add constraint md_purpose_pk primary key (purpose_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_rtc(
        ...
        ,
        content_map_doc varchar(4000) NULL ,occurrence_no integer NULL ,rtc_dttm timestamp NULL ,segment_version_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_rtc add constraint md_rtc_pk primary key (rtc_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment(
      ...
      execute (alter table &dbschema..md_segment add constraint md_segment_pk primary key (segment_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_custom_prop(
      ...
      execute (alter table &dbschema..md_segment_custom_prop add constraint md_segment_custom_prop_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_map(
        ...
        ,
        business_context_id varchar(36) NULL ,created_user_nm varchar(256) NULL ,folder_path_nm varchar(256) NULL ,last_published_dttm timestamp NULL ,owner_nm varchar(256) NULL ,rec_scheduled_start_dttm timestamp NULL ,rec_scheduled_start_tm varchar(20) NULL ,recurrence_day_of_month_no integer NULL ,recurrence_day_of_week_txt varchar(100) NULL ,recurrence_day_of_wk_ordinal_no varchar(36) NULL ,recurrence_days_of_week_txt varchar(100) NULL ,recurrence_frequency_cd varchar(36) NULL ,recurrence_monthly_type_nm varchar(36) NULL ,scheduled_end_dttm timestamp NULL ,scheduled_flg char(1) NULL ,scheduled_start_dttm timestamp NULL ,segment_map_category_nm varchar(100) NULL ,segment_map_cd varchar(60) NULL ,segment_map_desc varchar(1332) NULL ,segment_map_id varchar(36) NULL ,segment_map_nm varchar(60) NULL ,segment_map_src_cd varchar(10) NULL ,segment_map_status_cd varchar(20) NULL ,valid_from_dttm timestamp NULL ,valid_to_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_segment_map add constraint md_segment_map_pk primary key (segment_map_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_map_custom_prop(
      ...
      execute (alter table &dbschema..md_segment_map_custom_prop add constraint md_segment_map_custom_pro_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_map_x_segment(
      ...
      execute (alter table &dbschema..md_segment_map_x_segment add constraint md_segment_map_x_segment_pk primary key (segment_id,segment_map_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_test(
        task_version_id varchar(36) NOT NULL ,test_cd varchar(60) NOT NULL
        ,
        stratified_samp_criteria_txt varchar(1024) NULL ,stratified_sampling_flg char(1) NULL ,task_id varchar(36) NULL ,test_cnt integer NULL ,test_enabled_flg char(1) NULL ,test_nm varchar(65) NULL ,test_sizing_type_nm varchar(65) NULL ,test_type_nm varchar(10) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_segment_test add constraint md_segment_test_pk primary key (task_version_id,test_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_test_x_segment(
      ...
      execute (alter table &dbschema..md_segment_test_x_segment add constraint md_segment_test_x_segment_pk primary key (segment_id,task_version_id,test_cd)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_segment_x_event(
      ...
      execute (alter table &dbschema..md_segment_x_event add constraint md_segment_x_event_pk primary key (event_id,segment_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_spot(
      ...
      execute (alter table &dbschema..md_spot add constraint md_spot_pk primary key (spot_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_target_assist(
        ...
        ,
        last_modified_dttm timestamp NULL ,model_available_dttm timestamp NULL ,percent_target_population_size integer NULL ,threshold_type_nm char(30) NULL ,use_targeting_flg char(1) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..md_target_assist add constraint md_target_assist_pk primary key (task_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_custom_prop(
      ...
      execute (alter table &dbschema..md_task_custom_prop add constraint md_task_custom_prop_pk primary key (Hashed_pk_col)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_audience(
      ...
      execute (alter table &dbschema..md_task_x_audience add constraint md_task_x_audience_pk primary key (audience_id,task_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_creative(
      ...
      execute (alter table &dbschema..md_task_x_creative add constraint md_task_x_creative_pk primary key (creative_id,spot_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_dataview(
      ...
      execute (alter table &dbschema..md_task_x_dataview add constraint md_task_x_dataview_pk primary key (dataview_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_event(
      ...
      execute (alter table &dbschema..md_task_x_event add constraint md_task_x_event_pk primary key (event_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_message(
      ...
      execute (alter table &dbschema..md_task_x_message add constraint md_task_x_message_pk primary key (message_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_segment(
      ...
      execute (alter table &dbschema..md_task_x_segment add constraint md_task_x_segment_pk primary key (segment_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_spot(
      ...
      execute (alter table &dbschema..md_task_x_spot add constraint md_task_x_spot_pk primary key (spot_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_task_x_variant(
      ...
      execute (alter table &dbschema..md_task_x_variant add constraint md_task_x_variant_pk primary key (analysis_group_id,task_version_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_vendor(
      ...
      execute (alter table &dbschema..md_vendor add constraint md_vendor_pk primary key (vendor_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_wf_process_def(
      ...
      execute (alter table &dbschema..md_wf_process_def add constraint md_wf_process_def_pk primary key (engine_pdef_id,pdef_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_wf_process_def_attr_grp(
      ...
      execute (alter table &dbschema..md_wf_process_def_attr_grp add constraint md_wf_process_def_attr_gr_pk primary key (attr_group_id,pdef_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_wf_process_def_categories(
      ...
      execute (alter table &dbschema..md_wf_process_def_categories add constraint md_wf_process_def_categor_pk primary key (category_id,pdef_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_wf_process_def_task_assg(
      ...
      execute (alter table &dbschema..md_wf_process_def_task_assg add constraint md_wf_process_def_task_as_pk primary key (assignee_id,assignee_type,pdef_id,task_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..md_wf_process_def_tasks(
      ...
      execute (alter table &dbschema..md_wf_process_def_tasks add constraint md_wf_process_def_tasks_pk primary key (pdef_id,task_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..media_activity_details(
        action_dttm timestamp NOT NULL ,detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,media_nm varchar(260) NOT NULL
        ,
      ...
      execute (alter table &dbschema..media_activity_details add constraint media_activity_details_pk primary key (action_dttm,detail_id,media_nm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..media_details(
        detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,identity_id varchar(36) NULL ,media_nm varchar(260) NOT NULL ,play_start_dttm timestamp NOT NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,media_player_nm varchar(30) NULL ,media_player_version_txt varchar(20) NULL ,media_uri_txt varchar(2024) NULL ,play_start_dttm_tz timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..media_details add constraint media_details_pk primary key (detail_id,media_nm,play_start_dttm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..media_details_ext(
        detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,media_nm varchar(260) NOT NULL ,play_end_dttm timestamp NOT NULL
        ,
        interaction_cnt integer NULL ,load_dttm timestamp NULL ,media_uri_txt varchar(2024) NULL ,play_end_dttm_tz timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..media_details_ext add constraint media_details_ext_pk primary key (detail_id,media_nm,play_end_dttm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..mobile_focus_defocus(
      ...
      execute (alter table &dbschema..mobile_focus_defocus add constraint mobile_focus_defocus_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..mobile_spots(
      ...
      execute (alter table &dbschema..mobile_spots add constraint mobile_spots_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..monthly_usage(
      ...
      execute (alter table &dbschema..monthly_usage add constraint monthly_usage_pk primary key (event_month)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_failed(
      ...
      execute (alter table &dbschema..notification_failed add constraint notification_failed_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_opened(
      ...
      execute (alter table &dbschema..notification_opened add constraint notification_opened_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_send(
      ...
      execute (alter table &dbschema..notification_send add constraint notification_send_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..notification_targeting_request(
      ...
      execute (alter table &dbschema..notification_targeting_request add constraint notification_targeting_re_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..outbound_system(
      ...
      execute (alter table &dbschema..outbound_system add constraint outbound_system_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..page_details(
        ...
        ,
        bytes_sent_cnt integer NULL ,channel_nm varchar(40) NULL ,class10_id varchar(650) NULL ,class11_id varchar(650) NULL ,class12_id varchar(650) NULL ,class13_id varchar(650) NULL ,class14_id varchar(650) NULL ,class15_id varchar(650) NULL ,class1_id varchar(650) NULL ,class2_id varchar(650) NULL ,class3_id varchar(650) NULL ,class4_id varchar(650) NULL ,class5_id varchar(650) NULL ,class6_id varchar(650) NULL ,class7_id varchar(650) NULL ,class8_id varchar(650) NULL ,class9_id varchar(650) NULL ,detail_dttm timestamp NULL ,detail_dttm_tz timestamp NULL ,detail_id_hex varchar(32) NULL ,domain_nm varchar(165) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,page_complete_sec_cnt integer NULL ,page_desc varchar(1332) NULL ,page_load_sec_cnt integer NULL ,page_url_txt varchar(1332) NULL ,protocol_nm varchar(8) NULL ,referrer_url_txt varchar(1332) NULL ,url_domain varchar(215) NULL ,window_size_txt varchar(20) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..page_details add constraint page_details_pk primary key (detail_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..page_details_ext(
        ...
        ,
        active_sec_spent_on_page_cnt integer NULL ,seconds_spent_on_page_cnt integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..page_details_ext add constraint page_details_ext_pk primary key (detail_id,load_dttm,session_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..page_errors(
        ...
        ,
        event_id varchar(36) NULL ,event_source_cd varchar(100) NULL ,in_page_error_dttm timestamp NULL ,in_page_error_dttm_tz timestamp NULL ,load_dttm timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..page_errors add constraint page_errors_pk primary key (detail_id,error_location_txt,in_page_error_txt)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..planning_hierarchy_defn(
        hier_defn_id varchar(128) NOT NULL ,level_nm varchar(128) NOT NULL ,level_no integer NOT NULL
        ,
      ...
      execute (alter table &dbschema..planning_hierarchy_defn add constraint planning_hierarchy_defn_pk primary key (hier_defn_id,level_nm,level_no)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..planning_info_custom_prop(
      ...
      execute (alter table &dbschema..planning_info_custom_prop add constraint planning_info_custom_prop_pk primary key (attr_group_id,attr_id,planning_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..product_views(
        ...
        ,
        action_dttm timestamp NULL ,action_dttm_tz timestamp NULL ,availability_message_txt varchar(650) NULL ,channel_nm varchar(40) NULL ,currency_cd varchar(6) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,product_group_nm varchar(130) NULL ,properties_map_doc varchar(4000) NULL ,saving_message_txt varchar(650) NULL ,shipping_message_txt varchar(650) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..product_views add constraint product_views_pk primary key (detail_id,product_id,product_nm,product_sku)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..promotion_displayed(
        detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,display_dttm timestamp NOT NULL ,event_designed_id varchar(36) NULL ,identity_id varchar(36) NULL ,promotion_nm varchar(260) NOT NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        channel_nm varchar(40) NULL ,derived_display_flg char(1) NULL ,display_dttm_tz timestamp NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,promotion_creative_nm varchar(260) NULL ,promotion_number integer NULL ,promotion_placement_nm varchar(260) NULL ,promotion_tracking_cd varchar(65) NULL ,promotion_type_nm varchar(65) NULL ,properties_map_doc varchar(4000) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..promotion_displayed add constraint promotion_displayed_pk primary key (detail_id,display_dttm,promotion_nm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..promotion_used(
        click_dttm timestamp NOT NULL ,detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,event_designed_id varchar(36) NULL ,identity_id varchar(36) NULL ,promotion_nm varchar(260) NOT NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        channel_nm varchar(40) NULL ,click_dttm_tz timestamp NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,promotion_creative_nm varchar(260) NULL ,promotion_number integer NULL ,promotion_placement_nm varchar(260) NULL ,promotion_tracking_cd varchar(65) NULL ,promotion_type_nm varchar(65) NULL ,properties_map_doc varchar(4000) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..promotion_used add constraint promotion_used_pk primary key (click_dttm,detail_id,promotion_nm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..response_history(
      ...
      execute (alter table &dbschema..response_history add constraint response_history_pk primary key (response_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..search_results(
        detail_id varchar(32) NOT NULL ,detail_id_hex varchar(32) NULL ,event_designed_id varchar(36) NULL ,identity_id varchar(36) NULL ,search_results_dttm timestamp NOT NULL ,search_results_sk varchar(100) NULL ,session_id varchar(29) NULL ,session_id_hex varchar(29) NULL ,visit_id varchar(32) NULL ,visit_id_hex varchar(32) NULL
        ,
        channel_nm varchar(40) NULL ,event_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,mobile_app_id varchar(40) NULL ,properties_map_doc varchar(4000) NULL ,results_displayed_flg char(1) NULL ,search_nm varchar(42) NULL ,search_results_displayed integer NULL ,search_results_dttm_tz timestamp NULL ,srch_field_id varchar(325) NULL ,srch_field_name varchar(325) NULL ,srch_phrase varchar(2600) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..search_results add constraint search_results_pk primary key (detail_id,search_results_dttm)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..search_results_ext(
        ...
        ,
        load_dttm timestamp NULL ,search_results_displayed integer NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..search_results_ext add constraint search_results_ext_pk primary key (search_results_sk)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..session_details_ext(
        ...
        ,
        active_sec_spent_in_sessn_cnt integer NULL ,last_session_activity_dttm timestamp NULL ,last_session_activity_dttm_tz timestamp NULL ,load_dttm timestamp NULL ,seconds_spent_in_session_cnt integer NULL ,session_expiration_dttm timestamp NULL ,session_expiration_dttm_tz timestamp NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..session_details_ext add constraint session_details_ext_pk primary key (session_id,session_id_hex)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_message_clicked(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_click_dttm timestamp NULL ,sms_click_dttm_tz timestamp NULL ,sms_message_id varchar(40) NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_message_clicked add constraint sms_message_clicked_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_message_delivered(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_delivered_dttm timestamp NULL ,sms_delivered_dttm_tz timestamp NULL ,sms_message_id varchar(40) NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_message_delivered add constraint sms_message_delivered_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_message_failed(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,reason_cd varchar(5) NULL ,reason_description_txt varchar(1500) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_failed_dttm timestamp NULL ,sms_failed_dttm_tz timestamp NULL ,sms_message_id varchar(40) NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_message_failed add constraint sms_message_failed_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_message_reply(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_content varchar(40) NULL ,sms_message_id varchar(40) NULL ,sms_reply_dttm timestamp NULL ,sms_reply_dttm_tz timestamp NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_message_reply add constraint sms_message_reply_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_message_send(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,fragment_cnt integer NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_message_id varchar(40) NULL ,sms_send_dttm timestamp NULL ,sms_send_dttm_tz timestamp NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_message_send add constraint sms_message_send_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_optout(
        event_id varchar(36) NOT NULL
        ,
        aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_message_id varchar(40) NULL ,sms_optout_dttm timestamp NULL ,sms_optout_dttm_tz timestamp NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_optout add constraint sms_optout_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..sms_optout_details(
        event_id varchar(36) NOT NULL
        ,
        address_val varchar(20) NULL ,aud_occurrence_id varchar(36) NULL ,audience_id varchar(36) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,country_cd varchar(3) NULL ,creative_id varchar(36) NULL ,creative_version_id varchar(36) NULL ,event_designed_id varchar(36) NULL ,event_nm varchar(256) NULL ,identity_id varchar(36) NULL ,load_dttm timestamp NULL ,occurrence_id varchar(36) NULL ,response_tracking_cd varchar(36) NULL ,sender_id varchar(40) NULL ,sms_message_id varchar(40) NULL ,sms_optout_dttm timestamp NULL ,sms_optout_dttm_tz timestamp NULL ,task_id varchar(36) NULL ,task_version_id varchar(36) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..sms_optout_details add constraint sms_optout_details_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..spot_clicked(
        creative_id varchar(36) NULL ,detail_id_hex varchar(32) NULL ,event_designed_id varchar(36) NULL ,event_id varchar(36) NOT NULL ,identity_id varchar(36) NULL ,occurrence_id varchar(36) NULL ,session_id_hex varchar(29) NULL ,spot_id varchar(36) NULL ,task_id varchar(36) NULL ,visit_id_hex varchar(32) NULL
        ,
        channel_nm varchar(40) NULL ,channel_user_id varchar(300) NULL ,context_type_nm varchar(256) NULL ,context_val varchar(256) NULL ,control_group_flg char(1) NULL ,creative_version_id varchar(36) NULL ,event_key_cd varchar(100) NULL ,event_nm varchar(256) NULL ,event_source_cd varchar(100) NULL ,load_dttm timestamp NULL ,message_id varchar(36) NULL ,message_version_id varchar(36) NULL ,mobile_app_id varchar(40) NULL ,product_id varchar(128) NULL ,product_nm varchar(128) NULL ,product_qty_no integer NULL ,product_sku_no varchar(100) NULL ,properties_map_doc varchar(4000) NULL ,rec_group_id varchar(3) NULL ,request_id varchar(36) NULL ,reserved_1_txt varchar(100) NULL ,reserved_2_txt varchar(100) NULL ,response_tracking_cd varchar(36) NULL ,segment_id varchar(36) NULL ,segment_version_id varchar(36) NULL ,spot_clicked_dttm timestamp NULL ,spot_clicked_dttm_tz timestamp NULL ,task_version_id varchar(36) NULL ,url_txt varchar(1332) NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..spot_clicked add constraint spot_clicked_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..spot_requested(
      ...
      execute (alter table &dbschema..spot_requested add constraint spot_requested_pk primary key (event_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..tag_details(
      ...
      execute (alter table &dbschema..tag_details add constraint tag_details_pk primary key (component_id,component_type,tag_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..wf_process_details(
        ...
        ,
        business_info_id varchar(128) NULL ,business_info_nm varchar(128) NULL ,business_info_type varchar(128) NULL ,completed_dttm timestamp NULL ,created_by_usernm varchar(128) NULL ,created_dttm timestamp NULL ,delayed_by_day bigint NULL ,deleted_by_usernm varchar(128) NULL ,deleted_dttm timestamp NULL ,indexed_dttm timestamp NULL ,last_modified_dttm timestamp NULL ,last_modified_usernm varchar(128) NULL ,load_dttm timestamp NULL ,modified_status_cd varchar(128) NULL ,percent_complete bigint NULL ,planned_end_dttm timestamp NULL ,process_category varchar(128) NULL ,process_comment varchar(128) NULL ,process_desc varchar(1332) NULL ,process_instance_version varchar(128) NULL ,process_nm varchar(128) NULL ,process_owner_usernm varchar(128) NULL ,process_status varchar(128) NULL ,process_type varchar(128) NULL ,projected_end_dttm timestamp NULL ,published_by_usernm varchar(128) NULL ,published_dttm timestamp NULL ,start_dttm timestamp NULL ,submitted_by_usernm varchar(128) NULL ,submitted_dttm timestamp NULL ,timeline_calculated_dttm timestamp NULL ,user_tasks_cnt bigint NULL
        )) BY REDSHIFT;
      execute (alter table &dbschema..wf_process_details add constraint wf_process_details_pk primary key (pdef_id,process_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
 ...
 CONNECT TO REDSHIFT (&sql_passthru_connection.);
    EXECUTE (CREATE TABLE &dbschema..wf_process_details_custom_prop(
      ...
      execute (alter table &dbschema..wf_process_details_custom_prop add constraint wf_process_details_custom_pk primary key (attr_group_id,attr_id,process_id)) BY REDSHIFT;
 DISCONNECT FROM REDSHIFT;
 QUIT;
