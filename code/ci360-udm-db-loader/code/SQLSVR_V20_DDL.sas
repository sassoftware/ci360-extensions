...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..abt_attribution (
      interaction_cost int NULL, conversion_value int NULL, interaction_dttm datetime2 NOT NULL, task_id varchar(36) NULL, 
  ...
  execute (
    ALTER TABLE dbo.ABT_ATTRIBUTION
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.AB_TEST_PATH_ASSIGNMENT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.ACTIVITY_CONVERSION
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.ACTIVITY_FLOW_IN
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.ACTIVITY_START
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.ADVERTISING_CONTACT
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..asset_details (
      ...
      asset_deleted_flg char(1) NULL, external_sharing_error_dt date NULL, average_user_rating_val decimal(4,2) NULL, folder_level int NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..asset_rendition_details (
      ...
      current_revision_flg char(1) NULL, media_dpi decimal(10,2) NULL, file_size int NULL, media_depth int NULL, 
      media_height int NULL, rend_duration int NULL, media_width int NULL, created_dttm datetime2 NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.AUDIENCE_MEMBERSHIP_CHANGE
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.BUSINESS_PROCESS_DETAILS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CART_ACTIVITY_DETAILS
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..cdm_activity_detail (
      updated_dttm datetime2 NULL, last_published_dttm datetime2 NULL, valid_from_dttm datetime2 NULL, valid_to_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..cdm_contact_history (
      optimization_backfill_flg char(1) NULL, control_group_flg char(1) NULL, contact_dt date NOT NULL, updated_dttm datetime2 NULL, 
      contact_dttm_tz datetime2 NULL, contact_dttm datetime2 NULL, source_system_cd varchar(10) NULL, external_contact_info_2_id varchar(32) NULL, 
  ...
  execute (
    ALTER TABLE dbo.CDM_CONTACT_HISTORY
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CDM_RESPONSE_EXTENDED_ATTR
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CDM_RESPONSE_HISTORY
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..cdm_task_detail (
      ...
      updated_dttm datetime2 NULL, valid_from_dttm datetime2 NULL, export_dttm datetime2 NULL, valid_to_dttm datetime2 NULL, 
      scheduled_start_dttm datetime2 NULL, task_version_id varchar(36) NULL, task_type_nm varchar(40) NULL, task_subtype_nm varchar(100) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..commitment_line_items (
      ...
      cc_available_amt decimal(17,2) NULL, item_vend_alloc_amt decimal(17,2) NULL, item_number int NULL, created_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..commitment_line_items_ccbdgt (
      ...
      cc_bdgt_cmtmnt_outstanding_amt decimal(17,2) NULL, cmtmnt_overspent_amt decimal(17,2) NULL, cc_bdgt_direct_invoice_amt decimal(17,2) NULL, item_number int NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CONTACT_HISTORY
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CONVERSION_MILESTONE
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.CUSTOM_EVENTS_EXT
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..daily_usage (
      ...
      db_size decimal(17,2) NULL, admin_user_cnt int NULL, event_day varchar(36) NOT NULL )) by &database.;
   DISCONNECT FROM &database.;
QUIT;
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.DATA_VIEW_DETAILS
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..dbt_adv_campaign_visitors (
      ge_longitude decimal(13,6) NULL, ge_latitude decimal(13,6) NULL, rv_revenue decimal(17,2) NULL, co_conversions int NULL, 
  ...
  execute (
    ALTER TABLE dbo.DBT_ADV_CAMPAIGN_VISITORS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.DBT_BUSINESS_PROCESS
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..dbt_content (
      ...
      session_complete_load_dttm datetime2 NOT NULL, session_start_dttm_tz datetime2 NULL, detail_dttm_tz datetime2 NULL, detail_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..dbt_media_consumption (
      ...
      session_complete_load_dttm datetime2 NOT NULL, media_start_dttm datetime2 NULL, media_start_dttm_tz datetime2 NULL, views_started tinyint NULL, 
      views_completed tinyint NULL, views tinyint NULL, media_section_view tinyint NULL, visitor_type varchar(10) NULL, 
      visitor_id varchar(32) NULL, visit_origination_type varchar(65) NULL, visit_origination_tracking_code varchar(65) NULL, visit_origination_placement varchar(390) NULL, 
  ...
  execute (
    ALTER TABLE dbo.DBT_MEDIA_CONSUMPTION
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.DBT_PROMOTIONS
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..dbt_search (
      ...
      search_unknown_results int NULL, search_returned_results int NULL, exit_pages int NULL, search_no_results_returned int NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.DIRECT_CONTACT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.DOCUMENT_DETAILS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.EMAIL_COMPLAINT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.EMAIL_OPTOUT_DETAILS
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..email_send (
      test_flg char(1) NULL, properties_map_doc varchar(4000) NULL, load_dttm datetime2 NOT NULL, email_send_dttm_tz datetime2 NULL, 
      email_send_dttm datetime2 NULL, task_version_id varchar(36) NULL, subject_line_txt varchar(256) NULL, segment_id varchar(36) NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.EXTERNAL_EVENT
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..fiscal_cc_budget (
      ...
      cc_bdgt_direct_invoice_amt decimal(17,2) NULL, cc_bdgt_cmtmnt_invoice_cnt int NULL, last_modified_dttm datetime2 NULL, created_dttm datetime2 NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.IMPRESSION_DELIVERED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.IMPRESSION_SPOT_VIEWABLE
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..invoice_line_items (
      ...
      cc_allocated_amt decimal(17,2) NULL, item_number int NULL, payment_dttm datetime2 NULL, load_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..invoice_line_items_ccbdgt (
      ...
      cc_bdgt_amt decimal(17,2) NULL, cc_allocated_amt decimal(17,2) NULL, item_qty int NULL, item_number int NULL, 
      item_vend_alloc_unit int NULL, item_alloc_unit int NULL, cc_bdgt_cmtmnt_invoice_cnt int NULL, created_dttm datetime2 NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.IN_APP_TARGETING_REQUEST
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.JOURNEY_HOLDOUT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.JOURNEY_NODE_ENTRY
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.JOURNEY_SUCCESS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.JOURNEY_SUPPRESSION
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_activity_all (
      last_published_dttm datetime2 NULL, valid_from_dttm datetime2 NULL, valid_to_dttm datetime2 NULL, folder_path_nm varchar(256) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_activity_node_all (
      ...
      end_node_flg char(1) NULL, start_node_flg char(1) NULL, specific_wait_flg char(1) NULL, node_sequence_no int NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_dataview (
      include_external_flg char(1) NULL, include_internal_flg char(1) NULL, analytic_active_flg char(1) NULL, max_path_time_val int NULL, 
      analytics_period_val int NULL, max_path_length_val int NULL, half_life_time_val int NULL, last_published_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_dataview_all (
      include_internal_flg char(1) NULL, analytic_active_flg char(1) NULL, include_external_flg char(1) NULL, max_path_length_val int NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_grid_attr_defn (
      attr_obsolete_flg char(1) NULL, grid_mandatory_flg char(1) NULL, grid_obsolete_flg char(1) NULL, attr_order_no int NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_journey_occurrence (
      num_of_contacts_entered int NULL, num_of_contacts_suppressed int NULL, journey_occurrence_num int NULL, start_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_spot (
      location_selector_flg char(1) NULL, multi_page_flg char(1) NULL, last_published_dttm datetime2 NULL, valid_from_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_task (
      ...
      recurrence_day_of_month_no int NULL, impressions_qty_period_cnt int NULL, maximum_period_expression_cnt int NULL, valid_from_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_task_all (
      ...
      scheduled_flg char(1) NULL, export_template_flg char(1) NULL, segment_tests_flg char(1) NULL, recurrence_day_of_month_no int NULL, 
      impressions_per_session_cnt int NULL, test_duration int NULL, display_priority_no int NULL, limit_period_unit_cnt int NULL, 
      maximum_period_expression_cnt int NULL, impressions_qty_period_cnt int NULL, impressions_life_time_cnt int NULL, last_published_dttm datetime2 NULL, 
      model_start_dttm datetime2 NULL, scheduled_start_dttm datetime2 NULL, rec_scheduled_end_dttm datetime2 NULL, rec_scheduled_start_dttm datetime2 NULL, 
      scheduled_end_dttm datetime2 NULL, valid_from_dttm datetime2 NULL, valid_to_dttm datetime2 NULL, template_id varchar(36) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_wf_process_def_tasks (
      ...
      resp_file_enabled_flg char(1) NULL, res_mandatory_flg char(1) NULL, show_sourceitemlink_flg char(1) NULL, load_dttm datetime2 NULL, 
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.MEDIA_ACTIVITY_DETAILS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.MEDIA_DETAILS_EXT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.MOBILE_FOCUS_DEFOCUS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.NOTIFICATION_FAILED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.NOTIFICATION_OPENED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.NOTIFICATION_SEND
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.NOTIFICATION_TARGETING_REQUEST
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.OUTBOUND_SYSTEM
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.PAGE_DETAILS_EXT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.PROMOTION_DISPLAYED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.PROMOTION_USED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.RESPONSE_HISTORY
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SEARCH_RESULTS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SEARCH_RESULTS_EXT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SESSION_DETAILS_EXT
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_MESSAGE_CLICKED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_MESSAGE_DELIVERED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_MESSAGE_FAILED
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_MESSAGE_REPLY
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_MESSAGE_SEND
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SMS_OPTOUT_DETAILS
...
PROC SQL ;
  ...
  execute (
    ALTER TABLE dbo.SPOT_REQUESTED
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..wf_process_details (
      delayed_by_day bigint NULL, percent_complete bigint NULL, user_tasks_cnt bigint NULL, completed_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..wf_process_tasks (
      ...
      skip_update_scanning_flg char(1) NULL, is_sequential_flg char(1) NULL, projected_start_dttm datetime2 NULL, published_dttm datetime2 NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..wf_tasks_user_assignment (
      ...
      activation_completed_flg char(1) NULL, is_latest_flg char(1) NULL, created_dttm datetime2 NULL, modified_dttm datetime2 NULL, 
