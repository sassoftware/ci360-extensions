   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ABT_ATTRIBUTION_tmp as 
            select * from &dbschema..ABT_ATTRIBUTION where 1=0            ) by &database.;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.conversion_value = d.conversion_value, b.load_id = d.load_id, 
            b.interaction_subtype = d.interaction_subtype, b.interaction_type = d.interaction_type, 
            b.task_id = d.task_id, b.interaction = d.interaction, 
...
%if %sysfunc(exist(&udmmart..AB_TEST_PATH_ASSIGNMENT)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..AB_TEST_PATH_ASSIGNMENT_tmp as 
            select * from &dbschema..AB_TEST_PATH_ASSIGNMENT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.abtestpath_assignment_dttm_tz = d.abtestpath_assignment_dttm_tz, 
            b.load_dttm = d.load_dttm, b.abtestpath_assignment_dttm = d.abtestpath_assignment_dttm, 
            b.context_type_nm = d.context_type_nm, b.session_id_hex = d.session_id_hex, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ACTIVITY_CONVERSION_tmp as 
            select * from &dbschema..ACTIVITY_CONVERSION where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.activity_conversion_dttm_tz = d.activity_conversion_dttm_tz, b.activity_conversion_dttm = d.activity_conversion_dttm, 
            b.abtest_path_id = d.abtest_path_id, b.activity_id = d.activity_id, 
            b.activity_node_id = d.activity_node_id, b.channel_nm = d.channel_nm, 
            b.session_id_hex = d.session_id_hex, b.parent_event_designed_id = d.parent_event_designed_id, 
            b.identity_id = d.identity_id, b.goal_id = d.goal_id, 
...
%if %sysfunc(exist(&udmmart..ACTIVITY_FLOW_IN)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ACTIVITY_FLOW_IN_tmp as 
            select * from &dbschema..ACTIVITY_FLOW_IN where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.load_dttm = d.load_dttm, 
            b.activity_flow_in_dttm = d.activity_flow_in_dttm, b.activity_flow_in_dttm_tz = d.activity_flow_in_dttm_tz, 
            b.task_id = d.task_id, b.identity_id = d.identity_id, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm, 
            b.event_nm = d.event_nm, b.channel_user_id = d.channel_user_id, 
            b.activity_node_id = d.activity_node_id, b.activity_id = d.activity_id, 
            b.abtest_path_id = d.abtest_path_id, b.channel_nm = d.channel_nm, 
...
%if %sysfunc(exist(&udmmart..ACTIVITY_START)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ACTIVITY_START_tmp as 
            select * from &dbschema..ACTIVITY_START where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.activity_start_dttm = d.activity_start_dttm, 
            b.load_dttm = d.load_dttm, b.activity_start_dttm_tz = d.activity_start_dttm_tz, 
            b.channel_user_id = d.channel_user_id, b.channel_nm = d.channel_nm, 
            b.identity_id = d.identity_id, b.event_nm = d.event_nm, 
            b.activity_id = d.activity_id, b.event_designed_id = d.event_designed_id, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ADVERTISING_CONTACT_tmp as 
            select * from &dbschema..ADVERTISING_CONTACT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.task_version_id = d.task_version_id, b.task_action_nm = d.task_action_nm, 
            b.segment_id = d.segment_id, b.occurrence_id = d.occurrence_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.journey_id = d.journey_id, b.context_val = d.context_val, 
            b.response_tracking_cd = d.response_tracking_cd, b.context_type_nm = d.context_type_nm, 
            b.segment_version_id = d.segment_version_id, b.channel_nm = d.channel_nm, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..AUDIENCE_MEMBERSHIP_CHANGE_tmp as 
            select * from &dbschema..AUDIENCE_MEMBERSHIP_CHANGE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..BUSINESS_PROCESS_DETAILS_tmp as 
            select * from &dbschema..BUSINESS_PROCESS_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.is_completion_flg = d.is_completion_flg, b.process_instance_no = d.process_instance_no, 
            b.step_order_no = d.step_order_no, b.process_attempt_cnt = d.process_attempt_cnt, 
            b.process_exception_dttm_tz = d.process_exception_dttm_tz, b.process_dttm = d.process_dttm, 
            b.load_dttm = d.load_dttm, b.process_exception_dttm = d.process_exception_dttm, 
            b.process_dttm_tz = d.process_dttm_tz, b.visit_id = d.visit_id, 
            b.session_id_hex = d.session_id_hex, b.process_step_nm = d.process_step_nm, 
            b.process_details_sk = d.process_details_sk, b.event_nm = d.event_nm, 
            ...
            b.identity_id = d.identity_id, b.next_detail_id = d.next_detail_id, 
            b.visit_id_hex = d.visit_id_hex, b.attribute2_txt = d.attribute2_txt, 
            b.event_source_cd = d.event_source_cd, b.process_exception_txt = d.process_exception_txt, 
            b.process_nm = d.process_nm, b.session_id = d.session_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..CART_ACTIVITY_DETAILS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..CART_ACTIVITY_DETAILS_tmp as 
            select * from &dbschema..CART_ACTIVITY_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.displayed_cart_amt = d.displayed_cart_amt, 
            b.unit_price_amt = d.unit_price_amt, b.displayed_cart_items_no = d.displayed_cart_items_no, 
            b.quantity_val = d.quantity_val, b.properties_map_doc = d.properties_map_doc, 
            b.activity_dttm_tz = d.activity_dttm_tz, b.activity_dttm = d.activity_dttm, 
            b.load_dttm = d.load_dttm, b.cart_activity_sk = d.cart_activity_sk, 
            b.availability_message_txt = d.availability_message_txt, b.activity_cd = d.activity_cd, 
            b.cart_id = d.cart_id, b.visit_id_hex = d.visit_id_hex, 
            ...
            b.detail_id = d.detail_id, b.currency_cd = d.currency_cd, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..CONTACT_HISTORY_tmp as 
            select * from &dbschema..CONTACT_HISTORY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.properties_map_doc = d.properties_map_doc, b.contact_dttm = d.contact_dttm, 
            b.contact_dttm_tz = d.contact_dttm_tz, b.load_dttm = d.load_dttm, 
            b.task_version_id = d.task_version_id, b.session_id_hex = d.session_id_hex, 
            b.occurrence_id = d.occurrence_id, b.journey_id = d.journey_id, 
            b.creative_id = d.creative_id, b.contact_nm = d.contact_nm, 
            b.contact_channel_nm = d.contact_channel_nm, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.context_val = d.context_val, b.event_designed_id = d.event_designed_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.visit_id_hex = d.visit_id_hex, b.audience_id = d.audience_id, 
            b.context_type_nm = d.context_type_nm, b.detail_id_hex = d.detail_id_hex, 
            b.identity_id = d.identity_id, b.message_id = d.message_id, 
            b.parent_event_designed_id = d.parent_event_designed_id, b.task_id = d.task_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..CONVERSION_MILESTONE_tmp as 
            select * from &dbschema..CONVERSION_MILESTONE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.properties_map_doc = d.properties_map_doc, b.conversion_milestone_dttm_tz = d.conversion_milestone_dttm_tz, 
            b.conversion_milestone_dttm = d.conversion_milestone_dttm, b.load_dttm = d.load_dttm, 
            b.event_designed_id = d.event_designed_id, b.creative_version_id = d.creative_version_id, 
            b.context_type_nm = d.context_type_nm, b.channel_nm = d.channel_nm, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.analysis_group_id = d.analysis_group_id, 
            b.activity_id = d.activity_id, b.audience_id = d.audience_id, 
            b.channel_user_id = d.channel_user_id, b.context_val = d.context_val, 
            b.creative_id = d.creative_id, b.detail_id_hex = d.detail_id_hex, 
            b.visit_id_hex = d.visit_id_hex, b.task_version_id = d.task_version_id, 
            ...
            b.response_tracking_cd = d.response_tracking_cd, b.reserved_2_txt = d.reserved_2_txt, 
            b.reserved_1_txt = d.reserved_1_txt, b.rec_group_id = d.rec_group_id, 
            b.parent_event_designed_id = d.parent_event_designed_id, b.occurrence_id = d.occurrence_id, 
            b.mobile_app_id = d.mobile_app_id, b.message_version_id = d.message_version_id, 
            b.message_id = d.message_id, b.journey_occurrence_id = d.journey_occurrence_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..CUSTOM_EVENTS_tmp as 
            select * from &dbschema..CUSTOM_EVENTS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.custom_event_dttm = d.custom_event_dttm, b.custom_event_dttm_tz = d.custom_event_dttm_tz, 
            b.visit_id_hex = d.visit_id_hex, b.visit_id = d.visit_id, 
            b.session_id_hex = d.session_id_hex, b.session_id = d.session_id, 
            b.reserved_2_txt = d.reserved_2_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.page_id = d.page_id, b.mobile_app_id = d.mobile_app_id, 
            b.identity_id = d.identity_id, b.event_type_nm = d.event_type_nm, 
            b.event_source_cd = d.event_source_cd, b.event_nm = d.event_nm, 
            b.event_key_cd = d.event_key_cd, b.event_designed_id = d.event_designed_id, 
            b.detail_id_hex = d.detail_id_hex, b.detail_id = d.detail_id, 
            b.custom_events_sk = d.custom_events_sk, b.custom_event_nm = d.custom_event_nm, 
            b.custom_event_group_nm = d.custom_event_group_nm, b.channel_user_id = d.channel_user_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..CUSTOM_EVENTS_EXT_tmp as 
            select * from &dbschema..CUSTOM_EVENTS_EXT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
...
%if %sysfunc(exist(&udmmart..DAILY_USAGE)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DAILY_USAGE_tmp as 
            select * from &dbschema..DAILY_USAGE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.customer_profiles_processed_str = d.customer_profiles_processed_str, 
            b.bc_subjcnt_str = d.bc_subjcnt_str, b.advertising_members_cnt_str = d.advertising_members_cnt_str, 
            b.api_usage_str = d.api_usage_str, b.web_impr_cnt = d.web_impr_cnt, 
            b.facebook_ads_cnt = d.facebook_ads_cnt, b.sms_frag_cnt = d.sms_frag_cnt, 
            b.mobile_in_app_msg_cnt = d.mobile_in_app_msg_cnt, b.mobile_push_cnt = d.mobile_push_cnt, 
            b.mob_sesn_cnt = d.mob_sesn_cnt, b.mob_impr_cnt = d.mob_impr_cnt, 
            b.linkedin_ads_cnt = d.linkedin_ads_cnt, b.email_send_cnt = d.email_send_cnt, 
            b.audience_usage_cnt = d.audience_usage_cnt, b.email_preview_cnt = d.email_preview_cnt, 
            b.dm_destinations_total_id_cnt = d.dm_destinations_total_id_cnt, b.mai_scored_project_cnt = d.mai_scored_project_cnt, 
            b.google_ads_cnt = d.google_ads_cnt, b.outbound_api_cnt = d.outbound_api_cnt, 
            b.sms_output_result_cnt = d.sms_output_result_cnt, b.web_sesn_cnt = d.web_sesn_cnt, 
            b.plan_users_cnt = d.plan_users_cnt, b.sms_send_cnt = d.sms_send_cnt, 
            b.dm_destinations_total_row_cnt = d.dm_destinations_total_row_cnt, b.db_size = d.db_size, 
            b.asset_size = d.asset_size, b.admin_user_cnt = d.admin_user_cnt, 
            b.sms_output_result_str = d.sms_output_result_str, b.sms_send_str = d.sms_send_str, 
            b.sms_frag_str = d.sms_frag_str
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DATA_VIEW_DETAILS_tmp as 
            select * from &dbschema..DATA_VIEW_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.data_view_dttm_tz = d.data_view_dttm_tz, b.data_view_dttm = d.data_view_dttm, 
            b.visit_id_hex = d.visit_id_hex, b.visit_id = d.visit_id, 
            b.session_id_hex = d.session_id_hex, b.session_id = d.session_id, 
            b.reserved_2_txt = d.reserved_2_txt, b.reserved_1_txt = d.reserved_1_txt, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_ADV_CAMPAIGN_VISITORS_tmp as 
            select * from &dbschema..DBT_ADV_CAMPAIGN_VISITORS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.rv_revenue = d.rv_revenue, b.ge_latitude = d.ge_latitude, 
            b.co_conversions = d.co_conversions, b.page_views = d.page_views, 
            b.average_visit_duration = d.average_visit_duration, b.visits = d.visits, 
            b.new_visitors = d.new_visitors, b.return_visitors = d.return_visitors, 
            b.bouncers = d.bouncers, b.session_start_dttm = d.session_start_dttm, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.visit_dttm_tz = d.visit_dttm_tz, 
            b.session_complete_load_dttm = d.session_complete_load_dttm, b.visit_dttm = d.visit_dttm, 
            ...
            b.visit_origination_creative = d.visit_origination_creative, b.se_external_search_engine_domain = d.se_external_search_engine_domain, 
            b.se_external_search_engine = d.se_external_search_engine, b.se_external_search_engine_phrase = d.se_external_search_engine_phrase, 
            b.pl_device_operating_system = d.pl_device_operating_system, b.visit_origination_placement = d.visit_origination_placement, 
            b.landing_page_url_domain = d.landing_page_url_domain, b.landing_page_url = d.landing_page_url, 
            b.visit_origination_type = d.visit_origination_type, b.landing_page = d.landing_page, 
            b.ge_state_region = d.ge_state_region, b.ge_country = d.ge_country, 
            b.ge_city = d.ge_city, b.device_type = d.device_type, 
            b.device_name = d.device_name, b.cu_customer_id = d.cu_customer_id, 
            b.br_browser_version = d.br_browser_version, b.br_browser_name = d.br_browser_name, 
            b.bouncer = d.bouncer
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..DBT_BUSINESS_PROCESS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_BUSINESS_PROCESS_tmp as 
            select * from &dbschema..DBT_BUSINESS_PROCESS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.processes_abandoned = d.processes_abandoned, 
            b.processes_completed = d.processes_completed, b.steps = d.steps, 
            b.steps_completed = d.steps_completed, b.steps_abandoned = d.steps_abandoned, 
            b.processes = d.processes, b.last_step = d.last_step, 
            b.step_count = d.step_count, b.bus_process_started_dttm_tz = d.bus_process_started_dttm_tz, 
            b.session_start_dttm = d.session_start_dttm, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.visitor_type = d.visitor_type, 
            b.visit_origination_type = d.visit_origination_type, b.visit_origination_placement = d.visit_origination_placement, 
            b.visit_origination_creative = d.visit_origination_creative, b.device_type = d.device_type, 
            b.cu_customer_id = d.cu_customer_id, b.business_process_attribute_2 = d.business_process_attribute_2, 
            b.business_process_attribute_1 = d.business_process_attribute_1, b.bouncer = d.bouncer, 
            b.device_name = d.device_name, b.visit_id = d.visit_id, 
            b.visit_origination_name = d.visit_origination_name, b.visit_origination_tracking_code = d.visit_origination_tracking_code, 
            b.visitor_id = d.visitor_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_CONTENT_tmp as 
            select * from &dbschema..DBT_CONTENT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.entry_pages = d.entry_pages, b.visits = d.visits, 
            b.views = d.views, b.active_page_view_time = d.active_page_view_time, 
            b.bouncers = d.bouncers, b.exit_pages = d.exit_pages, 
            b.session_start_dttm = d.session_start_dttm, b.detail_dttm = d.detail_dttm, 
            b.detail_dttm_tz = d.detail_dttm_tz, b.session_start_dttm_tz = d.session_start_dttm_tz, 
            b.session_complete_load_dttm = d.session_complete_load_dttm, b.visitor_type = d.visitor_type, 
            ...
            b.pg_domain_name = d.pg_domain_name, b.device_name = d.device_name, 
            b.cu_customer_id = d.cu_customer_id, b.class1_id = d.class1_id, 
            b.bouncer = d.bouncer, b.class2_id = d.class2_id, 
            b.device_type = d.device_type, b.visit_id = d.visit_id, 
            b.visit_origination_name = d.visit_origination_name
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_DOCUMENTS_tmp as 
            select * from &dbschema..DBT_DOCUMENTS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.document_download_dttm = d.document_download_dttm, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.document_download_dttm_tz = d.document_download_dttm_tz, b.session_start_dttm = d.session_start_dttm, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.visitor_type = d.visitor_type, 
            b.visitor_id = d.visitor_id, b.visit_origination_type = d.visit_origination_type, 
            b.visit_origination_tracking_code = d.visit_origination_tracking_code, b.visit_origination_name = d.visit_origination_name, 
            b.visit_id = d.visit_id, b.do_page_url = d.do_page_url, 
            b.device_type = d.device_type, b.class2_id = d.class2_id, 
            b.bouncer = d.bouncer, b.class1_id = d.class1_id, 
            b.cu_customer_id = d.cu_customer_id, b.device_name = d.device_name, 
            b.do_page_description = d.do_page_description, b.session_id = d.session_id, 
            b.visit_origination_creative = d.visit_origination_creative, b.visit_origination_placement = d.visit_origination_placement
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..DBT_ECOMMERCE)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_ECOMMERCE_tmp as 
            select * from &dbschema..DBT_ECOMMERCE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.basket_removes_revenue = d.basket_removes_revenue, 
            b.basket_adds_revenue = d.basket_adds_revenue, b.product_purchase_revenues = d.product_purchase_revenues, 
            b.basket_adds_units = d.basket_adds_units, b.basket_adds = d.basket_adds, 
            b.product_views = d.product_views, b.product_purchase_units = d.product_purchase_units, 
            b.basket_removes_units = d.basket_removes_units, b.product_purchases = d.product_purchases, 
            b.basket_removes = d.basket_removes, b.baskets_completed = d.baskets_completed, 
            b.baskets_abandoned = d.baskets_abandoned, b.baskets_started = d.baskets_started, 
            ...
            b.visitor_id = d.visitor_id, b.visit_origination_tracking_code = d.visit_origination_tracking_code, 
            b.visit_origination_name = d.visit_origination_name, b.product_group_name = d.product_group_name, 
            b.device_name = d.device_name, b.bouncer = d.bouncer, 
            b.cu_customer_id = d.cu_customer_id, b.device_type = d.device_type, 
            b.session_id = d.session_id, b.visit_origination_creative = d.visit_origination_creative, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_FORMS_tmp as 
            select * from &dbschema..DBT_FORMS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.forms_started = d.forms_started, b.forms_completed = d.forms_completed, 
            b.forms_not_submitted = d.forms_not_submitted, b.form_attempt_dttm = d.form_attempt_dttm, 
            b.session_complete_load_dttm = d.session_complete_load_dttm, b.form_attempt_dttm_tz = d.form_attempt_dttm_tz, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.session_start_dttm = d.session_start_dttm, 
            b.visitor_type = d.visitor_type, b.visit_origination_type = d.visit_origination_type, 
            b.visit_origination_placement = d.visit_origination_placement, b.visit_origination_creative = d.visit_origination_creative, 
            b.visit_id = d.visit_id, b.session_id = d.session_id, 
            b.last_field = d.last_field, b.form_nm = d.form_nm, 
            b.device_name = d.device_name, b.cu_customer_id = d.cu_customer_id, 
            b.bouncer = d.bouncer, b.device_type = d.device_type, 
            b.visit_origination_name = d.visit_origination_name, b.visit_origination_tracking_code = d.visit_origination_tracking_code, 
            b.visitor_id = d.visitor_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_GOALS_tmp as 
            select * from &dbschema..DBT_GOALS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.visits = d.visits, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.session_start_dttm = d.session_start_dttm, b.goal_reached_dttm_tz = d.goal_reached_dttm_tz, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.goal_reached_dttm = d.goal_reached_dttm, 
            b.goals = d.goals, b.visit_origination_tracking_code = d.visit_origination_tracking_code, 
            b.visit_id = d.visit_id, b.device_name = d.device_name, 
            b.cu_customer_id = d.cu_customer_id, b.goal_group_name = d.goal_group_name, 
            b.bouncer = d.bouncer, b.session_id = d.session_id, 
            b.visit_origination_name = d.visit_origination_name, b.visitor_id = d.visitor_id, 
            b.device_type = d.device_type, b.goal_name = d.goal_name, 
            b.visit_origination_creative = d.visit_origination_creative, b.visit_origination_placement = d.visit_origination_placement, 
            b.visit_origination_type = d.visit_origination_type, b.visitor_type = d.visitor_type
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_MEDIA_CONSUMPTION_tmp as 
            select * from &dbschema..DBT_MEDIA_CONSUMPTION where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.counter = d.counter, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.media_start_dttm = d.media_start_dttm, b.media_start_dttm_tz = d.media_start_dttm_tz, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.session_start_dttm = d.session_start_dttm, 
            b.media_section_view = d.media_section_view, b.views_completed = d.views_completed, 
            b.views = d.views, b.views_started = d.views_started, 
            b.visitor_id = d.visitor_id, b.visit_origination_name = d.visit_origination_name, 
            b.media_name = d.media_name, b.device_name = d.device_name, 
            b.cu_customer_id = d.cu_customer_id, b.visit_origination_placement = d.visit_origination_placement, 
            b.visit_origination_tracking_code = d.visit_origination_tracking_code, b.bouncer = d.bouncer, 
            b.device_type = d.device_type, b.media_uri_txt = d.media_uri_txt, 
            b.session_id = d.session_id, b.visit_origination_creative = d.visit_origination_creative, 
            b.visit_origination_type = d.visit_origination_type, b.visitor_type = d.visitor_type
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..DBT_PROMOTIONS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_PROMOTIONS_tmp as 
            select * from &dbschema..DBT_PROMOTIONS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.displays = d.displays, 
            b.click_throughs = d.click_throughs, b.promotion_shown_dttm = d.promotion_shown_dttm, 
            b.promotion_shown_dttm_tz = d.promotion_shown_dttm_tz, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.session_start_dttm_tz = d.session_start_dttm_tz, b.session_start_dttm = d.session_start_dttm, 
            b.visit_origination_tracking_code = d.visit_origination_tracking_code, b.visit_id = d.visit_id, 
            b.cu_customer_id = d.cu_customer_id, b.bouncer = d.bouncer, 
            b.device_name = d.device_name, b.promotion_creative = d.promotion_creative, 
            b.promotion_name = d.promotion_name, b.promotion_tracking_code = d.promotion_tracking_code, 
            b.visit_origination_name = d.visit_origination_name, b.visitor_id = d.visitor_id, 
            b.device_type = d.device_type, b.promotion_placement = d.promotion_placement, 
            b.promotion_type = d.promotion_type, b.session_id = d.session_id, 
            b.visit_origination_creative = d.visit_origination_creative, b.visit_origination_placement = d.visit_origination_placement, 
            b.visit_origination_type = d.visit_origination_type, b.visitor_type = d.visitor_type
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..DBT_SEARCH)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DBT_SEARCH_tmp as 
            select * from &dbschema..DBT_SEARCH where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.searches = d.searches, 
            b.visits = d.visits, b.search_unknown_results = d.search_unknown_results, 
            b.search_returned_results = d.search_returned_results, b.search_no_results_returned = d.search_no_results_returned, 
            b.num_pages_viewed_afterwards = d.num_pages_viewed_afterwards, b.num_additional_searches = d.num_additional_searches, 
            b.exit_pages = d.exit_pages, b.session_start_dttm_tz = d.session_start_dttm_tz, 
            b.search_results_dttm = d.search_results_dttm, b.session_complete_load_dttm = d.session_complete_load_dttm, 
            b.search_results_dttm_tz = d.search_results_dttm_tz, b.session_start_dttm = d.session_start_dttm, 
            b.visit_origination_tracking_code = d.visit_origination_tracking_code, b.visit_id = d.visit_id, 
            b.device_type = d.device_type, b.bouncer = d.bouncer, 
            b.cu_customer_id = d.cu_customer_id, b.internal_search_term = d.internal_search_term, 
            b.visit_origination_name = d.visit_origination_name, b.visit_origination_placement = d.visit_origination_placement, 
            b.visitor_id = d.visitor_id, b.device_name = d.device_name, 
            b.search_name = d.search_name, b.session_id = d.session_id, 
            b.visit_origination_creative = d.visit_origination_creative, b.visit_origination_type = d.visit_origination_type, 
            b.visitor_type = d.visitor_type
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..DECISION_EXECUTION)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         connect to &database. (&sql_passthru_connection.);
         execute( create  table &tmpdbschema..DECISION_EXECUTION_tmp as 
            select * from &dbschema..DECISION_EXECUTION where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         CONNECT TO &database. (&sql_passthru_connection.);
         EXECUTE (MERGE INTO &dbschema..DECISION_EXECUTION b USING &tmpdbschema..DECISION_EXECUTION_tmp d ON (
            b.execution_id = d.execution_id )
         WHEN MATCHED THEN
         UPDATE SET
            b.input_json = d.input_json, 
            b.output_json = d.output_json, b.execution_dttm = d.execution_dttm, 
            b.environment = d.environment, b.hostname = d.hostname, 
            b.decision_id = d.decision_id, b.event_nm = d.event_nm, 
...
%if %sysfunc(exist(&udmmart..DIRECT_CONTACT)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DIRECT_CONTACT_tmp as 
            select * from &dbschema..DIRECT_CONTACT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.control_group_flg = d.control_group_flg, 
            b.control_active_flg = d.control_active_flg, b.properties_map_doc = d.properties_map_doc, 
            b.direct_contact_dttm = d.direct_contact_dttm, b.direct_contact_dttm_tz = d.direct_contact_dttm_tz, 
            b.load_dttm = d.load_dttm, b.segment_id = d.segment_id, 
            b.message_id = d.message_id, b.event_nm = d.event_nm, 
            b.context_type_nm = d.context_type_nm, b.channel_nm = d.channel_nm, 
            b.event_designed_id = d.event_designed_id, b.identity_type_nm = d.identity_type_nm, 
            b.task_version_id = d.task_version_id, b.channel_user_id = d.channel_user_id, 
...
%if %sysfunc(exist(&udmmart..DOCUMENT_DETAILS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..DOCUMENT_DETAILS_tmp as 
            select * from &dbschema..DOCUMENT_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.link_event_dttm = d.link_event_dttm, 
            b.link_event_dttm_tz = d.link_event_dttm_tz, b.load_dttm = d.load_dttm, 
            b.visit_id_hex = d.visit_id_hex, b.session_id = d.session_id, 
            b.link_id = d.link_id, b.event_source_cd = d.event_source_cd, 
            b.detail_id = d.detail_id, b.identity_id = d.identity_id, 
            b.link_name = d.link_name, b.link_selector_path = d.link_selector_path, 
            b.uri_txt = d.uri_txt, b.alt_txt = d.alt_txt, 
            b.detail_id_hex = d.detail_id_hex, b.event_key_cd = d.event_key_cd, 
            b.session_id_hex = d.session_id_hex, b.visit_id = d.visit_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..EMAIL_BOUNCE)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_BOUNCE_tmp as 
            select * from &dbschema..EMAIL_BOUNCE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.email_bounce_dttm = d.email_bounce_dttm, 
            b.email_bounce_dttm_tz = d.email_bounce_dttm_tz, b.load_dttm = d.load_dttm, 
            ...
            b.journey_occurrence_id = d.journey_occurrence_id, b.event_nm = d.event_nm, 
            b.context_type_nm = d.context_type_nm, b.bounce_class_cd = d.bounce_class_cd, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.audience_id = d.audience_id, 
            b.context_val = d.context_val, b.event_designed_id = d.event_designed_id, 
            b.imprint_id = d.imprint_id, b.reason_txt = d.reason_txt, 
            b.recipient_domain_nm = d.recipient_domain_nm, b.segment_id = d.segment_id, 
            b.subject_line_txt = d.subject_line_txt, b.task_version_id = d.task_version_id, 
            b.analysis_group_id = d.analysis_group_id, b.channel_user_id = d.channel_user_id, 
            b.identity_id = d.identity_id, b.journey_id = d.journey_id, 
            b.program_id = d.program_id, b.raw_reason_txt = d.raw_reason_txt
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..EMAIL_CLICK)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_CLICK_tmp as 
            select * from &dbschema..EMAIL_CLICK where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.click_tracking_flg = d.click_tracking_flg, 
            b.is_mobile_flg = d.is_mobile_flg, b.open_tracking_flg = d.open_tracking_flg, 
            b.test_flg = d.test_flg, b.properties_map_doc = d.properties_map_doc, 
            b.email_click_dttm = d.email_click_dttm, b.email_click_dttm_tz = d.email_click_dttm_tz, 
            b.load_dttm = d.load_dttm, b.platform_desc = d.platform_desc, 
            b.occurrence_id = d.occurrence_id, b.mailbox_provider_nm = d.mailbox_provider_nm, 
            b.link_tracking_label_txt = d.link_tracking_label_txt, b.link_tracking_group_txt = d.link_tracking_group_txt, 
            ...
            b.link_tracking_id = d.link_tracking_id, b.manufacturer_nm = d.manufacturer_nm, 
            b.platform_version = d.platform_version, b.user_agent_nm = d.user_agent_nm, 
            b.uri_txt = d.uri_txt, b.task_version_id = d.task_version_id, 
            b.task_id = d.task_id, b.subject_line_txt = d.subject_line_txt, 
            b.segment_version_id = d.segment_version_id, b.segment_id = d.segment_id, 
            b.response_tracking_cd = d.response_tracking_cd, b.recipient_domain_nm = d.recipient_domain_nm, 
            b.program_id = d.program_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_COMPLAINT_tmp as 
            select * from &dbschema..EMAIL_COMPLAINT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.email_complaint_dttm_tz = d.email_complaint_dttm_tz, b.email_complaint_dttm = d.email_complaint_dttm, 
            ...
            b.analysis_group_id = d.analysis_group_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..EMAIL_OPEN)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_OPEN_tmp as 
            select * from &dbschema..EMAIL_OPEN where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.prefetched_flg = d.prefetched_flg, b.is_mobile_flg = d.is_mobile_flg, 
            b.click_tracking_flg = d.click_tracking_flg, b.open_tracking_flg = d.open_tracking_flg, 
            b.properties_map_doc = d.properties_map_doc, b.email_open_dttm_tz = d.email_open_dttm_tz, 
            b.load_dttm = d.load_dttm, b.email_open_dttm = d.email_open_dttm, 
            ...
            b.platform_desc = d.platform_desc, b.occurrence_id = d.occurrence_id, 
            b.manufacturer_nm = d.manufacturer_nm, b.mailbox_provider_nm = d.mailbox_provider_nm, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.journey_id = d.journey_id, 
            b.imprint_id = d.imprint_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.device_nm = d.device_nm, b.context_val = d.context_val, 
            b.context_type_nm = d.context_type_nm, b.channel_user_id = d.channel_user_id, 
            b.audience_id = d.audience_id, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.analysis_group_id = d.analysis_group_id, b.agent_family_nm = d.agent_family_nm
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_OPTOUT_tmp as 
            select * from &dbschema..EMAIL_OPTOUT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.email_optout_dttm_tz = d.email_optout_dttm_tz, b.email_optout_dttm = d.email_optout_dttm, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
            b.subject_line_txt = d.subject_line_txt, b.segment_version_id = d.segment_version_id, 
            b.segment_id = d.segment_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.recipient_domain_nm = d.recipient_domain_nm, b.program_id = d.program_id, 
            b.optout_type_nm = d.optout_type_nm, b.occurrence_id = d.occurrence_id, 
            b.link_tracking_label_txt = d.link_tracking_label_txt, b.link_tracking_id = d.link_tracking_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_OPTOUT_DETAILS_tmp as 
            select * from &dbschema..EMAIL_OPTOUT_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.imprint_id = d.imprint_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.email_address = d.email_address, b.context_val = d.context_val, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_REPLY_tmp as 
            select * from &dbschema..EMAIL_REPLY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.email_reply_dttm = d.email_reply_dttm, b.email_reply_dttm_tz = d.email_reply_dttm_tz, 
            b.uri_txt = d.uri_txt, b.task_version_id = d.task_version_id, 
            b.task_id = d.task_id, b.subject_line_txt = d.subject_line_txt, 
            b.segment_version_id = d.segment_version_id, b.segment_id = d.segment_id, 
            b.response_tracking_cd = d.response_tracking_cd, b.recipient_domain_nm = d.recipient_domain_nm, 
            b.program_id = d.program_id, b.occurrence_id = d.occurrence_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.journey_id = d.journey_id, 
            b.imprint_id = d.imprint_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm, 
...
%if %sysfunc(exist(&udmmart..EMAIL_SEND)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_SEND_tmp as 
            select * from &dbschema..EMAIL_SEND where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.email_send_dttm = d.email_send_dttm, 
            b.load_dttm = d.load_dttm, b.email_send_dttm_tz = d.email_send_dttm_tz, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
            b.subject_line_txt = d.subject_line_txt, b.segment_version_id = d.segment_version_id, 
            b.segment_id = d.segment_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.recipient_domain_nm = d.recipient_domain_nm, b.program_id = d.program_id, 
            b.occurrence_id = d.occurrence_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.journey_id = d.journey_id, b.imprint_url_txt = d.imprint_url_txt, 
            b.imprint_id = d.imprint_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.email_send_agent_name = d.email_send_agent_name, b.context_val = d.context_val, 
            b.context_type_nm = d.context_type_nm, b.channel_user_id = d.channel_user_id, 
            b.audience_id = d.audience_id, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.analysis_group_id = d.analysis_group_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EMAIL_VIEW_tmp as 
            select * from &dbschema..EMAIL_VIEW where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.test_flg = d.test_flg, 
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.email_view_dttm_tz = d.email_view_dttm_tz, b.email_view_dttm = d.email_view_dttm, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
            b.subject_line_txt = d.subject_line_txt, b.segment_version_id = d.segment_version_id, 
            b.segment_id = d.segment_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.recipient_domain_nm = d.recipient_domain_nm, b.program_id = d.program_id, 
...
%if %sysfunc(exist(&udmmart..EVENT_ERRORS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         connect to &database. (&sql_passthru_connection.);
         execute( create  table &tmpdbschema..EVENT_ERRORS_tmp as 
            select * from &dbschema..EVENT_ERRORS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         CONNECT TO &database. (&sql_passthru_connection.);
         EXECUTE (MERGE INTO &dbschema..EVENT_ERRORS b USING &tmpdbschema..EVENT_ERRORS_tmp d ON (
            b.event_id = d.event_id )
         WHEN MATCHED THEN
         UPDATE SET
            b.error_dttm_tz = d.error_dttm_tz, 
            b.error_dttm = d.error_dttm, b.payload_txt = d.payload_txt, 
            b.ip_address = d.ip_address, b.event_source_cd = d.event_source_cd, 
            b.error_txt = d.error_txt, b.error_cd = d.error_cd
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..EXTERNAL_EVENT_tmp as 
            select * from &dbschema..EXTERNAL_EVENT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..FORM_DETAILS_tmp as 
            select * from &dbschema..FORM_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.form_field_detail_dttm = d.form_field_detail_dttm, b.form_field_detail_dttm_tz = d.form_field_detail_dttm_tz, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.session_id = d.session_id, b.identity_id = d.identity_id, 
            b.form_nm = d.form_nm, b.form_field_value = d.form_field_value, 
            b.form_field_id = d.form_field_id, b.event_key_cd = d.event_key_cd, 
            b.detail_id_hex = d.detail_id_hex, b.detail_id = d.detail_id, 
            b.attempt_status_cd = d.attempt_status_cd, b.event_source_cd = d.event_source_cd, 
            b.form_field_nm = d.form_field_nm, b.session_id_hex = d.session_id_hex, 
...
%if %sysfunc(exist(&udmmart..IDENTITY_ADDRESSABLE_DEVICES)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         connect to &database. (&sql_passthru_connection.);
         execute( create  table &tmpdbschema..IDENTITY_ADDRESSABLE_DEVICES_tmp as 
            select * from &dbschema..IDENTITY_ADDRESSABLE_DEVICES where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IDENTITY_ATTRIBUTES_tmp as 
            select * from &dbschema..IDENTITY_ATTRIBUTES where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
...
%if %sysfunc(exist(&udmmart..IDENTITY_MAP)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IDENTITY_MAP_tmp as 
            select * from &dbschema..IDENTITY_MAP where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.entrytime = d.entrytime, 
            b.processed_dttm = d.processed_dttm, b.target_identity_id = d.target_identity_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IMPRESSION_DELIVERED_tmp as 
            select * from &dbschema..IMPRESSION_DELIVERED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.task_id = d.task_id, b.spot_id = d.spot_id, 
            b.segment_version_id = d.segment_version_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.reserved_1_txt = d.reserved_1_txt, b.rec_group_id = d.rec_group_id, 
            b.product_sku_no = d.product_sku_no, b.product_nm = d.product_nm, 
            b.mobile_app_id = d.mobile_app_id, b.message_version_id = d.message_version_id, 
            b.message_id = d.message_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.journey_id = d.journey_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            ...
            b.creative_version_id = d.creative_version_id, b.event_key_cd = d.event_key_cd, 
            b.event_source_cd = d.event_source_cd, b.product_id = d.product_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IMPRESSION_SPOT_VIEWABLE_tmp as 
            select * from &dbschema..IMPRESSION_SPOT_VIEWABLE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.control_group_flg = d.control_group_flg, 
            b.product_qty_no = d.product_qty_no, b.properties_map_doc = d.properties_map_doc, 
            b.impression_viewable_dttm_tz = d.impression_viewable_dttm_tz, b.impression_viewable_dttm = d.impression_viewable_dttm, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
            b.session_id_hex = d.session_id_hex, b.segment_id = d.segment_id, 
            b.reserved_2_txt = d.reserved_2_txt, b.request_id = d.request_id, 
            b.rec_group_id = d.rec_group_id, b.product_id = d.product_id, 
            b.mobile_app_id = d.mobile_app_id, b.message_id = d.message_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.detail_id_hex = d.detail_id_hex, 
            b.creative_id = d.creative_id, b.context_val = d.context_val, 
            b.channel_user_id = d.channel_user_id, b.audience_id = d.audience_id, 
            ...
            b.occurrence_id = d.occurrence_id, b.product_nm = d.product_nm, 
...
%if %sysfunc(exist(&udmmart..IN_APP_FAILED)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IN_APP_FAILED_tmp as 
            select * from &dbschema..IN_APP_FAILED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.load_dttm = d.load_dttm, b.in_app_failed_dttm_tz = d.in_app_failed_dttm_tz, 
            b.in_app_failed_dttm = d.in_app_failed_dttm, b.task_version_id = d.task_version_id, 
            b.spot_id = d.spot_id, b.segment_version_id = d.segment_version_id, 
            b.segment_id = d.segment_id, b.reserved_2_txt = d.reserved_2_txt, 
            b.occurrence_id = d.occurrence_id, b.mobile_app_id = d.mobile_app_id, 
            b.message_id = d.message_id, b.identity_id = d.identity_id, 
            b.error_message_txt = d.error_message_txt, b.error_cd = d.error_cd, 
            b.creative_version_id = d.creative_version_id, b.context_val = d.context_val, 
            b.channel_user_id = d.channel_user_id, b.channel_nm = d.channel_nm, 
            ...
            b.message_version_id = d.message_version_id, b.reserved_1_txt = d.reserved_1_txt, 
...
%if %sysfunc(exist(&udmmart..IN_APP_MESSAGE)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IN_APP_MESSAGE_tmp as 
            select * from &dbschema..IN_APP_MESSAGE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.in_app_action_dttm = d.in_app_action_dttm, b.in_app_action_dttm_tz = d.in_app_action_dttm_tz, 
            b.load_dttm = d.load_dttm, b.task_id = d.task_id, 
            b.segment_version_id = d.segment_version_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.reserved_2_txt = d.reserved_2_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.occurrence_id = d.occurrence_id, b.mobile_app_id = d.mobile_app_id, 
            b.message_version_id = d.message_version_id, b.message_id = d.message_id, 
            ...
            b.event_nm = d.event_nm, b.reserved_3_txt = d.reserved_3_txt, 
...
%if %sysfunc(exist(&udmmart..IN_APP_SEND)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IN_APP_SEND_tmp as 
            select * from &dbschema..IN_APP_SEND where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.in_app_send_dttm_tz = d.in_app_send_dttm_tz, b.load_dttm = d.load_dttm, 
            ...
            b.context_val = d.context_val, b.segment_id = d.segment_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..IN_APP_TARGETING_REQUEST_tmp as 
            select * from &dbschema..IN_APP_TARGETING_REQUEST where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.in_app_tgt_request_dttm_tz = d.in_app_tgt_request_dttm_tz, b.in_app_tgt_request_dttm = d.in_app_tgt_request_dttm, 
            b.load_dttm = d.load_dttm, b.mobile_app_id = d.mobile_app_id, 
...
%if %sysfunc(exist(&udmmart..JOURNEY_ENTRY)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_ENTRY_tmp as 
            select * from &dbschema..JOURNEY_ENTRY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.load_dttm = d.load_dttm, 
            b.entry_dttm = d.entry_dttm, b.entry_dttm_tz = d.entry_dttm_tz, 
            b.identity_type_val = d.identity_type_val, b.context_type_nm = d.context_type_nm, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.context_val = d.context_val, 
            b.identity_id = d.identity_id, b.identity_type_nm = d.identity_type_nm, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.audience_id = d.audience_id, 
...
%if %sysfunc(exist(&udmmart..JOURNEY_EXIT)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_EXIT_tmp as 
            select * from &dbschema..JOURNEY_EXIT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.exit_dttm_tz = d.exit_dttm_tz, 
            b.load_dttm = d.load_dttm, b.exit_dttm = d.exit_dttm, 
            b.last_node_id = d.last_node_id, b.identity_type_nm = d.identity_type_nm, 
            b.drop_aud_occurrence_id = d.drop_aud_occurrence_id, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.context_type_nm = d.context_type_nm, b.drop_audience_id = d.drop_audience_id, 
            b.event_nm = d.event_nm, b.group_id = d.group_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_HOLDOUT_tmp as 
            select * from &dbschema..JOURNEY_HOLDOUT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.holdout_dttm = d.holdout_dttm, b.load_dttm = d.load_dttm, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.identity_id = d.identity_id, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.context_type_nm = d.context_type_nm, 
            b.identity_type_val = d.identity_type_val, b.audience_id = d.audience_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_NODE_ENTRY_tmp as 
            select * from &dbschema..JOURNEY_NODE_ENTRY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.node_entry_dttm_tz = d.node_entry_dttm_tz, b.load_dttm = d.load_dttm, 
            ...
            b.context_val = d.context_val, b.identity_type_nm = d.identity_type_nm, 
            b.node_type_nm = d.node_type_nm, b.audience_id = d.audience_id, 
            ...
            b.node_id = d.node_id, b.previous_node_id = d.previous_node_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_SUCCESS_tmp as 
            select * from &dbschema..JOURNEY_SUCCESS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.identity_type_nm = d.identity_type_nm, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.context_type_nm = d.context_type_nm, b.group_id = d.group_id, 
            b.journey_id = d.journey_id, b.success_aud_occurrence_id = d.success_aud_occurrence_id, 
            b.audience_id = d.audience_id, b.context_val = d.context_val, 
            b.event_nm = d.event_nm, b.identity_id = d.identity_id, 
            b.identity_type_val = d.identity_type_val, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.parent_event_designed_id = d.parent_event_designed_id, b.success_audience_id = d.success_audience_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..JOURNEY_SUPPRESSION)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_SUPPRESSION_tmp as 
            select * from &dbschema..JOURNEY_SUPPRESSION where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.suppression_dttm_tz = d.suppression_dttm_tz, 
            b.load_dttm = d.load_dttm, b.suppression_dttm = d.suppression_dttm, 
            b.reason_txt = d.reason_txt, b.reason_cd = d.reason_cd, 
            b.identity_type_val = d.identity_type_val, b.aud_occurrence_id = d.aud_occurrence_id, 
...
%if %sysfunc(exist(&udmmart..JOURNEY_TEST_SUCCESS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..JOURNEY_TEST_SUCCESS_tmp as 
            select * from &dbschema..JOURNEY_TEST_SUCCESS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.success_dttm = d.success_dttm, 
            b.success_dttm_tz = d.success_dttm_tz, b.parent_event_designed_id = d.parent_event_designed_id, 
            b.identity_id = d.identity_id, b.group_id = d.group_id, 
            b.context_type_nm = d.context_type_nm, b.event_nm = d.event_nm, 
            b.journey_id = d.journey_id, b.success_audience_id = d.success_audience_id, 
            b.context_val = d.context_val, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.success_aud_occurrence_id = d.success_aud_occurrence_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..MEDIA_ACTIVITY_DETAILS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MEDIA_ACTIVITY_DETAILS_tmp as 
            select * from &dbschema..MEDIA_ACTIVITY_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.load_dttm = d.load_dttm, 
            b.action_dttm_tz = d.action_dttm_tz, b.action_dttm = d.action_dttm, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MEDIA_DETAILS_tmp as 
            select * from &dbschema..MEDIA_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.play_start_dttm_tz = d.play_start_dttm_tz, b.play_start_dttm = d.play_start_dttm, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.session_id_hex = d.session_id_hex, b.session_id = d.session_id, 
            b.media_uri_txt = d.media_uri_txt, b.media_player_nm = d.media_player_nm, 
            b.media_nm = d.media_nm, b.identity_id = d.identity_id, 
            b.event_key_cd = d.event_key_cd, b.detail_id_hex = d.detail_id_hex, 
            b.detail_id = d.detail_id, b.event_source_cd = d.event_source_cd, 
            b.media_player_version_txt = d.media_player_version_txt, b.visit_id = d.visit_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..MEDIA_DETAILS_EXT)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MEDIA_DETAILS_EXT_tmp as 
            select * from &dbschema..MEDIA_DETAILS_EXT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.exit_point_secs = d.exit_point_secs, 
            b.max_play_secs = d.max_play_secs, b.view_duration_secs = d.view_duration_secs, 
            b.end_tm = d.end_tm, b.media_display_duration_secs = d.media_display_duration_secs, 
            b.start_tm = d.start_tm, b.interaction_cnt = d.interaction_cnt, 
            b.play_end_dttm_tz = d.play_end_dttm_tz, b.play_end_dttm = d.play_end_dttm, 
            b.load_dttm = d.load_dttm, b.media_nm = d.media_nm, 
            b.detail_id_hex = d.detail_id_hex, b.detail_id = d.detail_id, 
            b.media_uri_txt = d.media_uri_txt
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MOBILE_FOCUS_DEFOCUS_tmp as 
            select * from &dbschema..MOBILE_FOCUS_DEFOCUS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.load_dttm = d.load_dttm, b.action_dttm_tz = d.action_dttm_tz, 
            b.visit_id_hex = d.visit_id_hex, b.reserved_1_txt = d.reserved_1_txt, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MOBILE_SPOTS_tmp as 
            select * from &dbschema..MOBILE_SPOTS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm, 
            b.channel_user_id = d.channel_user_id, b.detail_id_hex = d.detail_id_hex, 
            b.identity_id = d.identity_id, b.spot_id = d.spot_id
         WHEN NOT MATCHED THEN INSERT (
            load_dttm, action_dttm_tz, action_dttm, 
...
%if %sysfunc(exist(&udmmart..MONTHLY_USAGE)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..MONTHLY_USAGE_tmp as 
            select * from &dbschema..MONTHLY_USAGE where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.advertising_members_cnt_str = d.advertising_members_cnt_str, 
            b.api_usage_str = d.api_usage_str, b.customer_profiles_processed_str = d.customer_profiles_processed_str, 
            b.bc_subjcnt_str = d.bc_subjcnt_str, b.mobile_push_cnt = d.mobile_push_cnt, 
            b.sms_frag_cnt = d.sms_frag_cnt, b.google_ads_cnt = d.google_ads_cnt, 
            b.dm_destinations_total_id_cnt = d.dm_destinations_total_id_cnt, b.mai_scored_project_cnt = d.mai_scored_project_cnt, 
            b.linkedin_ads_cnt = d.linkedin_ads_cnt, b.mobile_in_app_msg_cnt = d.mobile_in_app_msg_cnt, 
            b.plan_users_cnt = d.plan_users_cnt, b.sms_output_result_cnt = d.sms_output_result_cnt, 
            b.web_impr_cnt = d.web_impr_cnt, b.mob_impr_cnt = d.mob_impr_cnt, 
            b.mob_sesn_cnt = d.mob_sesn_cnt, b.email_send_cnt = d.email_send_cnt, 
            b.facebook_ads_cnt = d.facebook_ads_cnt, b.outbound_api_cnt = d.outbound_api_cnt, 
            b.web_sesn_cnt = d.web_sesn_cnt, b.sms_send_cnt = d.sms_send_cnt, 
            b.email_preview_cnt = d.email_preview_cnt, b.dm_destinations_total_row_cnt = d.dm_destinations_total_row_cnt, 
            b.audience_usage_cnt = d.audience_usage_cnt, b.asset_size = d.asset_size, 
            b.db_size = d.db_size, b.admin_user_cnt = d.admin_user_cnt, 
            b.sms_send_str = d.sms_send_str, b.sms_frag_str = d.sms_frag_str, 
            b.sms_output_result_str = d.sms_output_result_str
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..NOTIFICATION_FAILED_tmp as 
            select * from &dbschema..NOTIFICATION_FAILED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.journey_id = d.journey_id, b.identity_id = d.identity_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            b.error_cd = d.error_cd, b.creative_id = d.creative_id, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm, 
            b.channel_nm = d.channel_nm, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.audience_id = d.audience_id, b.channel_user_id = d.channel_user_id, 
            b.creative_version_id = d.creative_version_id, b.error_message_txt = d.error_message_txt, 
...
%if %sysfunc(exist(&udmmart..NOTIFICATION_OPENED)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..NOTIFICATION_OPENED_tmp as 
            select * from &dbschema..NOTIFICATION_OPENED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.notification_opened_dttm = d.notification_opened_dttm, b.load_dttm = d.load_dttm, 
            b.notification_opened_dttm_tz = d.notification_opened_dttm_tz, b.task_version_id = d.task_version_id, 
            b.spot_id = d.spot_id, b.segment_id = d.segment_id, 
            b.reserved_3_txt = d.reserved_3_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.occurrence_id = d.occurrence_id, b.mobile_app_id = d.mobile_app_id, 
            b.message_version_id = d.message_version_id, b.message_id = d.message_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.journey_id = d.journey_id, 
            b.event_nm = d.event_nm, b.event_designed_id = d.event_designed_id, 
            ...
            b.identity_id = d.identity_id, b.reserved_2_txt = d.reserved_2_txt, 
            b.response_tracking_cd = d.response_tracking_cd, b.segment_version_id = d.segment_version_id, 
            b.task_id = d.task_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..NOTIFICATION_SEND)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..NOTIFICATION_SEND_tmp as 
            select * from &dbschema..NOTIFICATION_SEND where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.notification_send_dttm = d.notification_send_dttm, b.load_dttm = d.load_dttm, 
            b.notification_send_dttm_tz = d.notification_send_dttm_tz, b.task_version_id = d.task_version_id, 
            b.spot_id = d.spot_id, b.segment_id = d.segment_id, 
            b.reserved_2_txt = d.reserved_2_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.occurrence_id = d.occurrence_id, b.mobile_app_id = d.mobile_app_id, 
            b.message_id = d.message_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            ...
            b.event_nm = d.event_nm, b.journey_id = d.journey_id, 
            b.message_version_id = d.message_version_id, b.response_tracking_cd = d.response_tracking_cd, 
...
%if %sysfunc(exist(&udmmart..NOTIFICATION_TARGETING_REQUEST)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..NOTIFICATION_TARGETING_REQUE_tmp as 
            select * from &dbschema..NOTIFICATION_TARGETING_REQUEST where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.eligibility_flg = d.eligibility_flg, 
            b.notification_tgt_req_dttm = d.notification_tgt_req_dttm, b.notification_tgt_req_dttm_tz = d.notification_tgt_req_dttm_tz, 
            b.load_dttm = d.load_dttm, b.task_id = d.task_id, 
            b.mobile_app_id = d.mobile_app_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.journey_id = d.journey_id, b.event_nm = d.event_nm, 
            b.event_designed_id = d.event_designed_id, b.context_val = d.context_val, 
            b.context_type_nm = d.context_type_nm, b.channel_user_id = d.channel_user_id, 
            b.audience_id = d.audience_id, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.channel_nm = d.channel_nm, b.identity_id = d.identity_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ORDER_DETAILS_tmp as 
            select * from &dbschema..ORDER_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.shipping_message_txt = d.shipping_message_txt, b.session_id = d.session_id, 
            b.saving_message_txt = d.saving_message_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.record_type = d.record_type, b.product_sku = d.product_sku, 
            b.product_id = d.product_id, b.order_id = d.order_id, 
            b.mobile_app_id = d.mobile_app_id, b.identity_id = d.identity_id, 
            b.event_source_cd = d.event_source_cd, b.event_key_cd = d.event_key_cd, 
            b.event_designed_id = d.event_designed_id, b.detail_id = d.detail_id, 
            b.currency_cd = d.currency_cd, b.channel_nm = d.channel_nm, 
            b.cart_id = d.cart_id, b.availability_message_txt = d.availability_message_txt, 
            b.cart_nm = d.cart_nm, b.detail_id_hex = d.detail_id_hex, 
            b.event_nm = d.event_nm, b.product_group_nm = d.product_group_nm, 
            b.product_nm = d.product_nm, b.session_id_hex = d.session_id_hex, 
            b.visit_id_hex = d.visit_id_hex
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..ORDER_SUMMARY)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..ORDER_SUMMARY_tmp as 
            select * from &dbschema..ORDER_SUMMARY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.shipping_amt = d.shipping_amt, 
            b.total_tax_amt = d.total_tax_amt, b.total_price_amt = d.total_price_amt, 
            b.total_unit_qty = d.total_unit_qty, b.properties_map_doc = d.properties_map_doc, 
            b.activity_dttm = d.activity_dttm, b.activity_dttm_tz = d.activity_dttm_tz, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.visit_id = d.visit_id, b.shipping_postal_cd = d.shipping_postal_cd, 
            b.shipping_country_nm = d.shipping_country_nm, b.shipping_city_nm = d.shipping_city_nm, 
            b.session_id_hex = d.session_id_hex, b.record_type = d.record_type, 
            b.payment_type_desc = d.payment_type_desc, b.order_id = d.order_id, 
            b.mobile_app_id = d.mobile_app_id, b.identity_id = d.identity_id, 
            b.event_source_cd = d.event_source_cd, b.event_nm = d.event_nm, 
            b.event_designed_id = d.event_designed_id, b.detail_id_hex = d.detail_id_hex, 
            b.delivery_type_desc = d.delivery_type_desc, b.currency_cd = d.currency_cd, 
            b.channel_nm = d.channel_nm, b.cart_nm = d.cart_nm, 
            b.cart_id = d.cart_id, b.billing_state_region_cd = d.billing_state_region_cd, 
            b.billing_postal_cd = d.billing_postal_cd, b.billing_city_nm = d.billing_city_nm, 
            b.billing_country_nm = d.billing_country_nm, b.detail_id = d.detail_id, 
            b.event_key_cd = d.event_key_cd, b.session_id = d.session_id, 
...
%if %sysfunc(exist(&udmmart..OUTBOUND_SYSTEM)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..OUTBOUND_SYSTEM_tmp as 
            select * from &dbschema..OUTBOUND_SYSTEM where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.load_dttm = d.load_dttm, b.outbound_system_dttm_tz = d.outbound_system_dttm_tz, 
            b.outbound_system_dttm = d.outbound_system_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.task_id = d.task_id, b.session_id_hex = d.session_id_hex, 
            b.segment_version_id = d.segment_version_id, b.segment_id = d.segment_id, 
            b.reserved_2_txt = d.reserved_2_txt, b.reserved_1_txt = d.reserved_1_txt, 
            b.parent_event_id = d.parent_event_id, b.occurrence_id = d.occurrence_id, 
            b.mobile_app_id = d.mobile_app_id, b.message_version_id = d.message_version_id, 
            b.message_id = d.message_id, b.journey_id = d.journey_id, 
            b.identity_id = d.identity_id, b.event_nm = d.event_nm, 
            b.event_designed_id = d.event_designed_id, b.detail_id_hex = d.detail_id_hex, 
            b.creative_version_id = d.creative_version_id, b.context_val = d.context_val, 
            b.channel_user_id = d.channel_user_id, b.audience_id = d.audience_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PAGE_DETAILS_tmp as 
            select * from &dbschema..PAGE_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.detail_dttm = d.detail_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.session_id_hex = d.session_id_hex, b.session_id = d.session_id, 
            b.protocol_nm = d.protocol_nm, b.page_desc = d.page_desc, 
            b.event_source_cd = d.event_source_cd, b.domain_nm = d.domain_nm, 
            b.event_key_cd = d.event_key_cd, b.mobile_app_id = d.mobile_app_id, 
            b.page_url_txt = d.page_url_txt, b.url_domain = d.url_domain, 
            b.window_size_txt = d.window_size_txt, b.detail_id = d.detail_id, 
            b.class8_id = d.class8_id, b.class7_id = d.class7_id, 
            b.class6_id = d.class6_id, b.class4_id = d.class4_id, 
            b.class2_id = d.class2_id, b.class15_id = d.class15_id, 
            b.class13_id = d.class13_id, b.class11_id = d.class11_id, 
            b.channel_nm = d.channel_nm, b.class10_id = d.class10_id, 
            b.class12_id = d.class12_id, b.class14_id = d.class14_id, 
            b.class1_id = d.class1_id, b.class3_id = d.class3_id, 
            b.class5_id = d.class5_id, b.class9_id = d.class9_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PAGE_DETAILS_EXT_tmp as 
            select * from &dbschema..PAGE_DETAILS_EXT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.seconds_spent_on_page_cnt = d.seconds_spent_on_page_cnt, b.session_id_hex = d.session_id_hex, 
            b.detail_id_hex = d.detail_id_hex
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..PAGE_ERRORS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PAGE_ERRORS_tmp as 
            select * from &dbschema..PAGE_ERRORS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.in_page_error_dttm_tz = d.in_page_error_dttm_tz, 
            b.load_dttm = d.load_dttm, b.in_page_error_dttm = d.in_page_error_dttm, 
            b.visit_id_hex = d.visit_id_hex, b.visit_id = d.visit_id, 
            b.session_id_hex = d.session_id_hex, b.in_page_error_txt = d.in_page_error_txt, 
            b.event_source_cd = d.event_source_cd, b.detail_id_hex = d.detail_id_hex, 
            b.identity_id = d.identity_id, b.session_id = d.session_id, 
            b.detail_id = d.detail_id, b.error_location_txt = d.error_location_txt
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PRODUCT_VIEWS_tmp as 
            select * from &dbschema..PRODUCT_VIEWS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.properties_map_doc = d.properties_map_doc, b.action_dttm = d.action_dttm, 
            b.load_dttm = d.load_dttm, b.action_dttm_tz = d.action_dttm_tz, 
            b.session_id_hex = d.session_id_hex, b.product_sku = d.product_sku, 
            b.product_group_nm = d.product_group_nm, b.event_source_cd = d.event_source_cd, 
            b.event_designed_id = d.event_designed_id, b.channel_nm = d.channel_nm, 
            b.availability_message_txt = d.availability_message_txt, b.currency_cd = d.currency_cd, 
            b.detail_id = d.detail_id, b.event_key_cd = d.event_key_cd, 
            b.identity_id = d.identity_id, b.mobile_app_id = d.mobile_app_id, 
            b.product_id = d.product_id, b.saving_message_txt = d.saving_message_txt, 
            b.visit_id = d.visit_id, b.detail_id_hex = d.detail_id_hex, 
            b.event_nm = d.event_nm, b.product_nm = d.product_nm, 
            b.session_id = d.session_id, b.shipping_message_txt = d.shipping_message_txt, 
            b.visit_id_hex = d.visit_id_hex
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PROMOTION_DISPLAYED_tmp as 
            select * from &dbschema..PROMOTION_DISPLAYED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.display_dttm = d.display_dttm, b.load_dttm = d.load_dttm, 
            b.display_dttm_tz = d.display_dttm_tz, b.visit_id_hex = d.visit_id_hex, 
            b.session_id = d.session_id, b.promotion_placement_nm = d.promotion_placement_nm, 
            b.mobile_app_id = d.mobile_app_id, b.event_nm = d.event_nm, 
            b.event_key_cd = d.event_key_cd, b.event_designed_id = d.event_designed_id, 
            b.channel_nm = d.channel_nm, b.detail_id = d.detail_id, 
            b.event_source_cd = d.event_source_cd, b.promotion_creative_nm = d.promotion_creative_nm, 
            b.promotion_tracking_cd = d.promotion_tracking_cd, b.session_id_hex = d.session_id_hex, 
            b.detail_id_hex = d.detail_id_hex, b.identity_id = d.identity_id, 
            b.promotion_nm = d.promotion_nm, b.promotion_type_nm = d.promotion_type_nm, 
            b.visit_id = d.visit_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..PROMOTION_USED_tmp as 
            select * from &dbschema..PROMOTION_USED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.properties_map_doc = d.properties_map_doc, b.load_dttm = d.load_dttm, 
            b.click_dttm_tz = d.click_dttm_tz, b.click_dttm = d.click_dttm, 
            b.visit_id_hex = d.visit_id_hex, b.session_id = d.session_id, 
            b.promotion_placement_nm = d.promotion_placement_nm, b.mobile_app_id = d.mobile_app_id, 
            b.event_key_cd = d.event_key_cd, b.detail_id = d.detail_id, 
            b.channel_nm = d.channel_nm, b.event_designed_id = d.event_designed_id, 
            b.event_source_cd = d.event_source_cd, b.promotion_creative_nm = d.promotion_creative_nm, 
            b.promotion_tracking_cd = d.promotion_tracking_cd, b.session_id_hex = d.session_id_hex, 
            b.detail_id_hex = d.detail_id_hex, b.event_nm = d.event_nm, 
            b.identity_id = d.identity_id, b.promotion_nm = d.promotion_nm, 
...
%if %sysfunc(exist(&udmmart..RESPONSE_HISTORY)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..RESPONSE_HISTORY_tmp as 
            select * from &dbschema..RESPONSE_HISTORY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.response_dttm = d.response_dttm, b.response_dttm_tz = d.response_dttm_tz, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.task_version_id = d.task_version_id, b.response_nm = d.response_nm, 
            b.response_channel_nm = d.response_channel_nm, b.message_id = d.message_id, 
            b.identity_id = d.identity_id, b.context_val = d.context_val, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.audience_id = d.audience_id, 
            b.detail_id_hex = d.detail_id_hex, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.parent_event_designed_id = d.parent_event_designed_id, b.session_id_hex = d.session_id_hex, 
            b.context_type_nm = d.context_type_nm, b.creative_id = d.creative_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SEARCH_RESULTS_tmp as 
            select * from &dbschema..SEARCH_RESULTS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.search_results_dttm = d.search_results_dttm, b.search_results_dttm_tz = d.search_results_dttm_tz, 
            b.load_dttm = d.load_dttm, b.srch_phrase = d.srch_phrase, 
            b.session_id_hex = d.session_id_hex, b.session_id = d.session_id, 
            b.search_results_sk = d.search_results_sk, b.mobile_app_id = d.mobile_app_id, 
            b.event_source_cd = d.event_source_cd, b.event_nm = d.event_nm, 
            b.detail_id_hex = d.detail_id_hex, b.channel_nm = d.channel_nm, 
            b.identity_id = d.identity_id, b.search_nm = d.search_nm, 
            b.srch_field_id = d.srch_field_id, b.visit_id_hex = d.visit_id_hex, 
            b.detail_id = d.detail_id, b.event_designed_id = d.event_designed_id, 
            b.event_key_cd = d.event_key_cd, b.srch_field_name = d.srch_field_name, 
            b.visit_id = d.visit_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SEARCH_RESULTS_EXT_tmp as 
            select * from &dbschema..SEARCH_RESULTS_EXT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
...
%if %sysfunc(exist(&udmmart..SEGMENT_MEMBERSHIP)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         connect to &database. (&sql_passthru_connection.);
         execute( create  table &tmpdbschema..SEGMENT_MEMBERSHIP_tmp as 
            select * from &dbschema..SEGMENT_MEMBERSHIP where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         CONNECT TO &database. (&sql_passthru_connection.);
         EXECUTE (MERGE INTO &dbschema..SEGMENT_MEMBERSHIP b USING &tmpdbschema..SEGMENT_MEMBERSHIP_tmp d ON (
         ...
         UPDATE SET
            b.processed_dttm = d.processed_dttm, 
            b.processed_dttm_tz = d.processed_dttm_tz, b.segment_id = d.segment_id, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..SESSION_DETAILS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SESSION_DETAILS_tmp as 
            select * from &dbschema..SESSION_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.java_script_enabled_flg = d.java_script_enabled_flg, 
            b.flash_enabled_flg = d.flash_enabled_flg, b.java_enabled_flg = d.java_enabled_flg, 
            b.is_portable_flag = d.is_portable_flag, b.cookies_enabled_flg = d.cookies_enabled_flg, 
            b.session_dt = d.session_dt, b.session_dt_tz = d.session_dt_tz, 
            b.longitude = d.longitude, b.latitude = d.latitude, 
            b.metro_cd = d.metro_cd, b.session_timeout = d.session_timeout, 
            b.screen_color_depth_no = d.screen_color_depth_no, b.client_session_start_dttm_tz = d.client_session_start_dttm_tz, 
            b.client_session_start_dttm = d.client_session_start_dttm, b.load_dttm = d.load_dttm, 
            b.session_start_dttm = d.session_start_dttm, b.session_start_dttm_tz = d.session_start_dttm_tz, 
            b.visitor_id = d.visitor_id, b.state_region_cd = d.state_region_cd, 
            b.session_id = d.session_id, b.screen_size_txt = d.screen_size_txt, 
            b.profile_nm4 = d.profile_nm4, b.profile_nm1 = d.profile_nm1, 
            b.previous_session_id_hex = d.previous_session_id_hex, b.platform_type_nm = d.platform_type_nm, 
            b.new_visitor_flg = d.new_visitor_flg, b.manufacturer = d.manufacturer, 
            b.java_version_no = d.java_version_no, b.ip_address = d.ip_address, 
            b.eventsource_cd = d.eventsource_cd, b.device_language = d.device_language, 
            b.country_cd = d.country_cd, b.carrier_name = d.carrier_name, 
            b.app_id = d.app_id, b.browser_nm = d.browser_nm, 
            b.city_nm = d.city_nm, b.device_nm = d.device_nm, 
            b.device_type_nm = d.device_type_nm, b.flash_version_no = d.flash_version_no, 
            b.mobile_country_code = d.mobile_country_code, b.parent_event_id = d.parent_event_id, 
            b.postal_cd = d.postal_cd, b.profile_nm2 = d.profile_nm2, 
            b.region_nm = d.region_nm, b.user_agent_nm = d.user_agent_nm, 
            b.app_version = d.app_version, b.browser_version_no = d.browser_version_no, 
            b.channel_nm = d.channel_nm, b.country_nm = d.country_nm, 
            b.identity_id = d.identity_id, b.network_code = d.network_code, 
            b.organization_nm = d.organization_nm, b.platform_desc = d.platform_desc, 
            b.platform_version = d.platform_version, b.previous_session_id = d.previous_session_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SESSION_DETAILS_EXT_tmp as 
            select * from &dbschema..SESSION_DETAILS_EXT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.seconds_spent_in_session_cnt = d.seconds_spent_in_session_cnt, b.last_session_activity_dttm = d.last_session_activity_dttm, 
            b.session_expiration_dttm = d.session_expiration_dttm, b.session_expiration_dttm_tz = d.session_expiration_dttm_tz, 
            b.last_session_activity_dttm_tz = d.last_session_activity_dttm_tz, b.session_id_hex = d.session_id_hex
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_MESSAGE_CLICKED_tmp as 
            select * from &dbschema..SMS_MESSAGE_CLICKED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.load_dttm = d.load_dttm, b.sms_click_dttm = d.sms_click_dttm, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
...
%if %sysfunc(exist(&udmmart..SMS_MESSAGE_DELIVERED)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_MESSAGE_DELIVERED_tmp as 
            select * from &dbschema..SMS_MESSAGE_DELIVERED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.sms_delivered_dttm = d.sms_delivered_dttm, 
            b.load_dttm = d.load_dttm, b.sms_delivered_dttm_tz = d.sms_delivered_dttm_tz, 
            b.task_id = d.task_id, b.sender_id = d.sender_id, 
            b.response_tracking_cd = d.response_tracking_cd, b.occurrence_id = d.occurrence_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.country_cd = d.country_cd, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.context_type_nm = d.context_type_nm, 
            b.creative_id = d.creative_id, b.creative_version_id = d.creative_version_id, 
            b.identity_id = d.identity_id, b.sms_message_id = d.sms_message_id, 
            b.task_version_id = d.task_version_id, b.audience_id = d.audience_id, 
            b.context_val = d.context_val, b.event_designed_id = d.event_designed_id, 
            b.event_nm = d.event_nm, b.journey_id = d.journey_id
         WHEN NOT MATCHED THEN INSERT (
...
%if %sysfunc(exist(&udmmart..SMS_MESSAGE_FAILED)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_MESSAGE_FAILED_tmp as 
            select * from &dbschema..SMS_MESSAGE_FAILED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.sms_failed_dttm = d.sms_failed_dttm, 
            b.sms_failed_dttm_tz = d.sms_failed_dttm_tz, b.load_dttm = d.load_dttm, 
            b.task_id = d.task_id, b.sender_id = d.sender_id, 
            b.reason_cd = d.reason_cd, b.occurrence_id = d.occurrence_id, 
            b.identity_id = d.identity_id, b.event_designed_id = d.event_designed_id, 
            b.creative_version_id = d.creative_version_id, b.context_type_nm = d.context_type_nm, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.country_cd = d.country_cd, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.reason_description_txt = d.reason_description_txt, 
            b.sms_message_id = d.sms_message_id, b.task_version_id = d.task_version_id, 
            b.audience_id = d.audience_id, b.context_val = d.context_val, 
...
%if %sysfunc(exist(&udmmart..SMS_MESSAGE_REPLY)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_MESSAGE_REPLY_tmp as 
            select * from &dbschema..SMS_MESSAGE_REPLY where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.sms_reply_dttm = d.sms_reply_dttm, 
            b.load_dttm = d.load_dttm, b.sms_reply_dttm_tz = d.sms_reply_dttm_tz, 
            b.task_id = d.task_id, b.sms_content = d.sms_content, 
            b.sender_id = d.sender_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.context_type_nm = d.context_type_nm, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.country_cd = d.country_cd, b.identity_id = d.identity_id, 
            b.occurrence_id = d.occurrence_id, b.sms_message_id = d.sms_message_id, 
            b.task_version_id = d.task_version_id, b.audience_id = d.audience_id, 
            b.context_val = d.context_val, b.event_designed_id = d.event_designed_id, 
            b.event_nm = d.event_nm, b.journey_id = d.journey_id, 
            b.response_tracking_cd = d.response_tracking_cd
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_MESSAGE_SEND_tmp as 
            select * from &dbschema..SMS_MESSAGE_SEND where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.sms_send_dttm = d.sms_send_dttm, b.load_dttm = d.load_dttm, 
            b.sms_send_dttm_tz = d.sms_send_dttm_tz, b.task_id = d.task_id, 
            b.sender_id = d.sender_id, b.journey_occurrence_id = d.journey_occurrence_id, 
            b.identity_id = d.identity_id, b.event_nm = d.event_nm, 
            b.creative_id = d.creative_id, b.audience_id = d.audience_id, 
            b.context_val = d.context_val, b.creative_version_id = d.creative_version_id, 
            b.event_designed_id = d.event_designed_id, b.occurrence_id = d.occurrence_id, 
            b.task_version_id = d.task_version_id, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.context_type_nm = d.context_type_nm, b.country_cd = d.country_cd, 
            b.journey_id = d.journey_id, b.response_tracking_cd = d.response_tracking_cd, 
            b.sms_message_id = d.sms_message_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_OPTOUT_tmp as 
            select * from &dbschema..SMS_OPTOUT where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.occurrence_id = d.occurrence_id, b.journey_id = d.journey_id, 
            b.identity_id = d.identity_id, b.creative_version_id = d.creative_version_id, 
            b.creative_id = d.creative_id, b.country_cd = d.country_cd, 
            b.context_val = d.context_val, b.context_type_nm = d.context_type_nm, 
            b.aud_occurrence_id = d.aud_occurrence_id, b.event_designed_id = d.event_designed_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.optout_type_nm = d.optout_type_nm, 
            b.response_tracking_cd = d.response_tracking_cd, b.task_id = d.task_id, 
            b.audience_id = d.audience_id, b.event_nm = d.event_nm, 
...
%if %sysfunc(exist(&udmmart..SMS_OPTOUT_DETAILS)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SMS_OPTOUT_DETAILS_tmp as 
            select * from &dbschema..SMS_OPTOUT_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         WHEN MATCHED THEN
         UPDATE SET
            b.sms_optout_dttm = d.sms_optout_dttm, 
            b.load_dttm = d.load_dttm, b.sms_optout_dttm_tz = d.sms_optout_dttm_tz, 
            b.task_version_id = d.task_version_id, b.task_id = d.task_id, 
            b.sms_message_id = d.sms_message_id, b.occurrence_id = d.occurrence_id, 
            b.journey_occurrence_id = d.journey_occurrence_id, b.journey_id = d.journey_id, 
            b.identity_id = d.identity_id, b.creative_version_id = d.creative_version_id, 
            b.context_type_nm = d.context_type_nm, b.aud_occurrence_id = d.aud_occurrence_id, 
            b.country_cd = d.country_cd, b.optout_type_nm = d.optout_type_nm, 
            b.response_tracking_cd = d.response_tracking_cd, b.address_val = d.address_val, 
            b.audience_id = d.audience_id, b.context_val = d.context_val, 
            b.creative_id = d.creative_id, b.event_designed_id = d.event_designed_id, 
            b.event_nm = d.event_nm, b.sender_id = d.sender_id
         WHEN NOT MATCHED THEN INSERT (
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SPOT_CLICKED_tmp as 
            select * from &dbschema..SPOT_CLICKED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.spot_clicked_dttm_tz = d.spot_clicked_dttm_tz, b.task_id = d.task_id, 
            ...
            b.channel_user_id = d.channel_user_id, b.identity_id = d.identity_id, 
            b.mobile_app_id = d.mobile_app_id, b.product_sku_no = d.product_sku_no, 
            b.request_id = d.request_id, b.segment_id = d.segment_id, 
            b.spot_id = d.spot_id, b.url_txt = d.url_txt, 
            ...
            b.event_source_cd = d.event_source_cd, b.message_version_id = d.message_version_id, 
            b.occurrence_id = d.occurrence_id, b.product_nm = d.product_nm, 
...
%if %sysfunc(exist(&udmmart..SPOT_REQUESTED)) %then %do;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..SPOT_REQUESTED_tmp as 
            select * from &dbschema..SPOT_REQUESTED where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            b.properties_map_doc = d.properties_map_doc, 
            b.spot_requested_dttm = d.spot_requested_dttm, b.spot_requested_dttm_tz = d.spot_requested_dttm_tz, 
            b.load_dttm = d.load_dttm, b.visit_id_hex = d.visit_id_hex, 
            b.request_id = d.request_id, b.event_source_cd = d.event_source_cd, 
            b.detail_id_hex = d.detail_id_hex, b.channel_nm = d.channel_nm, 
            b.context_type_nm = d.context_type_nm, b.event_designed_id = d.event_designed_id, 
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL noerrorstop;
         ...
         execute( create  table &tmpdbschema..VISIT_DETAILS_tmp as 
            select * from &dbschema..VISIT_DETAILS where 1=0            ) by &database.;
         disconnect from &database.;
      QUIT;
   ...
   %if &errFlag = 0 %then %do;
      PROC SQL NOERRORSTOP;
         ...
         UPDATE SET
            ...
            b.load_dttm = d.load_dttm, b.visit_dttm_tz = d.visit_dttm_tz, 
            b.visit_dttm = d.visit_dttm, b.session_id = d.session_id, 
            b.search_term_txt = d.search_term_txt, b.referrer_query_string_txt = d.referrer_query_string_txt, 
            b.origination_placement_nm = d.origination_placement_nm, b.identity_id = d.identity_id, 
            b.origination_creative_nm = d.origination_creative_nm, b.origination_type_nm = d.origination_type_nm, 
            b.search_engine_desc = d.search_engine_desc, b.visit_id = d.visit_id, 
            b.origination_nm = d.origination_nm, b.origination_tracking_cd = d.origination_tracking_cd, 
            b.referrer_domain_nm = d.referrer_domain_nm, b.referrer_txt = d.referrer_txt, 
            b.search_engine_domain_txt = d.search_engine_domain_txt, b.session_id_hex = d.session_id_hex, 
            b.visit_id_hex = d.visit_id_hex
         WHEN NOT MATCHED THEN INSERT (
