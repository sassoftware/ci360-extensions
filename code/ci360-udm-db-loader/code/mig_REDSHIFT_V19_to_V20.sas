...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_activity_node_all (
      ...
      specific_wait_flg char(1) NULL, end_node_flg char(1) NULL, start_node_flg char(1) NULL, node_sequence_no integer NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_dataview_all (
      include_internal_flg char(1) NULL, include_external_flg char(1) NULL, analytic_active_flg char(1) NULL, max_path_length_val integer NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..md_task_all (
      ...
      use_modeling_flg char(1) NULL, activity_flg char(1) NULL, recurring_schedule_flg char(1) NULL, recurrence_day_of_month_no integer NULL, 
      ...
      impressions_qty_period_cnt integer NULL, maximum_period_expression_cnt integer NULL, impressions_life_time_cnt integer NULL, last_published_dttm timestamp NULL, 
