...
PROC SQL ;
   ...
   EXECUTE (ALTER TABLE &dbschema..ABT_ATTRIBUTION MODIFY
      PARTITION BY RANGE( interaction_dttm ) INTERVAL (NUMTODSINTERVAL(1, 'DAY')) (
         PARTITION p0 VALUES LESS THAN (TO_DATE('2026-06-10','YYYY-MM-DD') )
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..ASSET_DETAILS (
      folder_sk number NULL, asset_sk number NULL, public_media_id number NULL, user_rating_cnt number NULL, 
      total_user_rating_val number NULL, entity_revision_enabled_flg char(1) NULL, folder_deleted_flg char(1) NULL, entity_attribute_enabled_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..ASSET_RENDITION_DETAILS (
      download_cnt number NULL, revision_no number NULL, rend_deleted_flg char(1) NULL, rev_deleted_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..COMMITMENT_LINE_ITEMS (
      item_qty number NULL, item_alloc_unit number NULL, item_vend_alloc_unit number NULL, vendor_obsolete_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DAILY_USAGE (
      bc_subjcnt_str varchar(4000) NULL, customer_profiles_processed_str varchar(4000) NULL, api_usage_str varchar(4000) NULL, mob_impr_cnt number NULL, 
      dm_destinations_total_row_cnt number NULL, google_ads_cnt number NULL, mob_sesn_cnt number NULL, audience_usage_cnt number NULL, 
      mobile_in_app_msg_cnt number NULL, mobile_push_cnt number NULL, email_preview_cnt number NULL, facebook_ads_cnt number NULL, 
      web_sesn_cnt number NULL, plan_users_cnt number NULL, outbound_api_cnt number NULL, web_impr_cnt number NULL, 
      email_send_cnt number NULL, linkedin_ads_cnt number NULL, dm_destinations_total_id_cnt number NULL, asset_size decimal(17,2) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..DBT_MEDIA_CONSUMPTION (
      ...
      session_complete_load_dttm timestamp NOT NULL, media_start_dttm timestamp NULL, media_start_dttm_tz timestamp NULL, views_started number NULL, 
      views_completed number NULL, views number NULL, media_section_view number NULL, visitor_type varchar(10) NULL, 
      visitor_id varchar(32) NULL, visit_origination_type varchar(65) NULL, visit_origination_tracking_code varchar(65) NULL, visit_origination_placement varchar(390) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_ACTIVITY_NODE_ALL (
      previous_node_val varchar(4000) NULL, next_node_val varchar(4000) NULL, wait_tm number NULL, time_boxed_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MD_WF_PROCESS_DEF_TASKS (
      default_duration_perassignee number NULL, file_enabled_flg char(1) NULL, is_sequential_flg char(1) NULL, outgoing_flow_flg char(1) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..MONTHLY_USAGE (
      api_usage_str varchar(4000) NULL, bc_subjcnt_str varchar(4000) NULL, customer_profiles_processed_str varchar(4000) NULL, web_impr_cnt number NULL, 
      web_sesn_cnt number NULL, mob_sesn_cnt number NULL, email_preview_cnt number NULL, outbound_api_cnt number NULL, 
      facebook_ads_cnt number NULL, mobile_push_cnt number NULL, google_ads_cnt number NULL, audience_usage_cnt number NULL, 
      plan_users_cnt number NULL, email_send_cnt number NULL, linkedin_ads_cnt number NULL, dm_destinations_total_row_cnt number NULL, 
      mob_impr_cnt number NULL, dm_destinations_total_id_cnt number NULL, mobile_in_app_msg_cnt number NULL, asset_size decimal(17,2) NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_PROCESS_DETAILS (
      delayed_by_day number NULL, percent_complete number NULL, user_tasks_cnt number NULL, completed_dttm timestamp NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_PROCESS_TASKS (
      version_num number NULL, duration_per_assignee number NULL, delayed_by_day number NULL, percent_complete number NULL, 
...
PROC SQL ;
   ...
   EXECUTE (CREATE TABLE &dbschema..WF_TASKS_USER_ASSIGNMENT (
      usan_duration_day number NULL, delayed_by_day number NULL, is_assigned_flg char(1) NULL, is_replaced_flg char(1) NULL, 
